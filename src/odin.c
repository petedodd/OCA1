...
SEXP ocaode_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 983));
  ...
  SET_VECTOR_ELT(contents, 708, ScalarInteger(internal->dim_relapsefrompost_123));
  SET_VECTOR_ELT(contents, 709, ScalarInteger(internal->dim_relapsefrompost_1234));
  SET_VECTOR_ELT(contents, 710, ScalarInteger(internal->dim_relapsefrompost_12345));
  SET_VECTOR_ELT(contents, 711, ScalarInteger(internal->dim_relapsefrompost_123456));
  SET_VECTOR_ELT(contents, 712, ScalarInteger(internal->dim_relapsefrompost_2));
  SET_VECTOR_ELT(contents, 713, ScalarInteger(internal->dim_relapsefrompost_3));
  SET_VECTOR_ELT(contents, 714, ScalarInteger(internal->dim_relapsefrompost_4));
  SET_VECTOR_ELT(contents, 715, ScalarInteger(internal->dim_relapsefrompost_5));
  SET_VECTOR_ELT(contents, 716, ScalarInteger(internal->dim_relapsefrompost_6));
  SET_VECTOR_ELT(contents, 717, ScalarInteger(internal->dim_relapsefrompost_7));
  SET_VECTOR_ELT(contents, 718, ScalarInteger(internal->dim_RiskChangeA));
  SET_VECTOR_ELT(contents, 719, ScalarInteger(internal->dim_RiskChangeA_1));
  SET_VECTOR_ELT(contents, 720, ScalarInteger(internal->dim_RiskChangeA_12));
  SET_VECTOR_ELT(contents, 721, ScalarInteger(internal->dim_RiskChangeA_123));
  SET_VECTOR_ELT(contents, 722, ScalarInteger(internal->dim_RiskChangeA_1234));
  SET_VECTOR_ELT(contents, 723, ScalarInteger(internal->dim_RiskChangeA_12345));
  SET_VECTOR_ELT(contents, 724, ScalarInteger(internal->dim_RiskChangeA_123456));
  SET_VECTOR_ELT(contents, 725, ScalarInteger(internal->dim_RiskChangeA_2));
  SET_VECTOR_ELT(contents, 726, ScalarInteger(internal->dim_RiskChangeA_3));
  SET_VECTOR_ELT(contents, 727, ScalarInteger(internal->dim_RiskChangeA_4));
  SET_VECTOR_ELT(contents, 728, ScalarInteger(internal->dim_RiskChangeA_5));
  SET_VECTOR_ELT(contents, 729, ScalarInteger(internal->dim_RiskChangeA_6));
  SET_VECTOR_ELT(contents, 730, ScalarInteger(internal->dim_RiskChangeA_7));
  SET_VECTOR_ELT(contents, 731, ScalarInteger(internal->dim_RiskChangeE));
  SET_VECTOR_ELT(contents, 732, ScalarInteger(internal->dim_RiskChangeE_1));
  SET_VECTOR_ELT(contents, 733, ScalarInteger(internal->dim_RiskChangeE_12));
  SET_VECTOR_ELT(contents, 734, ScalarInteger(internal->dim_RiskChangeE_123));
  SET_VECTOR_ELT(contents, 735, ScalarInteger(internal->dim_RiskChangeE_1234));
  SET_VECTOR_ELT(contents, 736, ScalarInteger(internal->dim_RiskChangeE_12345));
  SET_VECTOR_ELT(contents, 737, ScalarInteger(internal->dim_RiskChangeE_123456));
  SET_VECTOR_ELT(contents, 738, ScalarInteger(internal->dim_RiskChangeE_2));
  SET_VECTOR_ELT(contents, 739, ScalarInteger(internal->dim_RiskChangeE_3));
  SET_VECTOR_ELT(contents, 740, ScalarInteger(internal->dim_RiskChangeE_4));
  SET_VECTOR_ELT(contents, 741, ScalarInteger(internal->dim_RiskChangeE_5));
  SET_VECTOR_ELT(contents, 742, ScalarInteger(internal->dim_RiskChangeE_6));
  SET_VECTOR_ELT(contents, 743, ScalarInteger(internal->dim_RiskChangeE_7));
  SET_VECTOR_ELT(contents, 744, ScalarInteger(internal->dim_RiskChangeL));
  SET_VECTOR_ELT(contents, 745, ScalarInteger(internal->dim_RiskChangeL_1));
  SET_VECTOR_ELT(contents, 746, ScalarInteger(internal->dim_RiskChangeL_12));
  SET_VECTOR_ELT(contents, 747, ScalarInteger(internal->dim_RiskChangeL_123));
  SET_VECTOR_ELT(contents, 748, ScalarInteger(internal->dim_RiskChangeL_1234));
  SET_VECTOR_ELT(contents, 749, ScalarInteger(internal->dim_RiskChangeL_12345));
  SET_VECTOR_ELT(contents, 750, ScalarInteger(internal->dim_RiskChangeL_123456));
  SET_VECTOR_ELT(contents, 751, ScalarInteger(internal->dim_RiskChangeL_2));
  SET_VECTOR_ELT(contents, 752, ScalarInteger(internal->dim_RiskChangeL_3));
  SET_VECTOR_ELT(contents, 753, ScalarInteger(internal->dim_RiskChangeL_4));
  SET_VECTOR_ELT(contents, 754, ScalarInteger(internal->dim_RiskChangeL_5));
  SET_VECTOR_ELT(contents, 755, ScalarInteger(internal->dim_RiskChangeL_6));
  SET_VECTOR_ELT(contents, 756, ScalarInteger(internal->dim_RiskChangeL_7));
  SET_VECTOR_ELT(contents, 757, ScalarInteger(internal->dim_RiskChangeS));
  SET_VECTOR_ELT(contents, 758, ScalarInteger(internal->dim_RiskChangeS_1));
  SET_VECTOR_ELT(contents, 759, ScalarInteger(internal->dim_RiskChangeS_12));
  SET_VECTOR_ELT(contents, 760, ScalarInteger(internal->dim_RiskChangeS_123));
  SET_VECTOR_ELT(contents, 761, ScalarInteger(internal->dim_RiskChangeS_1234));
  SET_VECTOR_ELT(contents, 762, ScalarInteger(internal->dim_RiskChangeS_12345));
  SET_VECTOR_ELT(contents, 763, ScalarInteger(internal->dim_RiskChangeS_123456));
  SET_VECTOR_ELT(contents, 764, ScalarInteger(internal->dim_RiskChangeS_2));
  SET_VECTOR_ELT(contents, 765, ScalarInteger(internal->dim_RiskChangeS_3));
  SET_VECTOR_ELT(contents, 766, ScalarInteger(internal->dim_RiskChangeS_4));
  SET_VECTOR_ELT(contents, 767, ScalarInteger(internal->dim_RiskChangeS_5));
  SET_VECTOR_ELT(contents, 768, ScalarInteger(internal->dim_RiskChangeS_6));
  SET_VECTOR_ELT(contents, 769, ScalarInteger(internal->dim_RiskChangeS_7));
  SET_VECTOR_ELT(contents, 770, ScalarInteger(internal->dim_RiskChangeT));
  SET_VECTOR_ELT(contents, 771, ScalarInteger(internal->dim_RiskChangeT_1));
  SET_VECTOR_ELT(contents, 772, ScalarInteger(internal->dim_RiskChangeT_12));
  SET_VECTOR_ELT(contents, 773, ScalarInteger(internal->dim_RiskChangeT_123));
  SET_VECTOR_ELT(contents, 774, ScalarInteger(internal->dim_RiskChangeT_1234));
  SET_VECTOR_ELT(contents, 775, ScalarInteger(internal->dim_RiskChangeT_12345));
  SET_VECTOR_ELT(contents, 776, ScalarInteger(internal->dim_RiskChangeT_123456));
  SET_VECTOR_ELT(contents, 777, ScalarInteger(internal->dim_RiskChangeT_2));
  SET_VECTOR_ELT(contents, 778, ScalarInteger(internal->dim_RiskChangeT_3));
  SET_VECTOR_ELT(contents, 779, ScalarInteger(internal->dim_RiskChangeT_4));
  SET_VECTOR_ELT(contents, 780, ScalarInteger(internal->dim_RiskChangeT_5));
  SET_VECTOR_ELT(contents, 781, ScalarInteger(internal->dim_RiskChangeT_6));
  SET_VECTOR_ELT(contents, 782, ScalarInteger(internal->dim_RiskChangeT_7));
  SET_VECTOR_ELT(contents, 783, ScalarInteger(internal->dim_RiskChangeU));
  SET_VECTOR_ELT(contents, 784, ScalarInteger(internal->dim_RiskChangeU_1));
  SET_VECTOR_ELT(contents, 785, ScalarInteger(internal->dim_RiskChangeU_12));
  SET_VECTOR_ELT(contents, 786, ScalarInteger(internal->dim_RiskChangeU_123));
  SET_VECTOR_ELT(contents, 787, ScalarInteger(internal->dim_RiskChangeU_1234));
  SET_VECTOR_ELT(contents, 788, ScalarInteger(internal->dim_RiskChangeU_12345));
  SET_VECTOR_ELT(contents, 789, ScalarInteger(internal->dim_RiskChangeU_123456));
  SET_VECTOR_ELT(contents, 790, ScalarInteger(internal->dim_RiskChangeU_2));
  SET_VECTOR_ELT(contents, 791, ScalarInteger(internal->dim_RiskChangeU_3));
  SET_VECTOR_ELT(contents, 792, ScalarInteger(internal->dim_RiskChangeU_4));
  SET_VECTOR_ELT(contents, 793, ScalarInteger(internal->dim_RiskChangeU_5));
  SET_VECTOR_ELT(contents, 794, ScalarInteger(internal->dim_RiskChangeU_6));
  SET_VECTOR_ELT(contents, 795, ScalarInteger(internal->dim_RiskChangeU_7));
  SET_VECTOR_ELT(contents, 796, ScalarInteger(internal->dim_RiskHazard));
  SET_VECTOR_ELT(contents, 797, ScalarInteger(internal->dim_RiskHazard_1));
  SET_VECTOR_ELT(contents, 798, ScalarInteger(internal->dim_RiskHazard_12));
  SET_VECTOR_ELT(contents, 799, ScalarInteger(internal->dim_RiskHazard_2));
  SET_VECTOR_ELT(contents, 800, ScalarInteger(internal->dim_RiskHazard_3));
  SET_VECTOR_ELT(contents, 801, ScalarInteger(internal->dim_RiskHazardData));
  SET_VECTOR_ELT(contents, 802, ScalarInteger(internal->dim_RiskHazardData_1));
  SET_VECTOR_ELT(contents, 803, ScalarInteger(internal->dim_RiskHazardData_12));
  SET_VECTOR_ELT(contents, 804, ScalarInteger(internal->dim_RiskHazardData_123));
  SET_VECTOR_ELT(contents, 805, ScalarInteger(internal->dim_RiskHazardData_2));
  SET_VECTOR_ELT(contents, 806, ScalarInteger(internal->dim_RiskHazardData_3));
  SET_VECTOR_ELT(contents, 807, ScalarInteger(internal->dim_RiskHazardData_4));
  SET_VECTOR_ELT(contents, 808, ScalarInteger(internal->dim_Symp));
  SET_VECTOR_ELT(contents, 809, ScalarInteger(internal->dim_Symp_1));
  SET_VECTOR_ELT(contents, 810, ScalarInteger(internal->dim_Symp_12));
  SET_VECTOR_ELT(contents, 811, ScalarInteger(internal->dim_Symp_123));
  SET_VECTOR_ELT(contents, 812, ScalarInteger(internal->dim_Symp_1234));
  SET_VECTOR_ELT(contents, 813, ScalarInteger(internal->dim_Symp_12345));
  SET_VECTOR_ELT(contents, 814, ScalarInteger(internal->dim_Symp_123456));
  SET_VECTOR_ELT(contents, 815, ScalarInteger(internal->dim_Symp_2));
  SET_VECTOR_ELT(contents, 816, ScalarInteger(internal->dim_Symp_3));
  SET_VECTOR_ELT(contents, 817, ScalarInteger(internal->dim_Symp_4));
  SET_VECTOR_ELT(contents, 818, ScalarInteger(internal->dim_Symp_5));
  SET_VECTOR_ELT(contents, 819, ScalarInteger(internal->dim_Symp_6));
  SET_VECTOR_ELT(contents, 820, ScalarInteger(internal->dim_Symp_7));
  SET_VECTOR_ELT(contents, 821, ScalarInteger(internal->dim_tbbottom));
  SET_VECTOR_ELT(contents, 822, ScalarInteger(internal->dim_tbbottom_1));
  SET_VECTOR_ELT(contents, 823, ScalarInteger(internal->dim_tbbottom_12));
  SET_VECTOR_ELT(contents, 824, ScalarInteger(internal->dim_tbbottom_2));
  SET_VECTOR_ELT(contents, 825, ScalarInteger(internal->dim_tbbottom_3));
  SET_VECTOR_ELT(contents, 826, ScalarInteger(internal->dim_totalpops));
  SET_VECTOR_ELT(contents, 827, ScalarInteger(internal->dim_totalpops_1));
  SET_VECTOR_ELT(contents, 828, ScalarInteger(internal->dim_totalpops_12));
  SET_VECTOR_ELT(contents, 829, ScalarInteger(internal->dim_totalpops_123));
  SET_VECTOR_ELT(contents, 830, ScalarInteger(internal->dim_totalpops_1234));
  SET_VECTOR_ELT(contents, 831, ScalarInteger(internal->dim_totalpops_12345));
  SET_VECTOR_ELT(contents, 832, ScalarInteger(internal->dim_totalpops_123456));
  SET_VECTOR_ELT(contents, 833, ScalarInteger(internal->dim_totalpops_2));
  SET_VECTOR_ELT(contents, 834, ScalarInteger(internal->dim_totalpops_3));
  SET_VECTOR_ELT(contents, 835, ScalarInteger(internal->dim_totalpops_4));
  SET_VECTOR_ELT(contents, 836, ScalarInteger(internal->dim_totalpops_5));
  SET_VECTOR_ELT(contents, 837, ScalarInteger(internal->dim_totalpops_6));
  SET_VECTOR_ELT(contents, 838, ScalarInteger(internal->dim_totalpops_7));
  SET_VECTOR_ELT(contents, 839, ScalarInteger(internal->dim_Treat));
  SET_VECTOR_ELT(contents, 840, ScalarInteger(internal->dim_Treat_1));
  SET_VECTOR_ELT(contents, 841, ScalarInteger(internal->dim_Treat_12));
  SET_VECTOR_ELT(contents, 842, ScalarInteger(internal->dim_Treat_123));
  SET_VECTOR_ELT(contents, 843, ScalarInteger(internal->dim_Treat_1234));
  SET_VECTOR_ELT(contents, 844, ScalarInteger(internal->dim_Treat_12345));
  SET_VECTOR_ELT(contents, 845, ScalarInteger(internal->dim_Treat_123456));
  SET_VECTOR_ELT(contents, 846, ScalarInteger(internal->dim_Treat_2));
  SET_VECTOR_ELT(contents, 847, ScalarInteger(internal->dim_Treat_3));
  SET_VECTOR_ELT(contents, 848, ScalarInteger(internal->dim_Treat_4));
  SET_VECTOR_ELT(contents, 849, ScalarInteger(internal->dim_Treat_5));
  SET_VECTOR_ELT(contents, 850, ScalarInteger(internal->dim_Treat_6));
  SET_VECTOR_ELT(contents, 851, ScalarInteger(internal->dim_Treat_7));
  SET_VECTOR_ELT(contents, 852, ScalarInteger(internal->dim_treatmentends));
  SET_VECTOR_ELT(contents, 853, ScalarInteger(internal->dim_treatmentends_1));
  SET_VECTOR_ELT(contents, 854, ScalarInteger(internal->dim_treatmentends_12));
  SET_VECTOR_ELT(contents, 855, ScalarInteger(internal->dim_treatmentends_123));
  SET_VECTOR_ELT(contents, 856, ScalarInteger(internal->dim_treatmentends_1234));
  SET_VECTOR_ELT(contents, 857, ScalarInteger(internal->dim_treatmentends_12345));
  SET_VECTOR_ELT(contents, 858, ScalarInteger(internal->dim_treatmentends_123456));
  SET_VECTOR_ELT(contents, 859, ScalarInteger(internal->dim_treatmentends_2));
  SET_VECTOR_ELT(contents, 860, ScalarInteger(internal->dim_treatmentends_3));
  SET_VECTOR_ELT(contents, 861, ScalarInteger(internal->dim_treatmentends_4));
  SET_VECTOR_ELT(contents, 862, ScalarInteger(internal->dim_treatmentends_5));
  SET_VECTOR_ELT(contents, 863, ScalarInteger(internal->dim_treatmentends_6));
  SET_VECTOR_ELT(contents, 864, ScalarInteger(internal->dim_treatmentends_7));
  SET_VECTOR_ELT(contents, 865, ScalarInteger(internal->dim_treatmentstarts));
  SET_VECTOR_ELT(contents, 866, ScalarInteger(internal->dim_treatmentstarts_1));
  SET_VECTOR_ELT(contents, 867, ScalarInteger(internal->dim_treatmentstarts_12));
  SET_VECTOR_ELT(contents, 868, ScalarInteger(internal->dim_treatmentstarts_123));
  SET_VECTOR_ELT(contents, 869, ScalarInteger(internal->dim_treatmentstarts_1234));
  SET_VECTOR_ELT(contents, 870, ScalarInteger(internal->dim_treatmentstarts_12345));
  SET_VECTOR_ELT(contents, 871, ScalarInteger(internal->dim_treatmentstarts_123456));
  SET_VECTOR_ELT(contents, 872, ScalarInteger(internal->dim_treatmentstarts_2));
  SET_VECTOR_ELT(contents, 873, ScalarInteger(internal->dim_treatmentstarts_3));
  SET_VECTOR_ELT(contents, 874, ScalarInteger(internal->dim_treatmentstarts_4));
  SET_VECTOR_ELT(contents, 875, ScalarInteger(internal->dim_treatmentstarts_5));
  SET_VECTOR_ELT(contents, 876, ScalarInteger(internal->dim_treatmentstarts_6));
  SET_VECTOR_ELT(contents, 877, ScalarInteger(internal->dim_treatmentstarts_7));
  SET_VECTOR_ELT(contents, 878, ScalarInteger(internal->dim_ttp));
  SET_VECTOR_ELT(contents, 879, ScalarInteger(internal->dim_Uninfected));
  SET_VECTOR_ELT(contents, 880, ScalarInteger(internal->dim_Uninfected_1));
  SET_VECTOR_ELT(contents, 881, ScalarInteger(internal->dim_Uninfected_12));
  SET_VECTOR_ELT(contents, 882, ScalarInteger(internal->dim_Uninfected_123));
  SET_VECTOR_ELT(contents, 883, ScalarInteger(internal->dim_Uninfected_1234));
  SET_VECTOR_ELT(contents, 884, ScalarInteger(internal->dim_Uninfected_12345));
  SET_VECTOR_ELT(contents, 885, ScalarInteger(internal->dim_Uninfected_123456));
  SET_VECTOR_ELT(contents, 886, ScalarInteger(internal->dim_Uninfected_2));
  SET_VECTOR_ELT(contents, 887, ScalarInteger(internal->dim_Uninfected_3));
  SET_VECTOR_ELT(contents, 888, ScalarInteger(internal->dim_Uninfected_4));
  SET_VECTOR_ELT(contents, 889, ScalarInteger(internal->dim_Uninfected_5));
  SET_VECTOR_ELT(contents, 890, ScalarInteger(internal->dim_Uninfected_6));
  SET_VECTOR_ELT(contents, 891, ScalarInteger(internal->dim_Uninfected_7));
  SET_VECTOR_ELT(contents, 892, ScalarReal(internal->foi));
  ...
  SET_VECTOR_ELT(contents, 893, fromtreatmentA);
  ...
  SET_VECTOR_ELT(contents, 894, fromtreatmentL);
  ...
  SET_VECTOR_ELT(contents, 895, immigration);
  ...
  SET_VECTOR_ELT(contents, 896, In);
  ...
  SET_VECTOR_ELT(contents, 897, initial_Asymp);
  ...
  SET_VECTOR_ELT(contents, 898, initial_Learly);
  ...
  SET_VECTOR_ELT(contents, 899, initial_Llate);
  ...
  SET_VECTOR_ELT(contents, 900, initial_Symp);
  ...
  SET_VECTOR_ELT(contents, 901, initial_Treat);
  ...
  SET_VECTOR_ELT(contents, 902, initial_Uninfected);
  SET_VECTOR_ELT(contents, 907, ScalarInteger(internal->lttp));
  ...
  SET_VECTOR_ELT(contents, 908, migrA);
  ...
  SET_VECTOR_ELT(contents, 909, migrage);
  ...
  SET_VECTOR_ELT(contents, 910, migrageinA);
  ...
  SET_VECTOR_ELT(contents, 911, migrageinE);
  ...
  SET_VECTOR_ELT(contents, 912, migrageinL);
  ...
  SET_VECTOR_ELT(contents, 913, migrageinS);
  ...
  SET_VECTOR_ELT(contents, 914, migrageinT);
  ...
  SET_VECTOR_ELT(contents, 915, migrageinU);
  ...
  SET_VECTOR_ELT(contents, 916, migrageoutA);
  ...
  SET_VECTOR_ELT(contents, 917, migrageoutE);
  ...
  SET_VECTOR_ELT(contents, 918, migrageoutL);
  ...
  SET_VECTOR_ELT(contents, 919, migrageoutS);
  ...
  SET_VECTOR_ELT(contents, 920, migrageoutT);
  ...
  SET_VECTOR_ELT(contents, 921, migrageoutU);
  ...
  SET_VECTOR_ELT(contents, 922, migrE);
  ...
  SET_VECTOR_ELT(contents, 923, migrL);
  ...
  SET_VECTOR_ELT(contents, 924, migrS);
  ...
  SET_VECTOR_ELT(contents, 925, migrT);
  ...
  SET_VECTOR_ELT(contents, 926, migrU);
  SET_VECTOR_ELT(contents, 927, ScalarReal(internal->mortality_treated));
  SET_VECTOR_ELT(contents, 928, ScalarReal(internal->mortality_untreated));
  SET_VECTOR_ELT(contents, 929, ScalarInteger(internal->nage));
  ...
  SET_VECTOR_ELT(contents, 930, native);
  SET_VECTOR_ELT(contents, 931, ScalarInteger(internal->nnat));
  SET_VECTOR_ELT(contents, 932, ScalarInteger(internal->npost));
  ...
  SET_VECTOR_ELT(contents, 940, ScalarInteger(internal->offset_variable_Treat));
  ...
  SET_VECTOR_ELT(contents, 941, omega);
  ...
  SET_VECTOR_ELT(contents, 942, Pmigr_nat);
  ...
  SET_VECTOR_ELT(contents, 943, Pmigr_post);
  ...
  SET_VECTOR_ELT(contents, 944, Pmigr_prot);
  ...
  SET_VECTOR_ELT(contents, 945, Pmigr_risk);
  ...
  SET_VECTOR_ELT(contents, 946, Pmigr_strain);
  ...
  SET_VECTOR_ELT(contents, 947, popdat);
  ...
  SET_VECTOR_ELT(contents, 948, popinitA);
  ...
  SET_VECTOR_ELT(contents, 949, popinitE);
  ...
  SET_VECTOR_ELT(contents, 950, popinitL);
  ...
  SET_VECTOR_ELT(contents, 951, popinitS);
  ...
  SET_VECTOR_ELT(contents, 952, popinitT);
  ...
  SET_VECTOR_ELT(contents, 953, popinitU);
  ...
  SET_VECTOR_ELT(contents, 954, PostTBprognA);
  ...
  SET_VECTOR_ELT(contents, 955, PostTBprognE);
  ...
  SET_VECTOR_ELT(contents, 956, PostTBprognL);
  ...
  SET_VECTOR_ELT(contents, 957, PostTBprognS);
  ...
  SET_VECTOR_ELT(contents, 958, PostTBprognT);
  ...
  SET_VECTOR_ELT(contents, 959, PostTBprognU);
  SET_VECTOR_ELT(contents, 960, ScalarReal(internal->progn_fast));
  ...
  SET_VECTOR_ELT(contents, 961, progn_posttb);
  SET_VECTOR_ELT(contents, 962, ScalarReal(internal->progn_slow));
  SET_VECTOR_ELT(contents, 963, ScalarReal(internal->progn_symp));
  SEXP r = PROTECT(allocVector(REALSXP, internal->dim_r));
  memcpy(REAL(r), internal->r, internal->dim_r * sizeof(double));
  SET_VECTOR_ELT(contents, 964, r);
  SET_VECTOR_ELT(contents, 965, ScalarReal(internal->relapse));
  ...
  SET_VECTOR_ELT(contents, 966, relapsefrompost);
  ...
  SET_VECTOR_ELT(contents, 967, RiskChangeA);
  ...
  SET_VECTOR_ELT(contents, 968, RiskChangeE);
  ...
  SET_VECTOR_ELT(contents, 969, RiskChangeL);
  ...
  SET_VECTOR_ELT(contents, 970, RiskChangeS);
  ...
  SET_VECTOR_ELT(contents, 971, RiskChangeT);
  ...
  SET_VECTOR_ELT(contents, 972, RiskChangeU);
  ...
  SET_VECTOR_ELT(contents, 973, RiskHazard);
  ...
  SET_VECTOR_ELT(contents, 974, RiskHazardData);
  SET_VECTOR_ELT(contents, 975, ScalarReal(internal->stabilization));
  ...
  SET_VECTOR_ELT(contents, 976, tbbottom);
  SET_VECTOR_ELT(contents, 977, ScalarReal(internal->tol));
  ...
  SET_VECTOR_ELT(contents, 978, totalpops);
  SET_VECTOR_ELT(contents, 979, ScalarReal(internal->treatment_inversedurn));
  ...
  SET_VECTOR_ELT(contents, 980, treatmentends);
  ...
  SET_VECTOR_ELT(contents, 981, treatmentstarts);
  SEXP ttp = PROTECT(allocVector(REALSXP, internal->dim_ttp));
  memcpy(REAL(ttp), internal->ttp, internal->dim_ttp * sizeof(double));
  SET_VECTOR_ELT(contents, 982, ttp);
  SEXP nms = PROTECT(allocVector(STRSXP, 983));
  ...
  SET_STRING_ELT(nms, 708, mkChar("dim_relapsefrompost_123"));
  SET_STRING_ELT(nms, 709, mkChar("dim_relapsefrompost_1234"));
  SET_STRING_ELT(nms, 710, mkChar("dim_relapsefrompost_12345"));
  SET_STRING_ELT(nms, 711, mkChar("dim_relapsefrompost_123456"));
  SET_STRING_ELT(nms, 712, mkChar("dim_relapsefrompost_2"));
  SET_STRING_ELT(nms, 713, mkChar("dim_relapsefrompost_3"));
  SET_STRING_ELT(nms, 714, mkChar("dim_relapsefrompost_4"));
  SET_STRING_ELT(nms, 715, mkChar("dim_relapsefrompost_5"));
  SET_STRING_ELT(nms, 716, mkChar("dim_relapsefrompost_6"));
  SET_STRING_ELT(nms, 717, mkChar("dim_relapsefrompost_7"));
  SET_STRING_ELT(nms, 718, mkChar("dim_RiskChangeA"));
  SET_STRING_ELT(nms, 719, mkChar("dim_RiskChangeA_1"));
  SET_STRING_ELT(nms, 720, mkChar("dim_RiskChangeA_12"));
  SET_STRING_ELT(nms, 721, mkChar("dim_RiskChangeA_123"));
  SET_STRING_ELT(nms, 722, mkChar("dim_RiskChangeA_1234"));
  SET_STRING_ELT(nms, 723, mkChar("dim_RiskChangeA_12345"));
  SET_STRING_ELT(nms, 724, mkChar("dim_RiskChangeA_123456"));
  SET_STRING_ELT(nms, 725, mkChar("dim_RiskChangeA_2"));
  SET_STRING_ELT(nms, 726, mkChar("dim_RiskChangeA_3"));
  SET_STRING_ELT(nms, 727, mkChar("dim_RiskChangeA_4"));
  SET_STRING_ELT(nms, 728, mkChar("dim_RiskChangeA_5"));
  SET_STRING_ELT(nms, 729, mkChar("dim_RiskChangeA_6"));
  SET_STRING_ELT(nms, 730, mkChar("dim_RiskChangeA_7"));
  SET_STRING_ELT(nms, 731, mkChar("dim_RiskChangeE"));
  SET_STRING_ELT(nms, 732, mkChar("dim_RiskChangeE_1"));
  SET_STRING_ELT(nms, 733, mkChar("dim_RiskChangeE_12"));
  SET_STRING_ELT(nms, 734, mkChar("dim_RiskChangeE_123"));
  SET_STRING_ELT(nms, 735, mkChar("dim_RiskChangeE_1234"));
  SET_STRING_ELT(nms, 736, mkChar("dim_RiskChangeE_12345"));
  SET_STRING_ELT(nms, 737, mkChar("dim_RiskChangeE_123456"));
  SET_STRING_ELT(nms, 738, mkChar("dim_RiskChangeE_2"));
  SET_STRING_ELT(nms, 739, mkChar("dim_RiskChangeE_3"));
  SET_STRING_ELT(nms, 740, mkChar("dim_RiskChangeE_4"));
  SET_STRING_ELT(nms, 741, mkChar("dim_RiskChangeE_5"));
  SET_STRING_ELT(nms, 742, mkChar("dim_RiskChangeE_6"));
  SET_STRING_ELT(nms, 743, mkChar("dim_RiskChangeE_7"));
  SET_STRING_ELT(nms, 744, mkChar("dim_RiskChangeL"));
  SET_STRING_ELT(nms, 745, mkChar("dim_RiskChangeL_1"));
  SET_STRING_ELT(nms, 746, mkChar("dim_RiskChangeL_12"));
  SET_STRING_ELT(nms, 747, mkChar("dim_RiskChangeL_123"));
  SET_STRING_ELT(nms, 748, mkChar("dim_RiskChangeL_1234"));
  SET_STRING_ELT(nms, 749, mkChar("dim_RiskChangeL_12345"));
  SET_STRING_ELT(nms, 750, mkChar("dim_RiskChangeL_123456"));
  SET_STRING_ELT(nms, 751, mkChar("dim_RiskChangeL_2"));
  SET_STRING_ELT(nms, 752, mkChar("dim_RiskChangeL_3"));
  SET_STRING_ELT(nms, 753, mkChar("dim_RiskChangeL_4"));
  SET_STRING_ELT(nms, 754, mkChar("dim_RiskChangeL_5"));
  SET_STRING_ELT(nms, 755, mkChar("dim_RiskChangeL_6"));
  SET_STRING_ELT(nms, 756, mkChar("dim_RiskChangeL_7"));
  SET_STRING_ELT(nms, 757, mkChar("dim_RiskChangeS"));
  SET_STRING_ELT(nms, 758, mkChar("dim_RiskChangeS_1"));
  SET_STRING_ELT(nms, 759, mkChar("dim_RiskChangeS_12"));
  SET_STRING_ELT(nms, 760, mkChar("dim_RiskChangeS_123"));
  SET_STRING_ELT(nms, 761, mkChar("dim_RiskChangeS_1234"));
  SET_STRING_ELT(nms, 762, mkChar("dim_RiskChangeS_12345"));
  SET_STRING_ELT(nms, 763, mkChar("dim_RiskChangeS_123456"));
  SET_STRING_ELT(nms, 764, mkChar("dim_RiskChangeS_2"));
  SET_STRING_ELT(nms, 765, mkChar("dim_RiskChangeS_3"));
  SET_STRING_ELT(nms, 766, mkChar("dim_RiskChangeS_4"));
  SET_STRING_ELT(nms, 767, mkChar("dim_RiskChangeS_5"));
  SET_STRING_ELT(nms, 768, mkChar("dim_RiskChangeS_6"));
  SET_STRING_ELT(nms, 769, mkChar("dim_RiskChangeS_7"));
  SET_STRING_ELT(nms, 770, mkChar("dim_RiskChangeT"));
  SET_STRING_ELT(nms, 771, mkChar("dim_RiskChangeT_1"));
  SET_STRING_ELT(nms, 772, mkChar("dim_RiskChangeT_12"));
  SET_STRING_ELT(nms, 773, mkChar("dim_RiskChangeT_123"));
  SET_STRING_ELT(nms, 774, mkChar("dim_RiskChangeT_1234"));
  SET_STRING_ELT(nms, 775, mkChar("dim_RiskChangeT_12345"));
  SET_STRING_ELT(nms, 776, mkChar("dim_RiskChangeT_123456"));
  SET_STRING_ELT(nms, 777, mkChar("dim_RiskChangeT_2"));
  SET_STRING_ELT(nms, 778, mkChar("dim_RiskChangeT_3"));
  SET_STRING_ELT(nms, 779, mkChar("dim_RiskChangeT_4"));
  SET_STRING_ELT(nms, 780, mkChar("dim_RiskChangeT_5"));
  SET_STRING_ELT(nms, 781, mkChar("dim_RiskChangeT_6"));
  SET_STRING_ELT(nms, 782, mkChar("dim_RiskChangeT_7"));
  SET_STRING_ELT(nms, 783, mkChar("dim_RiskChangeU"));
  SET_STRING_ELT(nms, 784, mkChar("dim_RiskChangeU_1"));
  SET_STRING_ELT(nms, 785, mkChar("dim_RiskChangeU_12"));
  SET_STRING_ELT(nms, 786, mkChar("dim_RiskChangeU_123"));
  SET_STRING_ELT(nms, 787, mkChar("dim_RiskChangeU_1234"));
  SET_STRING_ELT(nms, 788, mkChar("dim_RiskChangeU_12345"));
  SET_STRING_ELT(nms, 789, mkChar("dim_RiskChangeU_123456"));
  SET_STRING_ELT(nms, 790, mkChar("dim_RiskChangeU_2"));
  SET_STRING_ELT(nms, 791, mkChar("dim_RiskChangeU_3"));
  SET_STRING_ELT(nms, 792, mkChar("dim_RiskChangeU_4"));
  SET_STRING_ELT(nms, 793, mkChar("dim_RiskChangeU_5"));
  SET_STRING_ELT(nms, 794, mkChar("dim_RiskChangeU_6"));
  SET_STRING_ELT(nms, 795, mkChar("dim_RiskChangeU_7"));
  SET_STRING_ELT(nms, 796, mkChar("dim_RiskHazard"));
  SET_STRING_ELT(nms, 797, mkChar("dim_RiskHazard_1"));
  SET_STRING_ELT(nms, 798, mkChar("dim_RiskHazard_12"));
  SET_STRING_ELT(nms, 799, mkChar("dim_RiskHazard_2"));
  SET_STRING_ELT(nms, 800, mkChar("dim_RiskHazard_3"));
  SET_STRING_ELT(nms, 801, mkChar("dim_RiskHazardData"));
  SET_STRING_ELT(nms, 802, mkChar("dim_RiskHazardData_1"));
  SET_STRING_ELT(nms, 803, mkChar("dim_RiskHazardData_12"));
  SET_STRING_ELT(nms, 804, mkChar("dim_RiskHazardData_123"));
  SET_STRING_ELT(nms, 805, mkChar("dim_RiskHazardData_2"));
  SET_STRING_ELT(nms, 806, mkChar("dim_RiskHazardData_3"));
  SET_STRING_ELT(nms, 807, mkChar("dim_RiskHazardData_4"));
  SET_STRING_ELT(nms, 808, mkChar("dim_Symp"));
  SET_STRING_ELT(nms, 809, mkChar("dim_Symp_1"));
  SET_STRING_ELT(nms, 810, mkChar("dim_Symp_12"));
  SET_STRING_ELT(nms, 811, mkChar("dim_Symp_123"));
  SET_STRING_ELT(nms, 812, mkChar("dim_Symp_1234"));
  SET_STRING_ELT(nms, 813, mkChar("dim_Symp_12345"));
  SET_STRING_ELT(nms, 814, mkChar("dim_Symp_123456"));
  SET_STRING_ELT(nms, 815, mkChar("dim_Symp_2"));
  SET_STRING_ELT(nms, 816, mkChar("dim_Symp_3"));
  SET_STRING_ELT(nms, 817, mkChar("dim_Symp_4"));
  SET_STRING_ELT(nms, 818, mkChar("dim_Symp_5"));
  SET_STRING_ELT(nms, 819, mkChar("dim_Symp_6"));
  SET_STRING_ELT(nms, 820, mkChar("dim_Symp_7"));
  SET_STRING_ELT(nms, 821, mkChar("dim_tbbottom"));
  SET_STRING_ELT(nms, 822, mkChar("dim_tbbottom_1"));
  SET_STRING_ELT(nms, 823, mkChar("dim_tbbottom_12"));
  SET_STRING_ELT(nms, 824, mkChar("dim_tbbottom_2"));
  SET_STRING_ELT(nms, 825, mkChar("dim_tbbottom_3"));
  SET_STRING_ELT(nms, 826, mkChar("dim_totalpops"));
  SET_STRING_ELT(nms, 827, mkChar("dim_totalpops_1"));
  SET_STRING_ELT(nms, 828, mkChar("dim_totalpops_12"));
  SET_STRING_ELT(nms, 829, mkChar("dim_totalpops_123"));
  SET_STRING_ELT(nms, 830, mkChar("dim_totalpops_1234"));
  SET_STRING_ELT(nms, 831, mkChar("dim_totalpops_12345"));
  SET_STRING_ELT(nms, 832, mkChar("dim_totalpops_123456"));
  SET_STRING_ELT(nms, 833, mkChar("dim_totalpops_2"));
  SET_STRING_ELT(nms, 834, mkChar("dim_totalpops_3"));
  SET_STRING_ELT(nms, 835, mkChar("dim_totalpops_4"));
  SET_STRING_ELT(nms, 836, mkChar("dim_totalpops_5"));
  SET_STRING_ELT(nms, 837, mkChar("dim_totalpops_6"));
  SET_STRING_ELT(nms, 838, mkChar("dim_totalpops_7"));
  SET_STRING_ELT(nms, 839, mkChar("dim_Treat"));
  SET_STRING_ELT(nms, 840, mkChar("dim_Treat_1"));
  SET_STRING_ELT(nms, 841, mkChar("dim_Treat_12"));
  SET_STRING_ELT(nms, 842, mkChar("dim_Treat_123"));
  SET_STRING_ELT(nms, 843, mkChar("dim_Treat_1234"));
  SET_STRING_ELT(nms, 844, mkChar("dim_Treat_12345"));
  SET_STRING_ELT(nms, 845, mkChar("dim_Treat_123456"));
  SET_STRING_ELT(nms, 846, mkChar("dim_Treat_2"));
  SET_STRING_ELT(nms, 847, mkChar("dim_Treat_3"));
  SET_STRING_ELT(nms, 848, mkChar("dim_Treat_4"));
  SET_STRING_ELT(nms, 849, mkChar("dim_Treat_5"));
  SET_STRING_ELT(nms, 850, mkChar("dim_Treat_6"));
  SET_STRING_ELT(nms, 851, mkChar("dim_Treat_7"));
  SET_STRING_ELT(nms, 852, mkChar("dim_treatmentends"));
  SET_STRING_ELT(nms, 853, mkChar("dim_treatmentends_1"));
  SET_STRING_ELT(nms, 854, mkChar("dim_treatmentends_12"));
  SET_STRING_ELT(nms, 855, mkChar("dim_treatmentends_123"));
  SET_STRING_ELT(nms, 856, mkChar("dim_treatmentends_1234"));
  SET_STRING_ELT(nms, 857, mkChar("dim_treatmentends_12345"));
  SET_STRING_ELT(nms, 858, mkChar("dim_treatmentends_123456"));
  SET_STRING_ELT(nms, 859, mkChar("dim_treatmentends_2"));
  SET_STRING_ELT(nms, 860, mkChar("dim_treatmentends_3"));
  SET_STRING_ELT(nms, 861, mkChar("dim_treatmentends_4"));
  SET_STRING_ELT(nms, 862, mkChar("dim_treatmentends_5"));
  SET_STRING_ELT(nms, 863, mkChar("dim_treatmentends_6"));
  SET_STRING_ELT(nms, 864, mkChar("dim_treatmentends_7"));
  SET_STRING_ELT(nms, 865, mkChar("dim_treatmentstarts"));
  SET_STRING_ELT(nms, 866, mkChar("dim_treatmentstarts_1"));
  SET_STRING_ELT(nms, 867, mkChar("dim_treatmentstarts_12"));
  SET_STRING_ELT(nms, 868, mkChar("dim_treatmentstarts_123"));
  SET_STRING_ELT(nms, 869, mkChar("dim_treatmentstarts_1234"));
  SET_STRING_ELT(nms, 870, mkChar("dim_treatmentstarts_12345"));
  SET_STRING_ELT(nms, 871, mkChar("dim_treatmentstarts_123456"));
  SET_STRING_ELT(nms, 872, mkChar("dim_treatmentstarts_2"));
  SET_STRING_ELT(nms, 873, mkChar("dim_treatmentstarts_3"));
  SET_STRING_ELT(nms, 874, mkChar("dim_treatmentstarts_4"));
  SET_STRING_ELT(nms, 875, mkChar("dim_treatmentstarts_5"));
  SET_STRING_ELT(nms, 876, mkChar("dim_treatmentstarts_6"));
  SET_STRING_ELT(nms, 877, mkChar("dim_treatmentstarts_7"));
  SET_STRING_ELT(nms, 878, mkChar("dim_ttp"));
  SET_STRING_ELT(nms, 879, mkChar("dim_Uninfected"));
  SET_STRING_ELT(nms, 880, mkChar("dim_Uninfected_1"));
  SET_STRING_ELT(nms, 881, mkChar("dim_Uninfected_12"));
  SET_STRING_ELT(nms, 882, mkChar("dim_Uninfected_123"));
  SET_STRING_ELT(nms, 883, mkChar("dim_Uninfected_1234"));
  SET_STRING_ELT(nms, 884, mkChar("dim_Uninfected_12345"));
  SET_STRING_ELT(nms, 885, mkChar("dim_Uninfected_123456"));
  SET_STRING_ELT(nms, 886, mkChar("dim_Uninfected_2"));
  SET_STRING_ELT(nms, 887, mkChar("dim_Uninfected_3"));
  SET_STRING_ELT(nms, 888, mkChar("dim_Uninfected_4"));
  SET_STRING_ELT(nms, 889, mkChar("dim_Uninfected_5"));
  SET_STRING_ELT(nms, 890, mkChar("dim_Uninfected_6"));
  SET_STRING_ELT(nms, 891, mkChar("dim_Uninfected_7"));
  SET_STRING_ELT(nms, 892, mkChar("foi"));
  SET_STRING_ELT(nms, 893, mkChar("fromtreatmentA"));
  SET_STRING_ELT(nms, 894, mkChar("fromtreatmentL"));
  SET_STRING_ELT(nms, 895, mkChar("immigration"));
  SET_STRING_ELT(nms, 896, mkChar("In"));
  SET_STRING_ELT(nms, 897, mkChar("initial_Asymp"));
  SET_STRING_ELT(nms, 898, mkChar("initial_Learly"));
  SET_STRING_ELT(nms, 899, mkChar("initial_Llate"));
  SET_STRING_ELT(nms, 900, mkChar("initial_Symp"));
  SET_STRING_ELT(nms, 901, mkChar("initial_Treat"));
  SET_STRING_ELT(nms, 902, mkChar("initial_Uninfected"));
  SET_STRING_ELT(nms, 903, mkChar("interpolate_bz"));
  SET_STRING_ELT(nms, 904, mkChar("interpolate_In"));
  SET_STRING_ELT(nms, 905, mkChar("interpolate_omega"));
  SET_STRING_ELT(nms, 906, mkChar("interpolate_RiskHazard"));
  SET_STRING_ELT(nms, 907, mkChar("lttp"));
  SET_STRING_ELT(nms, 908, mkChar("migrA"));
  SET_STRING_ELT(nms, 909, mkChar("migrage"));
  SET_STRING_ELT(nms, 910, mkChar("migrageinA"));
  SET_STRING_ELT(nms, 911, mkChar("migrageinE"));
  SET_STRING_ELT(nms, 912, mkChar("migrageinL"));
  SET_STRING_ELT(nms, 913, mkChar("migrageinS"));
  SET_STRING_ELT(nms, 914, mkChar("migrageinT"));
  SET_STRING_ELT(nms, 915, mkChar("migrageinU"));
  SET_STRING_ELT(nms, 916, mkChar("migrageoutA"));
  SET_STRING_ELT(nms, 917, mkChar("migrageoutE"));
  SET_STRING_ELT(nms, 918, mkChar("migrageoutL"));
  SET_STRING_ELT(nms, 919, mkChar("migrageoutS"));
  SET_STRING_ELT(nms, 920, mkChar("migrageoutT"));
  SET_STRING_ELT(nms, 921, mkChar("migrageoutU"));
  SET_STRING_ELT(nms, 922, mkChar("migrE"));
  SET_STRING_ELT(nms, 923, mkChar("migrL"));
  SET_STRING_ELT(nms, 924, mkChar("migrS"));
  SET_STRING_ELT(nms, 925, mkChar("migrT"));
  SET_STRING_ELT(nms, 926, mkChar("migrU"));
  SET_STRING_ELT(nms, 927, mkChar("mortality_treated"));
  SET_STRING_ELT(nms, 928, mkChar("mortality_untreated"));
  SET_STRING_ELT(nms, 929, mkChar("nage"));
  SET_STRING_ELT(nms, 930, mkChar("native"));
  SET_STRING_ELT(nms, 931, mkChar("nnat"));
  SET_STRING_ELT(nms, 932, mkChar("npost"));
  ...
  SET_STRING_ELT(nms, 940, mkChar("offset_variable_Treat"));
  SET_STRING_ELT(nms, 941, mkChar("omega"));
  SET_STRING_ELT(nms, 942, mkChar("Pmigr_nat"));
  SET_STRING_ELT(nms, 943, mkChar("Pmigr_post"));
  SET_STRING_ELT(nms, 944, mkChar("Pmigr_prot"));
  SET_STRING_ELT(nms, 945, mkChar("Pmigr_risk"));
  SET_STRING_ELT(nms, 946, mkChar("Pmigr_strain"));
  SET_STRING_ELT(nms, 947, mkChar("popdat"));
  SET_STRING_ELT(nms, 948, mkChar("popinitA"));
  SET_STRING_ELT(nms, 949, mkChar("popinitE"));
  SET_STRING_ELT(nms, 950, mkChar("popinitL"));
  SET_STRING_ELT(nms, 951, mkChar("popinitS"));
  SET_STRING_ELT(nms, 952, mkChar("popinitT"));
  SET_STRING_ELT(nms, 953, mkChar("popinitU"));
  SET_STRING_ELT(nms, 954, mkChar("PostTBprognA"));
  SET_STRING_ELT(nms, 955, mkChar("PostTBprognE"));
  SET_STRING_ELT(nms, 956, mkChar("PostTBprognL"));
  SET_STRING_ELT(nms, 957, mkChar("PostTBprognS"));
  SET_STRING_ELT(nms, 958, mkChar("PostTBprognT"));
  SET_STRING_ELT(nms, 959, mkChar("PostTBprognU"));
  SET_STRING_ELT(nms, 960, mkChar("progn_fast"));
  SET_STRING_ELT(nms, 961, mkChar("progn_posttb"));
  SET_STRING_ELT(nms, 962, mkChar("progn_slow"));
  SET_STRING_ELT(nms, 963, mkChar("progn_symp"));
  SET_STRING_ELT(nms, 964, mkChar("r"));
  SET_STRING_ELT(nms, 965, mkChar("relapse"));
  SET_STRING_ELT(nms, 966, mkChar("relapsefrompost"));
  SET_STRING_ELT(nms, 967, mkChar("RiskChangeA"));
  SET_STRING_ELT(nms, 968, mkChar("RiskChangeE"));
  SET_STRING_ELT(nms, 969, mkChar("RiskChangeL"));
  SET_STRING_ELT(nms, 970, mkChar("RiskChangeS"));
  SET_STRING_ELT(nms, 971, mkChar("RiskChangeT"));
  SET_STRING_ELT(nms, 972, mkChar("RiskChangeU"));
  SET_STRING_ELT(nms, 973, mkChar("RiskHazard"));
  SET_STRING_ELT(nms, 974, mkChar("RiskHazardData"));
  SET_STRING_ELT(nms, 975, mkChar("stabilization"));
  SET_STRING_ELT(nms, 976, mkChar("tbbottom"));
  SET_STRING_ELT(nms, 977, mkChar("tol"));
  SET_STRING_ELT(nms, 978, mkChar("totalpops"));
  SET_STRING_ELT(nms, 979, mkChar("treatment_inversedurn"));
  SET_STRING_ELT(nms, 980, mkChar("treatmentends"));
  SET_STRING_ELT(nms, 981, mkChar("treatmentstarts"));
  SET_STRING_ELT(nms, 982, mkChar("ttp"));
