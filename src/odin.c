...
SEXP ocaode_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 957));
  ...
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_fromtreatmentA));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_fromtreatmentA_1));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_fromtreatmentA_12));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_fromtreatmentA_123));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_fromtreatmentA_1234));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_fromtreatmentA_12345));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_fromtreatmentA_123456));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_fromtreatmentA_2));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_fromtreatmentA_3));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_fromtreatmentA_4));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_fromtreatmentA_5));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_fromtreatmentA_6));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_fromtreatmentA_7));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_fromtreatmentL));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_fromtreatmentL_1));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_fromtreatmentL_12));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_fromtreatmentL_123));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_fromtreatmentL_1234));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_fromtreatmentL_12345));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_fromtreatmentL_123456));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_fromtreatmentL_2));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_fromtreatmentL_3));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_fromtreatmentL_4));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_fromtreatmentL_5));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_fromtreatmentL_6));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_fromtreatmentL_7));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_immigration));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_immigration_1));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_immigration_12));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_immigration_2));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_immigration_3));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_In));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_In_1));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_In_2));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_Learly));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_Learly_1));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_Learly_12));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_Learly_123));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_Learly_1234));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_Learly_12345));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_Learly_123456));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_Learly_2));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_Learly_3));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_Learly_4));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_Learly_5));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_Learly_6));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_Learly_7));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_Llate));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_Llate_1));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_Llate_12));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_Llate_123));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_Llate_1234));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_Llate_12345));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_Llate_123456));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_Llate_2));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_Llate_3));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_Llate_4));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_Llate_5));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_Llate_6));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_Llate_7));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_migrA));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_migrA_1));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_migrA_12));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_migrA_123));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_migrA_1234));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_migrA_12345));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_migrA_123456));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_migrA_2));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_migrA_3));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_migrA_4));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_migrA_5));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_migrA_6));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_migrA_7));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_migrage));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_migrageinA));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_migrageinA_1));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_migrageinA_12));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_migrageinA_123));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_migrageinA_1234));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_migrageinA_12345));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_migrageinA_123456));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_migrageinA_2));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_migrageinA_3));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_migrageinA_4));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_migrageinA_5));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_migrageinA_6));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_migrageinA_7));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_migrageinE));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_migrageinE_1));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_migrageinE_12));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_migrageinE_123));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_migrageinE_1234));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_migrageinE_12345));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_migrageinE_123456));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_migrageinE_2));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_migrageinE_3));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_migrageinE_4));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_migrageinE_5));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_migrageinE_6));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_migrageinE_7));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_migrageinL));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_migrageinL_1));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_migrageinL_12));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_migrageinL_123));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_migrageinL_1234));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_migrageinL_12345));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_migrageinL_123456));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_migrageinL_2));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_migrageinL_3));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_migrageinL_4));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_migrageinL_5));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_migrageinL_6));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_migrageinL_7));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_migrageinS));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_migrageinS_1));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_migrageinS_12));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_migrageinS_123));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_migrageinS_1234));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_migrageinS_12345));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_migrageinS_123456));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_migrageinS_2));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_migrageinS_3));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_migrageinS_4));
  SET_VECTOR_ELT(contents, 314, ScalarInteger(internal->dim_migrageinS_5));
  SET_VECTOR_ELT(contents, 315, ScalarInteger(internal->dim_migrageinS_6));
  SET_VECTOR_ELT(contents, 316, ScalarInteger(internal->dim_migrageinS_7));
  SET_VECTOR_ELT(contents, 317, ScalarInteger(internal->dim_migrageinT));
  SET_VECTOR_ELT(contents, 318, ScalarInteger(internal->dim_migrageinT_1));
  SET_VECTOR_ELT(contents, 319, ScalarInteger(internal->dim_migrageinT_12));
  SET_VECTOR_ELT(contents, 320, ScalarInteger(internal->dim_migrageinT_123));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->dim_migrageinT_1234));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->dim_migrageinT_12345));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->dim_migrageinT_123456));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->dim_migrageinT_2));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->dim_migrageinT_3));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->dim_migrageinT_4));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->dim_migrageinT_5));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->dim_migrageinT_6));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->dim_migrageinT_7));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->dim_migrageinU));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->dim_migrageinU_1));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->dim_migrageinU_12));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->dim_migrageinU_123));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->dim_migrageinU_1234));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->dim_migrageinU_12345));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->dim_migrageinU_123456));
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->dim_migrageinU_2));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->dim_migrageinU_3));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->dim_migrageinU_4));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->dim_migrageinU_5));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->dim_migrageinU_6));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->dim_migrageinU_7));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->dim_migrageoutA));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->dim_migrageoutA_1));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->dim_migrageoutA_12));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->dim_migrageoutA_123));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->dim_migrageoutA_1234));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->dim_migrageoutA_12345));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->dim_migrageoutA_123456));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->dim_migrageoutA_2));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->dim_migrageoutA_3));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->dim_migrageoutA_4));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->dim_migrageoutA_5));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->dim_migrageoutA_6));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->dim_migrageoutA_7));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->dim_migrageoutE));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->dim_migrageoutE_1));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->dim_migrageoutE_12));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->dim_migrageoutE_123));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->dim_migrageoutE_1234));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->dim_migrageoutE_12345));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->dim_migrageoutE_123456));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->dim_migrageoutE_2));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->dim_migrageoutE_3));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->dim_migrageoutE_4));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->dim_migrageoutE_5));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->dim_migrageoutE_6));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->dim_migrageoutE_7));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->dim_migrageoutL));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->dim_migrageoutL_1));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->dim_migrageoutL_12));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->dim_migrageoutL_123));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->dim_migrageoutL_1234));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->dim_migrageoutL_12345));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->dim_migrageoutL_123456));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->dim_migrageoutL_2));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->dim_migrageoutL_3));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->dim_migrageoutL_4));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->dim_migrageoutL_5));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->dim_migrageoutL_6));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->dim_migrageoutL_7));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->dim_migrageoutS));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->dim_migrageoutS_1));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->dim_migrageoutS_12));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->dim_migrageoutS_123));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->dim_migrageoutS_1234));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->dim_migrageoutS_12345));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->dim_migrageoutS_123456));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->dim_migrageoutS_2));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->dim_migrageoutS_3));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->dim_migrageoutS_4));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->dim_migrageoutS_5));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->dim_migrageoutS_6));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->dim_migrageoutS_7));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->dim_migrageoutT));
  SET_VECTOR_ELT(contents, 396, ScalarInteger(internal->dim_migrageoutT_1));
  SET_VECTOR_ELT(contents, 397, ScalarInteger(internal->dim_migrageoutT_12));
  SET_VECTOR_ELT(contents, 398, ScalarInteger(internal->dim_migrageoutT_123));
  SET_VECTOR_ELT(contents, 399, ScalarInteger(internal->dim_migrageoutT_1234));
  SET_VECTOR_ELT(contents, 400, ScalarInteger(internal->dim_migrageoutT_12345));
  SET_VECTOR_ELT(contents, 401, ScalarInteger(internal->dim_migrageoutT_123456));
  SET_VECTOR_ELT(contents, 402, ScalarInteger(internal->dim_migrageoutT_2));
  SET_VECTOR_ELT(contents, 403, ScalarInteger(internal->dim_migrageoutT_3));
  SET_VECTOR_ELT(contents, 404, ScalarInteger(internal->dim_migrageoutT_4));
  SET_VECTOR_ELT(contents, 405, ScalarInteger(internal->dim_migrageoutT_5));
  SET_VECTOR_ELT(contents, 406, ScalarInteger(internal->dim_migrageoutT_6));
  SET_VECTOR_ELT(contents, 407, ScalarInteger(internal->dim_migrageoutT_7));
  SET_VECTOR_ELT(contents, 408, ScalarInteger(internal->dim_migrageoutU));
  SET_VECTOR_ELT(contents, 409, ScalarInteger(internal->dim_migrageoutU_1));
  SET_VECTOR_ELT(contents, 410, ScalarInteger(internal->dim_migrageoutU_12));
  SET_VECTOR_ELT(contents, 411, ScalarInteger(internal->dim_migrageoutU_123));
  SET_VECTOR_ELT(contents, 412, ScalarInteger(internal->dim_migrageoutU_1234));
  SET_VECTOR_ELT(contents, 413, ScalarInteger(internal->dim_migrageoutU_12345));
  SET_VECTOR_ELT(contents, 414, ScalarInteger(internal->dim_migrageoutU_123456));
  SET_VECTOR_ELT(contents, 415, ScalarInteger(internal->dim_migrageoutU_2));
  SET_VECTOR_ELT(contents, 416, ScalarInteger(internal->dim_migrageoutU_3));
  SET_VECTOR_ELT(contents, 417, ScalarInteger(internal->dim_migrageoutU_4));
  SET_VECTOR_ELT(contents, 418, ScalarInteger(internal->dim_migrageoutU_5));
  SET_VECTOR_ELT(contents, 419, ScalarInteger(internal->dim_migrageoutU_6));
  SET_VECTOR_ELT(contents, 420, ScalarInteger(internal->dim_migrageoutU_7));
  SET_VECTOR_ELT(contents, 421, ScalarInteger(internal->dim_migrE));
  SET_VECTOR_ELT(contents, 422, ScalarInteger(internal->dim_migrE_1));
  SET_VECTOR_ELT(contents, 423, ScalarInteger(internal->dim_migrE_12));
  SET_VECTOR_ELT(contents, 424, ScalarInteger(internal->dim_migrE_123));
  SET_VECTOR_ELT(contents, 425, ScalarInteger(internal->dim_migrE_1234));
  SET_VECTOR_ELT(contents, 426, ScalarInteger(internal->dim_migrE_12345));
  SET_VECTOR_ELT(contents, 427, ScalarInteger(internal->dim_migrE_123456));
  SET_VECTOR_ELT(contents, 428, ScalarInteger(internal->dim_migrE_2));
  SET_VECTOR_ELT(contents, 429, ScalarInteger(internal->dim_migrE_3));
  SET_VECTOR_ELT(contents, 430, ScalarInteger(internal->dim_migrE_4));
  SET_VECTOR_ELT(contents, 431, ScalarInteger(internal->dim_migrE_5));
  SET_VECTOR_ELT(contents, 432, ScalarInteger(internal->dim_migrE_6));
  SET_VECTOR_ELT(contents, 433, ScalarInteger(internal->dim_migrE_7));
  SET_VECTOR_ELT(contents, 434, ScalarInteger(internal->dim_migrL));
  SET_VECTOR_ELT(contents, 435, ScalarInteger(internal->dim_migrL_1));
  SET_VECTOR_ELT(contents, 436, ScalarInteger(internal->dim_migrL_12));
  SET_VECTOR_ELT(contents, 437, ScalarInteger(internal->dim_migrL_123));
  SET_VECTOR_ELT(contents, 438, ScalarInteger(internal->dim_migrL_1234));
  SET_VECTOR_ELT(contents, 439, ScalarInteger(internal->dim_migrL_12345));
  SET_VECTOR_ELT(contents, 440, ScalarInteger(internal->dim_migrL_123456));
  SET_VECTOR_ELT(contents, 441, ScalarInteger(internal->dim_migrL_2));
  SET_VECTOR_ELT(contents, 442, ScalarInteger(internal->dim_migrL_3));
  SET_VECTOR_ELT(contents, 443, ScalarInteger(internal->dim_migrL_4));
  SET_VECTOR_ELT(contents, 444, ScalarInteger(internal->dim_migrL_5));
  SET_VECTOR_ELT(contents, 445, ScalarInteger(internal->dim_migrL_6));
  SET_VECTOR_ELT(contents, 446, ScalarInteger(internal->dim_migrL_7));
  SET_VECTOR_ELT(contents, 447, ScalarInteger(internal->dim_migrS));
  SET_VECTOR_ELT(contents, 448, ScalarInteger(internal->dim_migrS_1));
  SET_VECTOR_ELT(contents, 449, ScalarInteger(internal->dim_migrS_12));
  SET_VECTOR_ELT(contents, 450, ScalarInteger(internal->dim_migrS_123));
  SET_VECTOR_ELT(contents, 451, ScalarInteger(internal->dim_migrS_1234));
  SET_VECTOR_ELT(contents, 452, ScalarInteger(internal->dim_migrS_12345));
  SET_VECTOR_ELT(contents, 453, ScalarInteger(internal->dim_migrS_123456));
  SET_VECTOR_ELT(contents, 454, ScalarInteger(internal->dim_migrS_2));
  SET_VECTOR_ELT(contents, 455, ScalarInteger(internal->dim_migrS_3));
  SET_VECTOR_ELT(contents, 456, ScalarInteger(internal->dim_migrS_4));
  SET_VECTOR_ELT(contents, 457, ScalarInteger(internal->dim_migrS_5));
  SET_VECTOR_ELT(contents, 458, ScalarInteger(internal->dim_migrS_6));
  SET_VECTOR_ELT(contents, 459, ScalarInteger(internal->dim_migrS_7));
  SET_VECTOR_ELT(contents, 460, ScalarInteger(internal->dim_migrT));
  SET_VECTOR_ELT(contents, 461, ScalarInteger(internal->dim_migrT_1));
  SET_VECTOR_ELT(contents, 462, ScalarInteger(internal->dim_migrT_12));
  SET_VECTOR_ELT(contents, 463, ScalarInteger(internal->dim_migrT_123));
  SET_VECTOR_ELT(contents, 464, ScalarInteger(internal->dim_migrT_1234));
  SET_VECTOR_ELT(contents, 465, ScalarInteger(internal->dim_migrT_12345));
  SET_VECTOR_ELT(contents, 466, ScalarInteger(internal->dim_migrT_123456));
  SET_VECTOR_ELT(contents, 467, ScalarInteger(internal->dim_migrT_2));
  SET_VECTOR_ELT(contents, 468, ScalarInteger(internal->dim_migrT_3));
  SET_VECTOR_ELT(contents, 469, ScalarInteger(internal->dim_migrT_4));
  SET_VECTOR_ELT(contents, 470, ScalarInteger(internal->dim_migrT_5));
  SET_VECTOR_ELT(contents, 471, ScalarInteger(internal->dim_migrT_6));
  SET_VECTOR_ELT(contents, 472, ScalarInteger(internal->dim_migrT_7));
  SET_VECTOR_ELT(contents, 473, ScalarInteger(internal->dim_migrU));
  SET_VECTOR_ELT(contents, 474, ScalarInteger(internal->dim_migrU_1));
  SET_VECTOR_ELT(contents, 475, ScalarInteger(internal->dim_migrU_12));
  SET_VECTOR_ELT(contents, 476, ScalarInteger(internal->dim_migrU_123));
  SET_VECTOR_ELT(contents, 477, ScalarInteger(internal->dim_migrU_1234));
  SET_VECTOR_ELT(contents, 478, ScalarInteger(internal->dim_migrU_12345));
  SET_VECTOR_ELT(contents, 479, ScalarInteger(internal->dim_migrU_123456));
  SET_VECTOR_ELT(contents, 480, ScalarInteger(internal->dim_migrU_2));
  SET_VECTOR_ELT(contents, 481, ScalarInteger(internal->dim_migrU_3));
  SET_VECTOR_ELT(contents, 482, ScalarInteger(internal->dim_migrU_4));
  SET_VECTOR_ELT(contents, 483, ScalarInteger(internal->dim_migrU_5));
  SET_VECTOR_ELT(contents, 484, ScalarInteger(internal->dim_migrU_6));
  SET_VECTOR_ELT(contents, 485, ScalarInteger(internal->dim_migrU_7));
  SET_VECTOR_ELT(contents, 486, ScalarInteger(internal->dim_native));
  SET_VECTOR_ELT(contents, 487, ScalarInteger(internal->dim_omega));
  SET_VECTOR_ELT(contents, 488, ScalarInteger(internal->dim_omega_1));
  SET_VECTOR_ELT(contents, 489, ScalarInteger(internal->dim_omega_2));
  SET_VECTOR_ELT(contents, 490, ScalarInteger(internal->dim_Pmigr_nat));
  SET_VECTOR_ELT(contents, 491, ScalarInteger(internal->dim_Pmigr_post));
  SET_VECTOR_ELT(contents, 492, ScalarInteger(internal->dim_Pmigr_post_1));
  SET_VECTOR_ELT(contents, 493, ScalarInteger(internal->dim_Pmigr_post_2));
  SET_VECTOR_ELT(contents, 494, ScalarInteger(internal->dim_Pmigr_prot));
  SET_VECTOR_ELT(contents, 495, ScalarInteger(internal->dim_Pmigr_prot_1));
  SET_VECTOR_ELT(contents, 496, ScalarInteger(internal->dim_Pmigr_prot_2));
  SET_VECTOR_ELT(contents, 497, ScalarInteger(internal->dim_Pmigr_risk));
  SET_VECTOR_ELT(contents, 498, ScalarInteger(internal->dim_Pmigr_risk_1));
  SET_VECTOR_ELT(contents, 499, ScalarInteger(internal->dim_Pmigr_risk_2));
  SET_VECTOR_ELT(contents, 500, ScalarInteger(internal->dim_Pmigr_strain));
  SET_VECTOR_ELT(contents, 501, ScalarInteger(internal->dim_Pmigr_strain_1));
  SET_VECTOR_ELT(contents, 502, ScalarInteger(internal->dim_Pmigr_strain_2));
  SET_VECTOR_ELT(contents, 503, ScalarInteger(internal->dim_popdat));
  SET_VECTOR_ELT(contents, 504, ScalarInteger(internal->dim_popdat_1));
  SET_VECTOR_ELT(contents, 505, ScalarInteger(internal->dim_popdat_12));
  SET_VECTOR_ELT(contents, 506, ScalarInteger(internal->dim_popdat_2));
  SET_VECTOR_ELT(contents, 507, ScalarInteger(internal->dim_popdat_3));
  SET_VECTOR_ELT(contents, 508, ScalarInteger(internal->dim_popinitA));
  SET_VECTOR_ELT(contents, 509, ScalarInteger(internal->dim_popinitA_1));
  SET_VECTOR_ELT(contents, 510, ScalarInteger(internal->dim_popinitA_12));
  SET_VECTOR_ELT(contents, 511, ScalarInteger(internal->dim_popinitA_123));
  SET_VECTOR_ELT(contents, 512, ScalarInteger(internal->dim_popinitA_1234));
  SET_VECTOR_ELT(contents, 513, ScalarInteger(internal->dim_popinitA_12345));
  SET_VECTOR_ELT(contents, 514, ScalarInteger(internal->dim_popinitA_123456));
  SET_VECTOR_ELT(contents, 515, ScalarInteger(internal->dim_popinitA_2));
  SET_VECTOR_ELT(contents, 516, ScalarInteger(internal->dim_popinitA_3));
  SET_VECTOR_ELT(contents, 517, ScalarInteger(internal->dim_popinitA_4));
  SET_VECTOR_ELT(contents, 518, ScalarInteger(internal->dim_popinitA_5));
  SET_VECTOR_ELT(contents, 519, ScalarInteger(internal->dim_popinitA_6));
  SET_VECTOR_ELT(contents, 520, ScalarInteger(internal->dim_popinitA_7));
  SET_VECTOR_ELT(contents, 521, ScalarInteger(internal->dim_popinitE));
  SET_VECTOR_ELT(contents, 522, ScalarInteger(internal->dim_popinitE_1));
  SET_VECTOR_ELT(contents, 523, ScalarInteger(internal->dim_popinitE_12));
  SET_VECTOR_ELT(contents, 524, ScalarInteger(internal->dim_popinitE_123));
  SET_VECTOR_ELT(contents, 525, ScalarInteger(internal->dim_popinitE_1234));
  SET_VECTOR_ELT(contents, 526, ScalarInteger(internal->dim_popinitE_12345));
  SET_VECTOR_ELT(contents, 527, ScalarInteger(internal->dim_popinitE_123456));
  SET_VECTOR_ELT(contents, 528, ScalarInteger(internal->dim_popinitE_2));
  SET_VECTOR_ELT(contents, 529, ScalarInteger(internal->dim_popinitE_3));
  SET_VECTOR_ELT(contents, 530, ScalarInteger(internal->dim_popinitE_4));
  SET_VECTOR_ELT(contents, 531, ScalarInteger(internal->dim_popinitE_5));
  SET_VECTOR_ELT(contents, 532, ScalarInteger(internal->dim_popinitE_6));
  SET_VECTOR_ELT(contents, 533, ScalarInteger(internal->dim_popinitE_7));
  SET_VECTOR_ELT(contents, 534, ScalarInteger(internal->dim_popinitL));
  SET_VECTOR_ELT(contents, 535, ScalarInteger(internal->dim_popinitL_1));
  SET_VECTOR_ELT(contents, 536, ScalarInteger(internal->dim_popinitL_12));
  SET_VECTOR_ELT(contents, 537, ScalarInteger(internal->dim_popinitL_123));
  SET_VECTOR_ELT(contents, 538, ScalarInteger(internal->dim_popinitL_1234));
  SET_VECTOR_ELT(contents, 539, ScalarInteger(internal->dim_popinitL_12345));
  SET_VECTOR_ELT(contents, 540, ScalarInteger(internal->dim_popinitL_123456));
  SET_VECTOR_ELT(contents, 541, ScalarInteger(internal->dim_popinitL_2));
  SET_VECTOR_ELT(contents, 542, ScalarInteger(internal->dim_popinitL_3));
  SET_VECTOR_ELT(contents, 543, ScalarInteger(internal->dim_popinitL_4));
  SET_VECTOR_ELT(contents, 544, ScalarInteger(internal->dim_popinitL_5));
  SET_VECTOR_ELT(contents, 545, ScalarInteger(internal->dim_popinitL_6));
  SET_VECTOR_ELT(contents, 546, ScalarInteger(internal->dim_popinitL_7));
  SET_VECTOR_ELT(contents, 547, ScalarInteger(internal->dim_popinitS));
  SET_VECTOR_ELT(contents, 548, ScalarInteger(internal->dim_popinitS_1));
  SET_VECTOR_ELT(contents, 549, ScalarInteger(internal->dim_popinitS_12));
  SET_VECTOR_ELT(contents, 550, ScalarInteger(internal->dim_popinitS_123));
  SET_VECTOR_ELT(contents, 551, ScalarInteger(internal->dim_popinitS_1234));
  SET_VECTOR_ELT(contents, 552, ScalarInteger(internal->dim_popinitS_12345));
  SET_VECTOR_ELT(contents, 553, ScalarInteger(internal->dim_popinitS_123456));
  SET_VECTOR_ELT(contents, 554, ScalarInteger(internal->dim_popinitS_2));
  SET_VECTOR_ELT(contents, 555, ScalarInteger(internal->dim_popinitS_3));
  SET_VECTOR_ELT(contents, 556, ScalarInteger(internal->dim_popinitS_4));
  SET_VECTOR_ELT(contents, 557, ScalarInteger(internal->dim_popinitS_5));
  SET_VECTOR_ELT(contents, 558, ScalarInteger(internal->dim_popinitS_6));
  SET_VECTOR_ELT(contents, 559, ScalarInteger(internal->dim_popinitS_7));
  SET_VECTOR_ELT(contents, 560, ScalarInteger(internal->dim_popinitT));
  SET_VECTOR_ELT(contents, 561, ScalarInteger(internal->dim_popinitT_1));
  SET_VECTOR_ELT(contents, 562, ScalarInteger(internal->dim_popinitT_12));
  SET_VECTOR_ELT(contents, 563, ScalarInteger(internal->dim_popinitT_123));
  SET_VECTOR_ELT(contents, 564, ScalarInteger(internal->dim_popinitT_1234));
  SET_VECTOR_ELT(contents, 565, ScalarInteger(internal->dim_popinitT_12345));
  SET_VECTOR_ELT(contents, 566, ScalarInteger(internal->dim_popinitT_123456));
  SET_VECTOR_ELT(contents, 567, ScalarInteger(internal->dim_popinitT_2));
  SET_VECTOR_ELT(contents, 568, ScalarInteger(internal->dim_popinitT_3));
  SET_VECTOR_ELT(contents, 569, ScalarInteger(internal->dim_popinitT_4));
  SET_VECTOR_ELT(contents, 570, ScalarInteger(internal->dim_popinitT_5));
  SET_VECTOR_ELT(contents, 571, ScalarInteger(internal->dim_popinitT_6));
  SET_VECTOR_ELT(contents, 572, ScalarInteger(internal->dim_popinitT_7));
  SET_VECTOR_ELT(contents, 573, ScalarInteger(internal->dim_popinitU));
  SET_VECTOR_ELT(contents, 574, ScalarInteger(internal->dim_popinitU_1));
  SET_VECTOR_ELT(contents, 575, ScalarInteger(internal->dim_popinitU_12));
  SET_VECTOR_ELT(contents, 576, ScalarInteger(internal->dim_popinitU_123));
  SET_VECTOR_ELT(contents, 577, ScalarInteger(internal->dim_popinitU_1234));
  SET_VECTOR_ELT(contents, 578, ScalarInteger(internal->dim_popinitU_12345));
  SET_VECTOR_ELT(contents, 579, ScalarInteger(internal->dim_popinitU_123456));
  SET_VECTOR_ELT(contents, 580, ScalarInteger(internal->dim_popinitU_2));
  SET_VECTOR_ELT(contents, 581, ScalarInteger(internal->dim_popinitU_3));
  SET_VECTOR_ELT(contents, 582, ScalarInteger(internal->dim_popinitU_4));
  SET_VECTOR_ELT(contents, 583, ScalarInteger(internal->dim_popinitU_5));
  SET_VECTOR_ELT(contents, 584, ScalarInteger(internal->dim_popinitU_6));
  SET_VECTOR_ELT(contents, 585, ScalarInteger(internal->dim_popinitU_7));
  SET_VECTOR_ELT(contents, 586, ScalarInteger(internal->dim_PostTBprognA));
  SET_VECTOR_ELT(contents, 587, ScalarInteger(internal->dim_PostTBprognA_1));
  SET_VECTOR_ELT(contents, 588, ScalarInteger(internal->dim_PostTBprognA_12));
  SET_VECTOR_ELT(contents, 589, ScalarInteger(internal->dim_PostTBprognA_123));
  SET_VECTOR_ELT(contents, 590, ScalarInteger(internal->dim_PostTBprognA_1234));
  SET_VECTOR_ELT(contents, 591, ScalarInteger(internal->dim_PostTBprognA_12345));
  SET_VECTOR_ELT(contents, 592, ScalarInteger(internal->dim_PostTBprognA_123456));
  SET_VECTOR_ELT(contents, 593, ScalarInteger(internal->dim_PostTBprognA_2));
  SET_VECTOR_ELT(contents, 594, ScalarInteger(internal->dim_PostTBprognA_3));
  SET_VECTOR_ELT(contents, 595, ScalarInteger(internal->dim_PostTBprognA_4));
  SET_VECTOR_ELT(contents, 596, ScalarInteger(internal->dim_PostTBprognA_5));
  SET_VECTOR_ELT(contents, 597, ScalarInteger(internal->dim_PostTBprognA_6));
  SET_VECTOR_ELT(contents, 598, ScalarInteger(internal->dim_PostTBprognA_7));
  SET_VECTOR_ELT(contents, 599, ScalarInteger(internal->dim_PostTBprognE));
  SET_VECTOR_ELT(contents, 600, ScalarInteger(internal->dim_PostTBprognE_1));
  SET_VECTOR_ELT(contents, 601, ScalarInteger(internal->dim_PostTBprognE_12));
  SET_VECTOR_ELT(contents, 602, ScalarInteger(internal->dim_PostTBprognE_123));
  SET_VECTOR_ELT(contents, 603, ScalarInteger(internal->dim_PostTBprognE_1234));
  SET_VECTOR_ELT(contents, 604, ScalarInteger(internal->dim_PostTBprognE_12345));
  SET_VECTOR_ELT(contents, 605, ScalarInteger(internal->dim_PostTBprognE_123456));
  SET_VECTOR_ELT(contents, 606, ScalarInteger(internal->dim_PostTBprognE_2));
  SET_VECTOR_ELT(contents, 607, ScalarInteger(internal->dim_PostTBprognE_3));
  SET_VECTOR_ELT(contents, 608, ScalarInteger(internal->dim_PostTBprognE_4));
  SET_VECTOR_ELT(contents, 609, ScalarInteger(internal->dim_PostTBprognE_5));
  SET_VECTOR_ELT(contents, 610, ScalarInteger(internal->dim_PostTBprognE_6));
  SET_VECTOR_ELT(contents, 611, ScalarInteger(internal->dim_PostTBprognE_7));
  SET_VECTOR_ELT(contents, 612, ScalarInteger(internal->dim_PostTBprognL));
  SET_VECTOR_ELT(contents, 613, ScalarInteger(internal->dim_PostTBprognL_1));
  SET_VECTOR_ELT(contents, 614, ScalarInteger(internal->dim_PostTBprognL_12));
  SET_VECTOR_ELT(contents, 615, ScalarInteger(internal->dim_PostTBprognL_123));
  SET_VECTOR_ELT(contents, 616, ScalarInteger(internal->dim_PostTBprognL_1234));
  SET_VECTOR_ELT(contents, 617, ScalarInteger(internal->dim_PostTBprognL_12345));
  SET_VECTOR_ELT(contents, 618, ScalarInteger(internal->dim_PostTBprognL_123456));
  SET_VECTOR_ELT(contents, 619, ScalarInteger(internal->dim_PostTBprognL_2));
  SET_VECTOR_ELT(contents, 620, ScalarInteger(internal->dim_PostTBprognL_3));
  SET_VECTOR_ELT(contents, 621, ScalarInteger(internal->dim_PostTBprognL_4));
  SET_VECTOR_ELT(contents, 622, ScalarInteger(internal->dim_PostTBprognL_5));
  SET_VECTOR_ELT(contents, 623, ScalarInteger(internal->dim_PostTBprognL_6));
  SET_VECTOR_ELT(contents, 624, ScalarInteger(internal->dim_PostTBprognL_7));
  SET_VECTOR_ELT(contents, 625, ScalarInteger(internal->dim_PostTBprognS));
  SET_VECTOR_ELT(contents, 626, ScalarInteger(internal->dim_PostTBprognS_1));
  SET_VECTOR_ELT(contents, 627, ScalarInteger(internal->dim_PostTBprognS_12));
  SET_VECTOR_ELT(contents, 628, ScalarInteger(internal->dim_PostTBprognS_123));
  SET_VECTOR_ELT(contents, 629, ScalarInteger(internal->dim_PostTBprognS_1234));
  SET_VECTOR_ELT(contents, 630, ScalarInteger(internal->dim_PostTBprognS_12345));
  SET_VECTOR_ELT(contents, 631, ScalarInteger(internal->dim_PostTBprognS_123456));
  SET_VECTOR_ELT(contents, 632, ScalarInteger(internal->dim_PostTBprognS_2));
  SET_VECTOR_ELT(contents, 633, ScalarInteger(internal->dim_PostTBprognS_3));
  SET_VECTOR_ELT(contents, 634, ScalarInteger(internal->dim_PostTBprognS_4));
  SET_VECTOR_ELT(contents, 635, ScalarInteger(internal->dim_PostTBprognS_5));
  SET_VECTOR_ELT(contents, 636, ScalarInteger(internal->dim_PostTBprognS_6));
  SET_VECTOR_ELT(contents, 637, ScalarInteger(internal->dim_PostTBprognS_7));
  SET_VECTOR_ELT(contents, 638, ScalarInteger(internal->dim_PostTBprognT));
  SET_VECTOR_ELT(contents, 639, ScalarInteger(internal->dim_PostTBprognT_1));
  SET_VECTOR_ELT(contents, 640, ScalarInteger(internal->dim_PostTBprognT_12));
  SET_VECTOR_ELT(contents, 641, ScalarInteger(internal->dim_PostTBprognT_123));
  SET_VECTOR_ELT(contents, 642, ScalarInteger(internal->dim_PostTBprognT_1234));
  SET_VECTOR_ELT(contents, 643, ScalarInteger(internal->dim_PostTBprognT_12345));
  SET_VECTOR_ELT(contents, 644, ScalarInteger(internal->dim_PostTBprognT_123456));
  SET_VECTOR_ELT(contents, 645, ScalarInteger(internal->dim_PostTBprognT_2));
  SET_VECTOR_ELT(contents, 646, ScalarInteger(internal->dim_PostTBprognT_3));
  SET_VECTOR_ELT(contents, 647, ScalarInteger(internal->dim_PostTBprognT_4));
  SET_VECTOR_ELT(contents, 648, ScalarInteger(internal->dim_PostTBprognT_5));
  SET_VECTOR_ELT(contents, 649, ScalarInteger(internal->dim_PostTBprognT_6));
  SET_VECTOR_ELT(contents, 650, ScalarInteger(internal->dim_PostTBprognT_7));
  SET_VECTOR_ELT(contents, 651, ScalarInteger(internal->dim_PostTBprognU));
  SET_VECTOR_ELT(contents, 652, ScalarInteger(internal->dim_PostTBprognU_1));
  SET_VECTOR_ELT(contents, 653, ScalarInteger(internal->dim_PostTBprognU_12));
  SET_VECTOR_ELT(contents, 654, ScalarInteger(internal->dim_PostTBprognU_123));
  SET_VECTOR_ELT(contents, 655, ScalarInteger(internal->dim_PostTBprognU_1234));
  SET_VECTOR_ELT(contents, 656, ScalarInteger(internal->dim_PostTBprognU_12345));
  SET_VECTOR_ELT(contents, 657, ScalarInteger(internal->dim_PostTBprognU_123456));
  SET_VECTOR_ELT(contents, 658, ScalarInteger(internal->dim_PostTBprognU_2));
  SET_VECTOR_ELT(contents, 659, ScalarInteger(internal->dim_PostTBprognU_3));
  SET_VECTOR_ELT(contents, 660, ScalarInteger(internal->dim_PostTBprognU_4));
  SET_VECTOR_ELT(contents, 661, ScalarInteger(internal->dim_PostTBprognU_5));
  SET_VECTOR_ELT(contents, 662, ScalarInteger(internal->dim_PostTBprognU_6));
  ...
  SET_VECTOR_ELT(contents, 666, ScalarInteger(internal->dim_rate_tbmortality));
  SET_VECTOR_ELT(contents, 667, ScalarInteger(internal->dim_rate_tbmortality_1));
  SET_VECTOR_ELT(contents, 668, ScalarInteger(internal->dim_rate_tbmortality_12));
  SET_VECTOR_ELT(contents, 669, ScalarInteger(internal->dim_rate_tbmortality_123));
  SET_VECTOR_ELT(contents, 670, ScalarInteger(internal->dim_rate_tbmortality_1234));
  SET_VECTOR_ELT(contents, 671, ScalarInteger(internal->dim_rate_tbmortality_12345));
  SET_VECTOR_ELT(contents, 672, ScalarInteger(internal->dim_rate_tbmortality_123456));
  SET_VECTOR_ELT(contents, 673, ScalarInteger(internal->dim_rate_tbmortality_2));
  SET_VECTOR_ELT(contents, 674, ScalarInteger(internal->dim_rate_tbmortality_3));
  SET_VECTOR_ELT(contents, 675, ScalarInteger(internal->dim_rate_tbmortality_4));
  SET_VECTOR_ELT(contents, 676, ScalarInteger(internal->dim_rate_tbmortality_5));
  SET_VECTOR_ELT(contents, 677, ScalarInteger(internal->dim_rate_tbmortality_6));
  SET_VECTOR_ELT(contents, 678, ScalarInteger(internal->dim_rate_tbmortality_7));
  SET_VECTOR_ELT(contents, 679, ScalarInteger(internal->dim_relapsefrompost));
  SET_VECTOR_ELT(contents, 680, ScalarInteger(internal->dim_relapsefrompost_1));
  SET_VECTOR_ELT(contents, 681, ScalarInteger(internal->dim_relapsefrompost_12));
  SET_VECTOR_ELT(contents, 682, ScalarInteger(internal->dim_relapsefrompost_123));
  SET_VECTOR_ELT(contents, 683, ScalarInteger(internal->dim_relapsefrompost_1234));
  SET_VECTOR_ELT(contents, 684, ScalarInteger(internal->dim_relapsefrompost_12345));
  SET_VECTOR_ELT(contents, 685, ScalarInteger(internal->dim_relapsefrompost_123456));
  SET_VECTOR_ELT(contents, 686, ScalarInteger(internal->dim_relapsefrompost_2));
  SET_VECTOR_ELT(contents, 687, ScalarInteger(internal->dim_relapsefrompost_3));
  SET_VECTOR_ELT(contents, 688, ScalarInteger(internal->dim_relapsefrompost_4));
  SET_VECTOR_ELT(contents, 689, ScalarInteger(internal->dim_relapsefrompost_5));
  SET_VECTOR_ELT(contents, 690, ScalarInteger(internal->dim_relapsefrompost_6));
  SET_VECTOR_ELT(contents, 691, ScalarInteger(internal->dim_relapsefrompost_7));
  SET_VECTOR_ELT(contents, 692, ScalarInteger(internal->dim_RiskChangeA));
  SET_VECTOR_ELT(contents, 693, ScalarInteger(internal->dim_RiskChangeA_1));
  SET_VECTOR_ELT(contents, 694, ScalarInteger(internal->dim_RiskChangeA_12));
  SET_VECTOR_ELT(contents, 695, ScalarInteger(internal->dim_RiskChangeA_123));
  SET_VECTOR_ELT(contents, 696, ScalarInteger(internal->dim_RiskChangeA_1234));
  SET_VECTOR_ELT(contents, 697, ScalarInteger(internal->dim_RiskChangeA_12345));
  SET_VECTOR_ELT(contents, 698, ScalarInteger(internal->dim_RiskChangeA_123456));
  SET_VECTOR_ELT(contents, 699, ScalarInteger(internal->dim_RiskChangeA_2));
  SET_VECTOR_ELT(contents, 700, ScalarInteger(internal->dim_RiskChangeA_3));
  SET_VECTOR_ELT(contents, 701, ScalarInteger(internal->dim_RiskChangeA_4));
  SET_VECTOR_ELT(contents, 702, ScalarInteger(internal->dim_RiskChangeA_5));
  SET_VECTOR_ELT(contents, 703, ScalarInteger(internal->dim_RiskChangeA_6));
  SET_VECTOR_ELT(contents, 704, ScalarInteger(internal->dim_RiskChangeA_7));
  SET_VECTOR_ELT(contents, 705, ScalarInteger(internal->dim_RiskChangeE));
  SET_VECTOR_ELT(contents, 706, ScalarInteger(internal->dim_RiskChangeE_1));
  SET_VECTOR_ELT(contents, 707, ScalarInteger(internal->dim_RiskChangeE_12));
  SET_VECTOR_ELT(contents, 708, ScalarInteger(internal->dim_RiskChangeE_123));
  SET_VECTOR_ELT(contents, 709, ScalarInteger(internal->dim_RiskChangeE_1234));
  SET_VECTOR_ELT(contents, 710, ScalarInteger(internal->dim_RiskChangeE_12345));
  SET_VECTOR_ELT(contents, 711, ScalarInteger(internal->dim_RiskChangeE_123456));
  SET_VECTOR_ELT(contents, 712, ScalarInteger(internal->dim_RiskChangeE_2));
  SET_VECTOR_ELT(contents, 713, ScalarInteger(internal->dim_RiskChangeE_3));
  SET_VECTOR_ELT(contents, 714, ScalarInteger(internal->dim_RiskChangeE_4));
  SET_VECTOR_ELT(contents, 715, ScalarInteger(internal->dim_RiskChangeE_5));
  SET_VECTOR_ELT(contents, 716, ScalarInteger(internal->dim_RiskChangeE_6));
  SET_VECTOR_ELT(contents, 717, ScalarInteger(internal->dim_RiskChangeE_7));
  SET_VECTOR_ELT(contents, 718, ScalarInteger(internal->dim_RiskChangeL));
  SET_VECTOR_ELT(contents, 719, ScalarInteger(internal->dim_RiskChangeL_1));
  SET_VECTOR_ELT(contents, 720, ScalarInteger(internal->dim_RiskChangeL_12));
  SET_VECTOR_ELT(contents, 721, ScalarInteger(internal->dim_RiskChangeL_123));
  SET_VECTOR_ELT(contents, 722, ScalarInteger(internal->dim_RiskChangeL_1234));
  SET_VECTOR_ELT(contents, 723, ScalarInteger(internal->dim_RiskChangeL_12345));
  SET_VECTOR_ELT(contents, 724, ScalarInteger(internal->dim_RiskChangeL_123456));
  SET_VECTOR_ELT(contents, 725, ScalarInteger(internal->dim_RiskChangeL_2));
  SET_VECTOR_ELT(contents, 726, ScalarInteger(internal->dim_RiskChangeL_3));
  SET_VECTOR_ELT(contents, 727, ScalarInteger(internal->dim_RiskChangeL_4));
  SET_VECTOR_ELT(contents, 728, ScalarInteger(internal->dim_RiskChangeL_5));
  SET_VECTOR_ELT(contents, 729, ScalarInteger(internal->dim_RiskChangeL_6));
  SET_VECTOR_ELT(contents, 730, ScalarInteger(internal->dim_RiskChangeL_7));
  SET_VECTOR_ELT(contents, 731, ScalarInteger(internal->dim_RiskChangeS));
  SET_VECTOR_ELT(contents, 732, ScalarInteger(internal->dim_RiskChangeS_1));
  SET_VECTOR_ELT(contents, 733, ScalarInteger(internal->dim_RiskChangeS_12));
  SET_VECTOR_ELT(contents, 734, ScalarInteger(internal->dim_RiskChangeS_123));
  SET_VECTOR_ELT(contents, 735, ScalarInteger(internal->dim_RiskChangeS_1234));
  SET_VECTOR_ELT(contents, 736, ScalarInteger(internal->dim_RiskChangeS_12345));
  SET_VECTOR_ELT(contents, 737, ScalarInteger(internal->dim_RiskChangeS_123456));
  SET_VECTOR_ELT(contents, 738, ScalarInteger(internal->dim_RiskChangeS_2));
  SET_VECTOR_ELT(contents, 739, ScalarInteger(internal->dim_RiskChangeS_3));
  SET_VECTOR_ELT(contents, 740, ScalarInteger(internal->dim_RiskChangeS_4));
  SET_VECTOR_ELT(contents, 741, ScalarInteger(internal->dim_RiskChangeS_5));
  SET_VECTOR_ELT(contents, 742, ScalarInteger(internal->dim_RiskChangeS_6));
  SET_VECTOR_ELT(contents, 743, ScalarInteger(internal->dim_RiskChangeS_7));
  SET_VECTOR_ELT(contents, 744, ScalarInteger(internal->dim_RiskChangeT));
  SET_VECTOR_ELT(contents, 745, ScalarInteger(internal->dim_RiskChangeT_1));
  SET_VECTOR_ELT(contents, 746, ScalarInteger(internal->dim_RiskChangeT_12));
  SET_VECTOR_ELT(contents, 747, ScalarInteger(internal->dim_RiskChangeT_123));
  SET_VECTOR_ELT(contents, 748, ScalarInteger(internal->dim_RiskChangeT_1234));
  SET_VECTOR_ELT(contents, 749, ScalarInteger(internal->dim_RiskChangeT_12345));
  SET_VECTOR_ELT(contents, 750, ScalarInteger(internal->dim_RiskChangeT_123456));
  SET_VECTOR_ELT(contents, 751, ScalarInteger(internal->dim_RiskChangeT_2));
  SET_VECTOR_ELT(contents, 752, ScalarInteger(internal->dim_RiskChangeT_3));
  SET_VECTOR_ELT(contents, 753, ScalarInteger(internal->dim_RiskChangeT_4));
  SET_VECTOR_ELT(contents, 754, ScalarInteger(internal->dim_RiskChangeT_5));
  SET_VECTOR_ELT(contents, 755, ScalarInteger(internal->dim_RiskChangeT_6));
  SET_VECTOR_ELT(contents, 756, ScalarInteger(internal->dim_RiskChangeT_7));
  SET_VECTOR_ELT(contents, 757, ScalarInteger(internal->dim_RiskChangeU));
  SET_VECTOR_ELT(contents, 758, ScalarInteger(internal->dim_RiskChangeU_1));
  SET_VECTOR_ELT(contents, 759, ScalarInteger(internal->dim_RiskChangeU_12));
  SET_VECTOR_ELT(contents, 760, ScalarInteger(internal->dim_RiskChangeU_123));
  SET_VECTOR_ELT(contents, 761, ScalarInteger(internal->dim_RiskChangeU_1234));
  SET_VECTOR_ELT(contents, 762, ScalarInteger(internal->dim_RiskChangeU_12345));
  SET_VECTOR_ELT(contents, 763, ScalarInteger(internal->dim_RiskChangeU_123456));
  SET_VECTOR_ELT(contents, 764, ScalarInteger(internal->dim_RiskChangeU_2));
  SET_VECTOR_ELT(contents, 765, ScalarInteger(internal->dim_RiskChangeU_3));
  SET_VECTOR_ELT(contents, 766, ScalarInteger(internal->dim_RiskChangeU_4));
  SET_VECTOR_ELT(contents, 767, ScalarInteger(internal->dim_RiskChangeU_5));
  SET_VECTOR_ELT(contents, 768, ScalarInteger(internal->dim_RiskChangeU_6));
  SET_VECTOR_ELT(contents, 769, ScalarInteger(internal->dim_RiskChangeU_7));
  SET_VECTOR_ELT(contents, 770, ScalarInteger(internal->dim_RiskHazard));
  SET_VECTOR_ELT(contents, 771, ScalarInteger(internal->dim_RiskHazard_1));
  SET_VECTOR_ELT(contents, 772, ScalarInteger(internal->dim_RiskHazard_12));
  SET_VECTOR_ELT(contents, 773, ScalarInteger(internal->dim_RiskHazard_2));
  SET_VECTOR_ELT(contents, 774, ScalarInteger(internal->dim_RiskHazard_3));
  SET_VECTOR_ELT(contents, 775, ScalarInteger(internal->dim_RiskHazardData));
  SET_VECTOR_ELT(contents, 776, ScalarInteger(internal->dim_RiskHazardData_1));
  SET_VECTOR_ELT(contents, 777, ScalarInteger(internal->dim_RiskHazardData_12));
  SET_VECTOR_ELT(contents, 778, ScalarInteger(internal->dim_RiskHazardData_123));
  SET_VECTOR_ELT(contents, 779, ScalarInteger(internal->dim_RiskHazardData_2));
  SET_VECTOR_ELT(contents, 780, ScalarInteger(internal->dim_RiskHazardData_3));
  SET_VECTOR_ELT(contents, 781, ScalarInteger(internal->dim_RiskHazardData_4));
  SET_VECTOR_ELT(contents, 782, ScalarInteger(internal->dim_Symp));
  SET_VECTOR_ELT(contents, 783, ScalarInteger(internal->dim_Symp_1));
  SET_VECTOR_ELT(contents, 784, ScalarInteger(internal->dim_Symp_12));
  SET_VECTOR_ELT(contents, 785, ScalarInteger(internal->dim_Symp_123));
  SET_VECTOR_ELT(contents, 786, ScalarInteger(internal->dim_Symp_1234));
  SET_VECTOR_ELT(contents, 787, ScalarInteger(internal->dim_Symp_12345));
  SET_VECTOR_ELT(contents, 788, ScalarInteger(internal->dim_Symp_123456));
  SET_VECTOR_ELT(contents, 789, ScalarInteger(internal->dim_Symp_2));
  SET_VECTOR_ELT(contents, 790, ScalarInteger(internal->dim_Symp_3));
  SET_VECTOR_ELT(contents, 791, ScalarInteger(internal->dim_Symp_4));
  SET_VECTOR_ELT(contents, 792, ScalarInteger(internal->dim_Symp_5));
  SET_VECTOR_ELT(contents, 793, ScalarInteger(internal->dim_Symp_6));
  SET_VECTOR_ELT(contents, 794, ScalarInteger(internal->dim_Symp_7));
  SET_VECTOR_ELT(contents, 795, ScalarInteger(internal->dim_tbbottom));
  SET_VECTOR_ELT(contents, 796, ScalarInteger(internal->dim_tbbottom_1));
  SET_VECTOR_ELT(contents, 797, ScalarInteger(internal->dim_tbbottom_12));
  SET_VECTOR_ELT(contents, 798, ScalarInteger(internal->dim_tbbottom_2));
  SET_VECTOR_ELT(contents, 799, ScalarInteger(internal->dim_tbbottom_3));
  SET_VECTOR_ELT(contents, 800, ScalarInteger(internal->dim_totalpops));
  SET_VECTOR_ELT(contents, 801, ScalarInteger(internal->dim_totalpops_1));
  SET_VECTOR_ELT(contents, 802, ScalarInteger(internal->dim_totalpops_12));
  SET_VECTOR_ELT(contents, 803, ScalarInteger(internal->dim_totalpops_123));
  SET_VECTOR_ELT(contents, 804, ScalarInteger(internal->dim_totalpops_1234));
  SET_VECTOR_ELT(contents, 805, ScalarInteger(internal->dim_totalpops_12345));
  SET_VECTOR_ELT(contents, 806, ScalarInteger(internal->dim_totalpops_123456));
  SET_VECTOR_ELT(contents, 807, ScalarInteger(internal->dim_totalpops_2));
  SET_VECTOR_ELT(contents, 808, ScalarInteger(internal->dim_totalpops_3));
  SET_VECTOR_ELT(contents, 809, ScalarInteger(internal->dim_totalpops_4));
  SET_VECTOR_ELT(contents, 810, ScalarInteger(internal->dim_totalpops_5));
  SET_VECTOR_ELT(contents, 811, ScalarInteger(internal->dim_totalpops_6));
  SET_VECTOR_ELT(contents, 812, ScalarInteger(internal->dim_totalpops_7));
  SET_VECTOR_ELT(contents, 813, ScalarInteger(internal->dim_Treat));
  SET_VECTOR_ELT(contents, 814, ScalarInteger(internal->dim_Treat_1));
  SET_VECTOR_ELT(contents, 815, ScalarInteger(internal->dim_Treat_12));
  SET_VECTOR_ELT(contents, 816, ScalarInteger(internal->dim_Treat_123));
  SET_VECTOR_ELT(contents, 817, ScalarInteger(internal->dim_Treat_1234));
  SET_VECTOR_ELT(contents, 818, ScalarInteger(internal->dim_Treat_12345));
  SET_VECTOR_ELT(contents, 819, ScalarInteger(internal->dim_Treat_123456));
  SET_VECTOR_ELT(contents, 820, ScalarInteger(internal->dim_Treat_2));
  SET_VECTOR_ELT(contents, 821, ScalarInteger(internal->dim_Treat_3));
  SET_VECTOR_ELT(contents, 822, ScalarInteger(internal->dim_Treat_4));
  SET_VECTOR_ELT(contents, 823, ScalarInteger(internal->dim_Treat_5));
  SET_VECTOR_ELT(contents, 824, ScalarInteger(internal->dim_Treat_6));
  SET_VECTOR_ELT(contents, 825, ScalarInteger(internal->dim_Treat_7));
  SET_VECTOR_ELT(contents, 826, ScalarInteger(internal->dim_treatmentends));
  SET_VECTOR_ELT(contents, 827, ScalarInteger(internal->dim_treatmentends_1));
  SET_VECTOR_ELT(contents, 828, ScalarInteger(internal->dim_treatmentends_12));
  SET_VECTOR_ELT(contents, 829, ScalarInteger(internal->dim_treatmentends_123));
  SET_VECTOR_ELT(contents, 830, ScalarInteger(internal->dim_treatmentends_1234));
  SET_VECTOR_ELT(contents, 831, ScalarInteger(internal->dim_treatmentends_12345));
  SET_VECTOR_ELT(contents, 832, ScalarInteger(internal->dim_treatmentends_123456));
  SET_VECTOR_ELT(contents, 833, ScalarInteger(internal->dim_treatmentends_2));
  SET_VECTOR_ELT(contents, 834, ScalarInteger(internal->dim_treatmentends_3));
  SET_VECTOR_ELT(contents, 835, ScalarInteger(internal->dim_treatmentends_4));
  SET_VECTOR_ELT(contents, 836, ScalarInteger(internal->dim_treatmentends_5));
  SET_VECTOR_ELT(contents, 837, ScalarInteger(internal->dim_treatmentends_6));
  SET_VECTOR_ELT(contents, 838, ScalarInteger(internal->dim_treatmentends_7));
  SET_VECTOR_ELT(contents, 839, ScalarInteger(internal->dim_treatmentstarts));
  SET_VECTOR_ELT(contents, 840, ScalarInteger(internal->dim_treatmentstarts_1));
  SET_VECTOR_ELT(contents, 841, ScalarInteger(internal->dim_treatmentstarts_12));
  SET_VECTOR_ELT(contents, 842, ScalarInteger(internal->dim_treatmentstarts_123));
  SET_VECTOR_ELT(contents, 843, ScalarInteger(internal->dim_treatmentstarts_1234));
  SET_VECTOR_ELT(contents, 844, ScalarInteger(internal->dim_treatmentstarts_12345));
  SET_VECTOR_ELT(contents, 845, ScalarInteger(internal->dim_treatmentstarts_123456));
  SET_VECTOR_ELT(contents, 846, ScalarInteger(internal->dim_treatmentstarts_2));
  SET_VECTOR_ELT(contents, 847, ScalarInteger(internal->dim_treatmentstarts_3));
  SET_VECTOR_ELT(contents, 848, ScalarInteger(internal->dim_treatmentstarts_4));
  SET_VECTOR_ELT(contents, 849, ScalarInteger(internal->dim_treatmentstarts_5));
  SET_VECTOR_ELT(contents, 850, ScalarInteger(internal->dim_treatmentstarts_6));
  SET_VECTOR_ELT(contents, 851, ScalarInteger(internal->dim_treatmentstarts_7));
  SET_VECTOR_ELT(contents, 852, ScalarInteger(internal->dim_ttp));
  SET_VECTOR_ELT(contents, 853, ScalarInteger(internal->dim_Uninfected));
  SET_VECTOR_ELT(contents, 854, ScalarInteger(internal->dim_Uninfected_1));
  SET_VECTOR_ELT(contents, 855, ScalarInteger(internal->dim_Uninfected_12));
  SET_VECTOR_ELT(contents, 856, ScalarInteger(internal->dim_Uninfected_123));
  SET_VECTOR_ELT(contents, 857, ScalarInteger(internal->dim_Uninfected_1234));
  SET_VECTOR_ELT(contents, 858, ScalarInteger(internal->dim_Uninfected_12345));
  SET_VECTOR_ELT(contents, 859, ScalarInteger(internal->dim_Uninfected_123456));
  SET_VECTOR_ELT(contents, 860, ScalarInteger(internal->dim_Uninfected_2));
  SET_VECTOR_ELT(contents, 861, ScalarInteger(internal->dim_Uninfected_3));
  SET_VECTOR_ELT(contents, 862, ScalarInteger(internal->dim_Uninfected_4));
  SET_VECTOR_ELT(contents, 863, ScalarInteger(internal->dim_Uninfected_5));
  SET_VECTOR_ELT(contents, 864, ScalarInteger(internal->dim_Uninfected_6));
  SET_VECTOR_ELT(contents, 865, ScalarInteger(internal->dim_Uninfected_7));
  SET_VECTOR_ELT(contents, 866, ScalarReal(internal->foi));
  ...
  SET_VECTOR_ELT(contents, 867, fromtreatmentA);
  ...
  SET_VECTOR_ELT(contents, 868, fromtreatmentL);
  ...
  SET_VECTOR_ELT(contents, 869, immigration);
  ...
  SET_VECTOR_ELT(contents, 870, In);
  ...
  SET_VECTOR_ELT(contents, 871, initial_Asymp);
  ...
  SET_VECTOR_ELT(contents, 872, initial_Learly);
  ...
  SET_VECTOR_ELT(contents, 873, initial_Llate);
  ...
  SET_VECTOR_ELT(contents, 874, initial_Symp);
  ...
  SET_VECTOR_ELT(contents, 875, initial_Treat);
  ...
  SET_VECTOR_ELT(contents, 876, initial_Uninfected);
  SET_VECTOR_ELT(contents, 881, ScalarInteger(internal->lttp));
  ...
  SET_VECTOR_ELT(contents, 882, migrA);
  ...
  SET_VECTOR_ELT(contents, 883, migrage);
  ...
  SET_VECTOR_ELT(contents, 884, migrageinA);
  ...
  SET_VECTOR_ELT(contents, 885, migrageinE);
  ...
  SET_VECTOR_ELT(contents, 886, migrageinL);
  ...
  SET_VECTOR_ELT(contents, 887, migrageinS);
  ...
  SET_VECTOR_ELT(contents, 888, migrageinT);
  ...
  SET_VECTOR_ELT(contents, 889, migrageinU);
  ...
  SET_VECTOR_ELT(contents, 890, migrageoutA);
  ...
  SET_VECTOR_ELT(contents, 891, migrageoutE);
  ...
  SET_VECTOR_ELT(contents, 892, migrageoutL);
  ...
  SET_VECTOR_ELT(contents, 893, migrageoutS);
  ...
  SET_VECTOR_ELT(contents, 894, migrageoutT);
  ...
  SET_VECTOR_ELT(contents, 895, migrageoutU);
  ...
  SET_VECTOR_ELT(contents, 896, migrE);
  ...
  SET_VECTOR_ELT(contents, 897, migrL);
  ...
  SET_VECTOR_ELT(contents, 898, migrS);
  ...
  SET_VECTOR_ELT(contents, 899, migrT);
  ...
  SET_VECTOR_ELT(contents, 900, migrU);
  SET_VECTOR_ELT(contents, 901, ScalarReal(internal->mortality_treated));
  SET_VECTOR_ELT(contents, 902, ScalarReal(internal->mortality_untreated));
  SET_VECTOR_ELT(contents, 903, ScalarInteger(internal->nage));
  ...
  SET_VECTOR_ELT(contents, 904, native);
  SET_VECTOR_ELT(contents, 905, ScalarInteger(internal->nnat));
  SET_VECTOR_ELT(contents, 906, ScalarInteger(internal->npost));
  SET_VECTOR_ELT(contents, 907, ScalarInteger(internal->nprot));
  SET_VECTOR_ELT(contents, 908, ScalarInteger(internal->nrisk));
  SET_VECTOR_ELT(contents, 909, ScalarInteger(internal->nstrain));
  SET_VECTOR_ELT(contents, 910, ScalarInteger(internal->offset_variable_Asymp));
  SET_VECTOR_ELT(contents, 911, ScalarInteger(internal->offset_variable_Llate));
  SET_VECTOR_ELT(contents, 912, ScalarInteger(internal->offset_variable_Symp));
  SET_VECTOR_ELT(contents, 913, ScalarInteger(internal->offset_variable_Treat));
  ...
  SET_VECTOR_ELT(contents, 914, omega);
  ...
  SET_VECTOR_ELT(contents, 915, Pmigr_nat);
  ...
  SET_VECTOR_ELT(contents, 916, Pmigr_post);
  ...
  SET_VECTOR_ELT(contents, 917, Pmigr_prot);
  ...
  SET_VECTOR_ELT(contents, 918, Pmigr_risk);
  ...
  SET_VECTOR_ELT(contents, 919, Pmigr_strain);
  ...
  SET_VECTOR_ELT(contents, 920, popdat);
  ...
  SET_VECTOR_ELT(contents, 921, popinitA);
  ...
  SET_VECTOR_ELT(contents, 922, popinitE);
  ...
  SET_VECTOR_ELT(contents, 923, popinitL);
  ...
  SET_VECTOR_ELT(contents, 924, popinitS);
  ...
  SET_VECTOR_ELT(contents, 925, popinitT);
  ...
  SET_VECTOR_ELT(contents, 926, popinitU);
  ...
  SET_VECTOR_ELT(contents, 927, PostTBprognA);
  ...
  SET_VECTOR_ELT(contents, 928, PostTBprognE);
  ...
  SET_VECTOR_ELT(contents, 929, PostTBprognL);
  ...
  SET_VECTOR_ELT(contents, 930, PostTBprognS);
  ...
  SET_VECTOR_ELT(contents, 931, PostTBprognT);
  ...
  SET_VECTOR_ELT(contents, 932, PostTBprognU);
  SET_VECTOR_ELT(contents, 933, ScalarReal(internal->progn_fast));
  ...
  SET_VECTOR_ELT(contents, 934, progn_posttb);
  SET_VECTOR_ELT(contents, 935, ScalarReal(internal->progn_slow));
  SET_VECTOR_ELT(contents, 936, ScalarReal(internal->progn_symp));
  SEXP r = PROTECT(allocVector(REALSXP, internal->dim_r));
  memcpy(REAL(r), internal->r, internal->dim_r * sizeof(double));
  SET_VECTOR_ELT(contents, 937, r);
  ...
  SET_VECTOR_ELT(contents, 938, rate_tbmortality);
  SET_VECTOR_ELT(contents, 939, ScalarReal(internal->relapse));
  ...
  SET_VECTOR_ELT(contents, 940, relapsefrompost);
  ...
  SET_VECTOR_ELT(contents, 941, RiskChangeA);
  ...
  SET_VECTOR_ELT(contents, 942, RiskChangeE);
  ...
  SET_VECTOR_ELT(contents, 943, RiskChangeL);
  ...
  SET_VECTOR_ELT(contents, 944, RiskChangeS);
  ...
  SET_VECTOR_ELT(contents, 945, RiskChangeT);
  ...
  SET_VECTOR_ELT(contents, 946, RiskChangeU);
  ...
  SET_VECTOR_ELT(contents, 947, RiskHazard);
  ...
  SET_VECTOR_ELT(contents, 948, RiskHazardData);
  SET_VECTOR_ELT(contents, 949, ScalarReal(internal->stabilization));
  ...
  SET_VECTOR_ELT(contents, 950, tbbottom);
  SET_VECTOR_ELT(contents, 951, ScalarReal(internal->tol));
  ...
  SET_VECTOR_ELT(contents, 952, totalpops);
  SET_VECTOR_ELT(contents, 953, ScalarReal(internal->treatment_inversedurn));
  ...
  SET_VECTOR_ELT(contents, 954, treatmentends);
  ...
  SET_VECTOR_ELT(contents, 955, treatmentstarts);
  SEXP ttp = PROTECT(allocVector(REALSXP, internal->dim_ttp));
  memcpy(REAL(ttp), internal->ttp, internal->dim_ttp * sizeof(double));
  SET_VECTOR_ELT(contents, 956, ttp);
  SEXP nms = PROTECT(allocVector(STRSXP, 957));
  ...
  SET_STRING_ELT(nms, 191, mkChar("dim_fromtreatmentA"));
  SET_STRING_ELT(nms, 192, mkChar("dim_fromtreatmentA_1"));
  SET_STRING_ELT(nms, 193, mkChar("dim_fromtreatmentA_12"));
  SET_STRING_ELT(nms, 194, mkChar("dim_fromtreatmentA_123"));
  SET_STRING_ELT(nms, 195, mkChar("dim_fromtreatmentA_1234"));
  SET_STRING_ELT(nms, 196, mkChar("dim_fromtreatmentA_12345"));
  SET_STRING_ELT(nms, 197, mkChar("dim_fromtreatmentA_123456"));
  SET_STRING_ELT(nms, 198, mkChar("dim_fromtreatmentA_2"));
  SET_STRING_ELT(nms, 199, mkChar("dim_fromtreatmentA_3"));
  SET_STRING_ELT(nms, 200, mkChar("dim_fromtreatmentA_4"));
  SET_STRING_ELT(nms, 201, mkChar("dim_fromtreatmentA_5"));
  SET_STRING_ELT(nms, 202, mkChar("dim_fromtreatmentA_6"));
  SET_STRING_ELT(nms, 203, mkChar("dim_fromtreatmentA_7"));
  SET_STRING_ELT(nms, 204, mkChar("dim_fromtreatmentL"));
  SET_STRING_ELT(nms, 205, mkChar("dim_fromtreatmentL_1"));
  SET_STRING_ELT(nms, 206, mkChar("dim_fromtreatmentL_12"));
  SET_STRING_ELT(nms, 207, mkChar("dim_fromtreatmentL_123"));
  SET_STRING_ELT(nms, 208, mkChar("dim_fromtreatmentL_1234"));
  SET_STRING_ELT(nms, 209, mkChar("dim_fromtreatmentL_12345"));
  SET_STRING_ELT(nms, 210, mkChar("dim_fromtreatmentL_123456"));
  SET_STRING_ELT(nms, 211, mkChar("dim_fromtreatmentL_2"));
  SET_STRING_ELT(nms, 212, mkChar("dim_fromtreatmentL_3"));
  SET_STRING_ELT(nms, 213, mkChar("dim_fromtreatmentL_4"));
  SET_STRING_ELT(nms, 214, mkChar("dim_fromtreatmentL_5"));
  SET_STRING_ELT(nms, 215, mkChar("dim_fromtreatmentL_6"));
  SET_STRING_ELT(nms, 216, mkChar("dim_fromtreatmentL_7"));
  SET_STRING_ELT(nms, 217, mkChar("dim_immigration"));
  SET_STRING_ELT(nms, 218, mkChar("dim_immigration_1"));
  SET_STRING_ELT(nms, 219, mkChar("dim_immigration_12"));
  SET_STRING_ELT(nms, 220, mkChar("dim_immigration_2"));
  SET_STRING_ELT(nms, 221, mkChar("dim_immigration_3"));
  SET_STRING_ELT(nms, 222, mkChar("dim_In"));
  SET_STRING_ELT(nms, 223, mkChar("dim_In_1"));
  SET_STRING_ELT(nms, 224, mkChar("dim_In_2"));
  SET_STRING_ELT(nms, 225, mkChar("dim_Learly"));
  SET_STRING_ELT(nms, 226, mkChar("dim_Learly_1"));
  SET_STRING_ELT(nms, 227, mkChar("dim_Learly_12"));
  SET_STRING_ELT(nms, 228, mkChar("dim_Learly_123"));
  SET_STRING_ELT(nms, 229, mkChar("dim_Learly_1234"));
  SET_STRING_ELT(nms, 230, mkChar("dim_Learly_12345"));
  SET_STRING_ELT(nms, 231, mkChar("dim_Learly_123456"));
  SET_STRING_ELT(nms, 232, mkChar("dim_Learly_2"));
  SET_STRING_ELT(nms, 233, mkChar("dim_Learly_3"));
  SET_STRING_ELT(nms, 234, mkChar("dim_Learly_4"));
  SET_STRING_ELT(nms, 235, mkChar("dim_Learly_5"));
  SET_STRING_ELT(nms, 236, mkChar("dim_Learly_6"));
  SET_STRING_ELT(nms, 237, mkChar("dim_Learly_7"));
  SET_STRING_ELT(nms, 238, mkChar("dim_Llate"));
  SET_STRING_ELT(nms, 239, mkChar("dim_Llate_1"));
  SET_STRING_ELT(nms, 240, mkChar("dim_Llate_12"));
  SET_STRING_ELT(nms, 241, mkChar("dim_Llate_123"));
  SET_STRING_ELT(nms, 242, mkChar("dim_Llate_1234"));
  SET_STRING_ELT(nms, 243, mkChar("dim_Llate_12345"));
  SET_STRING_ELT(nms, 244, mkChar("dim_Llate_123456"));
  SET_STRING_ELT(nms, 245, mkChar("dim_Llate_2"));
  SET_STRING_ELT(nms, 246, mkChar("dim_Llate_3"));
  SET_STRING_ELT(nms, 247, mkChar("dim_Llate_4"));
  SET_STRING_ELT(nms, 248, mkChar("dim_Llate_5"));
  SET_STRING_ELT(nms, 249, mkChar("dim_Llate_6"));
  SET_STRING_ELT(nms, 250, mkChar("dim_Llate_7"));
  SET_STRING_ELT(nms, 251, mkChar("dim_migrA"));
  SET_STRING_ELT(nms, 252, mkChar("dim_migrA_1"));
  SET_STRING_ELT(nms, 253, mkChar("dim_migrA_12"));
  SET_STRING_ELT(nms, 254, mkChar("dim_migrA_123"));
  SET_STRING_ELT(nms, 255, mkChar("dim_migrA_1234"));
  SET_STRING_ELT(nms, 256, mkChar("dim_migrA_12345"));
  SET_STRING_ELT(nms, 257, mkChar("dim_migrA_123456"));
  SET_STRING_ELT(nms, 258, mkChar("dim_migrA_2"));
  SET_STRING_ELT(nms, 259, mkChar("dim_migrA_3"));
  SET_STRING_ELT(nms, 260, mkChar("dim_migrA_4"));
  SET_STRING_ELT(nms, 261, mkChar("dim_migrA_5"));
  SET_STRING_ELT(nms, 262, mkChar("dim_migrA_6"));
  SET_STRING_ELT(nms, 263, mkChar("dim_migrA_7"));
  SET_STRING_ELT(nms, 264, mkChar("dim_migrage"));
  SET_STRING_ELT(nms, 265, mkChar("dim_migrageinA"));
  SET_STRING_ELT(nms, 266, mkChar("dim_migrageinA_1"));
  SET_STRING_ELT(nms, 267, mkChar("dim_migrageinA_12"));
  SET_STRING_ELT(nms, 268, mkChar("dim_migrageinA_123"));
  SET_STRING_ELT(nms, 269, mkChar("dim_migrageinA_1234"));
  SET_STRING_ELT(nms, 270, mkChar("dim_migrageinA_12345"));
  SET_STRING_ELT(nms, 271, mkChar("dim_migrageinA_123456"));
  SET_STRING_ELT(nms, 272, mkChar("dim_migrageinA_2"));
  SET_STRING_ELT(nms, 273, mkChar("dim_migrageinA_3"));
  SET_STRING_ELT(nms, 274, mkChar("dim_migrageinA_4"));
  SET_STRING_ELT(nms, 275, mkChar("dim_migrageinA_5"));
  SET_STRING_ELT(nms, 276, mkChar("dim_migrageinA_6"));
  SET_STRING_ELT(nms, 277, mkChar("dim_migrageinA_7"));
  SET_STRING_ELT(nms, 278, mkChar("dim_migrageinE"));
  SET_STRING_ELT(nms, 279, mkChar("dim_migrageinE_1"));
  SET_STRING_ELT(nms, 280, mkChar("dim_migrageinE_12"));
  SET_STRING_ELT(nms, 281, mkChar("dim_migrageinE_123"));
  SET_STRING_ELT(nms, 282, mkChar("dim_migrageinE_1234"));
  SET_STRING_ELT(nms, 283, mkChar("dim_migrageinE_12345"));
  SET_STRING_ELT(nms, 284, mkChar("dim_migrageinE_123456"));
  SET_STRING_ELT(nms, 285, mkChar("dim_migrageinE_2"));
  SET_STRING_ELT(nms, 286, mkChar("dim_migrageinE_3"));
  SET_STRING_ELT(nms, 287, mkChar("dim_migrageinE_4"));
  SET_STRING_ELT(nms, 288, mkChar("dim_migrageinE_5"));
  SET_STRING_ELT(nms, 289, mkChar("dim_migrageinE_6"));
  SET_STRING_ELT(nms, 290, mkChar("dim_migrageinE_7"));
  SET_STRING_ELT(nms, 291, mkChar("dim_migrageinL"));
  SET_STRING_ELT(nms, 292, mkChar("dim_migrageinL_1"));
  SET_STRING_ELT(nms, 293, mkChar("dim_migrageinL_12"));
  SET_STRING_ELT(nms, 294, mkChar("dim_migrageinL_123"));
  SET_STRING_ELT(nms, 295, mkChar("dim_migrageinL_1234"));
  SET_STRING_ELT(nms, 296, mkChar("dim_migrageinL_12345"));
  SET_STRING_ELT(nms, 297, mkChar("dim_migrageinL_123456"));
  SET_STRING_ELT(nms, 298, mkChar("dim_migrageinL_2"));
  SET_STRING_ELT(nms, 299, mkChar("dim_migrageinL_3"));
  SET_STRING_ELT(nms, 300, mkChar("dim_migrageinL_4"));
  SET_STRING_ELT(nms, 301, mkChar("dim_migrageinL_5"));
  SET_STRING_ELT(nms, 302, mkChar("dim_migrageinL_6"));
  SET_STRING_ELT(nms, 303, mkChar("dim_migrageinL_7"));
  SET_STRING_ELT(nms, 304, mkChar("dim_migrageinS"));
  SET_STRING_ELT(nms, 305, mkChar("dim_migrageinS_1"));
  SET_STRING_ELT(nms, 306, mkChar("dim_migrageinS_12"));
  SET_STRING_ELT(nms, 307, mkChar("dim_migrageinS_123"));
  SET_STRING_ELT(nms, 308, mkChar("dim_migrageinS_1234"));
  SET_STRING_ELT(nms, 309, mkChar("dim_migrageinS_12345"));
  SET_STRING_ELT(nms, 310, mkChar("dim_migrageinS_123456"));
  SET_STRING_ELT(nms, 311, mkChar("dim_migrageinS_2"));
  SET_STRING_ELT(nms, 312, mkChar("dim_migrageinS_3"));
  SET_STRING_ELT(nms, 313, mkChar("dim_migrageinS_4"));
  SET_STRING_ELT(nms, 314, mkChar("dim_migrageinS_5"));
  SET_STRING_ELT(nms, 315, mkChar("dim_migrageinS_6"));
  SET_STRING_ELT(nms, 316, mkChar("dim_migrageinS_7"));
  SET_STRING_ELT(nms, 317, mkChar("dim_migrageinT"));
  SET_STRING_ELT(nms, 318, mkChar("dim_migrageinT_1"));
  SET_STRING_ELT(nms, 319, mkChar("dim_migrageinT_12"));
  SET_STRING_ELT(nms, 320, mkChar("dim_migrageinT_123"));
  SET_STRING_ELT(nms, 321, mkChar("dim_migrageinT_1234"));
  SET_STRING_ELT(nms, 322, mkChar("dim_migrageinT_12345"));
  SET_STRING_ELT(nms, 323, mkChar("dim_migrageinT_123456"));
  SET_STRING_ELT(nms, 324, mkChar("dim_migrageinT_2"));
  SET_STRING_ELT(nms, 325, mkChar("dim_migrageinT_3"));
  SET_STRING_ELT(nms, 326, mkChar("dim_migrageinT_4"));
  SET_STRING_ELT(nms, 327, mkChar("dim_migrageinT_5"));
  SET_STRING_ELT(nms, 328, mkChar("dim_migrageinT_6"));
  SET_STRING_ELT(nms, 329, mkChar("dim_migrageinT_7"));
  SET_STRING_ELT(nms, 330, mkChar("dim_migrageinU"));
  SET_STRING_ELT(nms, 331, mkChar("dim_migrageinU_1"));
  SET_STRING_ELT(nms, 332, mkChar("dim_migrageinU_12"));
  SET_STRING_ELT(nms, 333, mkChar("dim_migrageinU_123"));
  SET_STRING_ELT(nms, 334, mkChar("dim_migrageinU_1234"));
  SET_STRING_ELT(nms, 335, mkChar("dim_migrageinU_12345"));
  SET_STRING_ELT(nms, 336, mkChar("dim_migrageinU_123456"));
  SET_STRING_ELT(nms, 337, mkChar("dim_migrageinU_2"));
  SET_STRING_ELT(nms, 338, mkChar("dim_migrageinU_3"));
  SET_STRING_ELT(nms, 339, mkChar("dim_migrageinU_4"));
  SET_STRING_ELT(nms, 340, mkChar("dim_migrageinU_5"));
  SET_STRING_ELT(nms, 341, mkChar("dim_migrageinU_6"));
  SET_STRING_ELT(nms, 342, mkChar("dim_migrageinU_7"));
  SET_STRING_ELT(nms, 343, mkChar("dim_migrageoutA"));
  SET_STRING_ELT(nms, 344, mkChar("dim_migrageoutA_1"));
  SET_STRING_ELT(nms, 345, mkChar("dim_migrageoutA_12"));
  SET_STRING_ELT(nms, 346, mkChar("dim_migrageoutA_123"));
  SET_STRING_ELT(nms, 347, mkChar("dim_migrageoutA_1234"));
  SET_STRING_ELT(nms, 348, mkChar("dim_migrageoutA_12345"));
  SET_STRING_ELT(nms, 349, mkChar("dim_migrageoutA_123456"));
  SET_STRING_ELT(nms, 350, mkChar("dim_migrageoutA_2"));
  SET_STRING_ELT(nms, 351, mkChar("dim_migrageoutA_3"));
  SET_STRING_ELT(nms, 352, mkChar("dim_migrageoutA_4"));
  SET_STRING_ELT(nms, 353, mkChar("dim_migrageoutA_5"));
  SET_STRING_ELT(nms, 354, mkChar("dim_migrageoutA_6"));
  SET_STRING_ELT(nms, 355, mkChar("dim_migrageoutA_7"));
  SET_STRING_ELT(nms, 356, mkChar("dim_migrageoutE"));
  SET_STRING_ELT(nms, 357, mkChar("dim_migrageoutE_1"));
  SET_STRING_ELT(nms, 358, mkChar("dim_migrageoutE_12"));
  SET_STRING_ELT(nms, 359, mkChar("dim_migrageoutE_123"));
  SET_STRING_ELT(nms, 360, mkChar("dim_migrageoutE_1234"));
  SET_STRING_ELT(nms, 361, mkChar("dim_migrageoutE_12345"));
  SET_STRING_ELT(nms, 362, mkChar("dim_migrageoutE_123456"));
  SET_STRING_ELT(nms, 363, mkChar("dim_migrageoutE_2"));
  SET_STRING_ELT(nms, 364, mkChar("dim_migrageoutE_3"));
  SET_STRING_ELT(nms, 365, mkChar("dim_migrageoutE_4"));
  SET_STRING_ELT(nms, 366, mkChar("dim_migrageoutE_5"));
  SET_STRING_ELT(nms, 367, mkChar("dim_migrageoutE_6"));
  SET_STRING_ELT(nms, 368, mkChar("dim_migrageoutE_7"));
  SET_STRING_ELT(nms, 369, mkChar("dim_migrageoutL"));
  SET_STRING_ELT(nms, 370, mkChar("dim_migrageoutL_1"));
  SET_STRING_ELT(nms, 371, mkChar("dim_migrageoutL_12"));
  SET_STRING_ELT(nms, 372, mkChar("dim_migrageoutL_123"));
  SET_STRING_ELT(nms, 373, mkChar("dim_migrageoutL_1234"));
  SET_STRING_ELT(nms, 374, mkChar("dim_migrageoutL_12345"));
  SET_STRING_ELT(nms, 375, mkChar("dim_migrageoutL_123456"));
  SET_STRING_ELT(nms, 376, mkChar("dim_migrageoutL_2"));
  SET_STRING_ELT(nms, 377, mkChar("dim_migrageoutL_3"));
  SET_STRING_ELT(nms, 378, mkChar("dim_migrageoutL_4"));
  SET_STRING_ELT(nms, 379, mkChar("dim_migrageoutL_5"));
  SET_STRING_ELT(nms, 380, mkChar("dim_migrageoutL_6"));
  SET_STRING_ELT(nms, 381, mkChar("dim_migrageoutL_7"));
  SET_STRING_ELT(nms, 382, mkChar("dim_migrageoutS"));
  SET_STRING_ELT(nms, 383, mkChar("dim_migrageoutS_1"));
  SET_STRING_ELT(nms, 384, mkChar("dim_migrageoutS_12"));
  SET_STRING_ELT(nms, 385, mkChar("dim_migrageoutS_123"));
  SET_STRING_ELT(nms, 386, mkChar("dim_migrageoutS_1234"));
  SET_STRING_ELT(nms, 387, mkChar("dim_migrageoutS_12345"));
  SET_STRING_ELT(nms, 388, mkChar("dim_migrageoutS_123456"));
  SET_STRING_ELT(nms, 389, mkChar("dim_migrageoutS_2"));
  SET_STRING_ELT(nms, 390, mkChar("dim_migrageoutS_3"));
  SET_STRING_ELT(nms, 391, mkChar("dim_migrageoutS_4"));
  SET_STRING_ELT(nms, 392, mkChar("dim_migrageoutS_5"));
  SET_STRING_ELT(nms, 393, mkChar("dim_migrageoutS_6"));
  SET_STRING_ELT(nms, 394, mkChar("dim_migrageoutS_7"));
  SET_STRING_ELT(nms, 395, mkChar("dim_migrageoutT"));
  SET_STRING_ELT(nms, 396, mkChar("dim_migrageoutT_1"));
  SET_STRING_ELT(nms, 397, mkChar("dim_migrageoutT_12"));
  SET_STRING_ELT(nms, 398, mkChar("dim_migrageoutT_123"));
  SET_STRING_ELT(nms, 399, mkChar("dim_migrageoutT_1234"));
  SET_STRING_ELT(nms, 400, mkChar("dim_migrageoutT_12345"));
  SET_STRING_ELT(nms, 401, mkChar("dim_migrageoutT_123456"));
  SET_STRING_ELT(nms, 402, mkChar("dim_migrageoutT_2"));
  SET_STRING_ELT(nms, 403, mkChar("dim_migrageoutT_3"));
  SET_STRING_ELT(nms, 404, mkChar("dim_migrageoutT_4"));
  SET_STRING_ELT(nms, 405, mkChar("dim_migrageoutT_5"));
  SET_STRING_ELT(nms, 406, mkChar("dim_migrageoutT_6"));
  SET_STRING_ELT(nms, 407, mkChar("dim_migrageoutT_7"));
  SET_STRING_ELT(nms, 408, mkChar("dim_migrageoutU"));
  SET_STRING_ELT(nms, 409, mkChar("dim_migrageoutU_1"));
  SET_STRING_ELT(nms, 410, mkChar("dim_migrageoutU_12"));
  SET_STRING_ELT(nms, 411, mkChar("dim_migrageoutU_123"));
  SET_STRING_ELT(nms, 412, mkChar("dim_migrageoutU_1234"));
  SET_STRING_ELT(nms, 413, mkChar("dim_migrageoutU_12345"));
  SET_STRING_ELT(nms, 414, mkChar("dim_migrageoutU_123456"));
  SET_STRING_ELT(nms, 415, mkChar("dim_migrageoutU_2"));
  SET_STRING_ELT(nms, 416, mkChar("dim_migrageoutU_3"));
  SET_STRING_ELT(nms, 417, mkChar("dim_migrageoutU_4"));
  SET_STRING_ELT(nms, 418, mkChar("dim_migrageoutU_5"));
  SET_STRING_ELT(nms, 419, mkChar("dim_migrageoutU_6"));
  SET_STRING_ELT(nms, 420, mkChar("dim_migrageoutU_7"));
  SET_STRING_ELT(nms, 421, mkChar("dim_migrE"));
  SET_STRING_ELT(nms, 422, mkChar("dim_migrE_1"));
  SET_STRING_ELT(nms, 423, mkChar("dim_migrE_12"));
  SET_STRING_ELT(nms, 424, mkChar("dim_migrE_123"));
  SET_STRING_ELT(nms, 425, mkChar("dim_migrE_1234"));
  SET_STRING_ELT(nms, 426, mkChar("dim_migrE_12345"));
  SET_STRING_ELT(nms, 427, mkChar("dim_migrE_123456"));
  SET_STRING_ELT(nms, 428, mkChar("dim_migrE_2"));
  SET_STRING_ELT(nms, 429, mkChar("dim_migrE_3"));
  SET_STRING_ELT(nms, 430, mkChar("dim_migrE_4"));
  SET_STRING_ELT(nms, 431, mkChar("dim_migrE_5"));
  SET_STRING_ELT(nms, 432, mkChar("dim_migrE_6"));
  SET_STRING_ELT(nms, 433, mkChar("dim_migrE_7"));
  SET_STRING_ELT(nms, 434, mkChar("dim_migrL"));
  SET_STRING_ELT(nms, 435, mkChar("dim_migrL_1"));
  SET_STRING_ELT(nms, 436, mkChar("dim_migrL_12"));
  SET_STRING_ELT(nms, 437, mkChar("dim_migrL_123"));
  SET_STRING_ELT(nms, 438, mkChar("dim_migrL_1234"));
  SET_STRING_ELT(nms, 439, mkChar("dim_migrL_12345"));
  SET_STRING_ELT(nms, 440, mkChar("dim_migrL_123456"));
  SET_STRING_ELT(nms, 441, mkChar("dim_migrL_2"));
  SET_STRING_ELT(nms, 442, mkChar("dim_migrL_3"));
  SET_STRING_ELT(nms, 443, mkChar("dim_migrL_4"));
  SET_STRING_ELT(nms, 444, mkChar("dim_migrL_5"));
  SET_STRING_ELT(nms, 445, mkChar("dim_migrL_6"));
  SET_STRING_ELT(nms, 446, mkChar("dim_migrL_7"));
  SET_STRING_ELT(nms, 447, mkChar("dim_migrS"));
  SET_STRING_ELT(nms, 448, mkChar("dim_migrS_1"));
  SET_STRING_ELT(nms, 449, mkChar("dim_migrS_12"));
  SET_STRING_ELT(nms, 450, mkChar("dim_migrS_123"));
  SET_STRING_ELT(nms, 451, mkChar("dim_migrS_1234"));
  SET_STRING_ELT(nms, 452, mkChar("dim_migrS_12345"));
  SET_STRING_ELT(nms, 453, mkChar("dim_migrS_123456"));
  SET_STRING_ELT(nms, 454, mkChar("dim_migrS_2"));
  SET_STRING_ELT(nms, 455, mkChar("dim_migrS_3"));
  SET_STRING_ELT(nms, 456, mkChar("dim_migrS_4"));
  SET_STRING_ELT(nms, 457, mkChar("dim_migrS_5"));
  SET_STRING_ELT(nms, 458, mkChar("dim_migrS_6"));
  SET_STRING_ELT(nms, 459, mkChar("dim_migrS_7"));
  SET_STRING_ELT(nms, 460, mkChar("dim_migrT"));
  SET_STRING_ELT(nms, 461, mkChar("dim_migrT_1"));
  SET_STRING_ELT(nms, 462, mkChar("dim_migrT_12"));
  SET_STRING_ELT(nms, 463, mkChar("dim_migrT_123"));
  SET_STRING_ELT(nms, 464, mkChar("dim_migrT_1234"));
  SET_STRING_ELT(nms, 465, mkChar("dim_migrT_12345"));
  SET_STRING_ELT(nms, 466, mkChar("dim_migrT_123456"));
  SET_STRING_ELT(nms, 467, mkChar("dim_migrT_2"));
  SET_STRING_ELT(nms, 468, mkChar("dim_migrT_3"));
  SET_STRING_ELT(nms, 469, mkChar("dim_migrT_4"));
  SET_STRING_ELT(nms, 470, mkChar("dim_migrT_5"));
  SET_STRING_ELT(nms, 471, mkChar("dim_migrT_6"));
  SET_STRING_ELT(nms, 472, mkChar("dim_migrT_7"));
  SET_STRING_ELT(nms, 473, mkChar("dim_migrU"));
  SET_STRING_ELT(nms, 474, mkChar("dim_migrU_1"));
  SET_STRING_ELT(nms, 475, mkChar("dim_migrU_12"));
  SET_STRING_ELT(nms, 476, mkChar("dim_migrU_123"));
  SET_STRING_ELT(nms, 477, mkChar("dim_migrU_1234"));
  SET_STRING_ELT(nms, 478, mkChar("dim_migrU_12345"));
  SET_STRING_ELT(nms, 479, mkChar("dim_migrU_123456"));
  SET_STRING_ELT(nms, 480, mkChar("dim_migrU_2"));
  SET_STRING_ELT(nms, 481, mkChar("dim_migrU_3"));
  SET_STRING_ELT(nms, 482, mkChar("dim_migrU_4"));
  SET_STRING_ELT(nms, 483, mkChar("dim_migrU_5"));
  SET_STRING_ELT(nms, 484, mkChar("dim_migrU_6"));
  SET_STRING_ELT(nms, 485, mkChar("dim_migrU_7"));
  SET_STRING_ELT(nms, 486, mkChar("dim_native"));
  SET_STRING_ELT(nms, 487, mkChar("dim_omega"));
  SET_STRING_ELT(nms, 488, mkChar("dim_omega_1"));
  SET_STRING_ELT(nms, 489, mkChar("dim_omega_2"));
  SET_STRING_ELT(nms, 490, mkChar("dim_Pmigr_nat"));
  SET_STRING_ELT(nms, 491, mkChar("dim_Pmigr_post"));
  SET_STRING_ELT(nms, 492, mkChar("dim_Pmigr_post_1"));
  SET_STRING_ELT(nms, 493, mkChar("dim_Pmigr_post_2"));
  SET_STRING_ELT(nms, 494, mkChar("dim_Pmigr_prot"));
  SET_STRING_ELT(nms, 495, mkChar("dim_Pmigr_prot_1"));
  SET_STRING_ELT(nms, 496, mkChar("dim_Pmigr_prot_2"));
  SET_STRING_ELT(nms, 497, mkChar("dim_Pmigr_risk"));
  SET_STRING_ELT(nms, 498, mkChar("dim_Pmigr_risk_1"));
  SET_STRING_ELT(nms, 499, mkChar("dim_Pmigr_risk_2"));
  SET_STRING_ELT(nms, 500, mkChar("dim_Pmigr_strain"));
  SET_STRING_ELT(nms, 501, mkChar("dim_Pmigr_strain_1"));
  SET_STRING_ELT(nms, 502, mkChar("dim_Pmigr_strain_2"));
  SET_STRING_ELT(nms, 503, mkChar("dim_popdat"));
  SET_STRING_ELT(nms, 504, mkChar("dim_popdat_1"));
  SET_STRING_ELT(nms, 505, mkChar("dim_popdat_12"));
  SET_STRING_ELT(nms, 506, mkChar("dim_popdat_2"));
  SET_STRING_ELT(nms, 507, mkChar("dim_popdat_3"));
  SET_STRING_ELT(nms, 508, mkChar("dim_popinitA"));
  SET_STRING_ELT(nms, 509, mkChar("dim_popinitA_1"));
  SET_STRING_ELT(nms, 510, mkChar("dim_popinitA_12"));
  SET_STRING_ELT(nms, 511, mkChar("dim_popinitA_123"));
  SET_STRING_ELT(nms, 512, mkChar("dim_popinitA_1234"));
  SET_STRING_ELT(nms, 513, mkChar("dim_popinitA_12345"));
  SET_STRING_ELT(nms, 514, mkChar("dim_popinitA_123456"));
  SET_STRING_ELT(nms, 515, mkChar("dim_popinitA_2"));
  SET_STRING_ELT(nms, 516, mkChar("dim_popinitA_3"));
  SET_STRING_ELT(nms, 517, mkChar("dim_popinitA_4"));
  SET_STRING_ELT(nms, 518, mkChar("dim_popinitA_5"));
  SET_STRING_ELT(nms, 519, mkChar("dim_popinitA_6"));
  SET_STRING_ELT(nms, 520, mkChar("dim_popinitA_7"));
  SET_STRING_ELT(nms, 521, mkChar("dim_popinitE"));
  SET_STRING_ELT(nms, 522, mkChar("dim_popinitE_1"));
  SET_STRING_ELT(nms, 523, mkChar("dim_popinitE_12"));
  SET_STRING_ELT(nms, 524, mkChar("dim_popinitE_123"));
  SET_STRING_ELT(nms, 525, mkChar("dim_popinitE_1234"));
  SET_STRING_ELT(nms, 526, mkChar("dim_popinitE_12345"));
  SET_STRING_ELT(nms, 527, mkChar("dim_popinitE_123456"));
  SET_STRING_ELT(nms, 528, mkChar("dim_popinitE_2"));
  SET_STRING_ELT(nms, 529, mkChar("dim_popinitE_3"));
  SET_STRING_ELT(nms, 530, mkChar("dim_popinitE_4"));
  SET_STRING_ELT(nms, 531, mkChar("dim_popinitE_5"));
  SET_STRING_ELT(nms, 532, mkChar("dim_popinitE_6"));
  SET_STRING_ELT(nms, 533, mkChar("dim_popinitE_7"));
  SET_STRING_ELT(nms, 534, mkChar("dim_popinitL"));
  SET_STRING_ELT(nms, 535, mkChar("dim_popinitL_1"));
  SET_STRING_ELT(nms, 536, mkChar("dim_popinitL_12"));
  SET_STRING_ELT(nms, 537, mkChar("dim_popinitL_123"));
  SET_STRING_ELT(nms, 538, mkChar("dim_popinitL_1234"));
  SET_STRING_ELT(nms, 539, mkChar("dim_popinitL_12345"));
  SET_STRING_ELT(nms, 540, mkChar("dim_popinitL_123456"));
  SET_STRING_ELT(nms, 541, mkChar("dim_popinitL_2"));
  SET_STRING_ELT(nms, 542, mkChar("dim_popinitL_3"));
  SET_STRING_ELT(nms, 543, mkChar("dim_popinitL_4"));
  SET_STRING_ELT(nms, 544, mkChar("dim_popinitL_5"));
  SET_STRING_ELT(nms, 545, mkChar("dim_popinitL_6"));
  SET_STRING_ELT(nms, 546, mkChar("dim_popinitL_7"));
  SET_STRING_ELT(nms, 547, mkChar("dim_popinitS"));
  SET_STRING_ELT(nms, 548, mkChar("dim_popinitS_1"));
  SET_STRING_ELT(nms, 549, mkChar("dim_popinitS_12"));
  SET_STRING_ELT(nms, 550, mkChar("dim_popinitS_123"));
  SET_STRING_ELT(nms, 551, mkChar("dim_popinitS_1234"));
  SET_STRING_ELT(nms, 552, mkChar("dim_popinitS_12345"));
  SET_STRING_ELT(nms, 553, mkChar("dim_popinitS_123456"));
  SET_STRING_ELT(nms, 554, mkChar("dim_popinitS_2"));
  SET_STRING_ELT(nms, 555, mkChar("dim_popinitS_3"));
  SET_STRING_ELT(nms, 556, mkChar("dim_popinitS_4"));
  SET_STRING_ELT(nms, 557, mkChar("dim_popinitS_5"));
  SET_STRING_ELT(nms, 558, mkChar("dim_popinitS_6"));
  SET_STRING_ELT(nms, 559, mkChar("dim_popinitS_7"));
  SET_STRING_ELT(nms, 560, mkChar("dim_popinitT"));
  SET_STRING_ELT(nms, 561, mkChar("dim_popinitT_1"));
  SET_STRING_ELT(nms, 562, mkChar("dim_popinitT_12"));
  SET_STRING_ELT(nms, 563, mkChar("dim_popinitT_123"));
  SET_STRING_ELT(nms, 564, mkChar("dim_popinitT_1234"));
  SET_STRING_ELT(nms, 565, mkChar("dim_popinitT_12345"));
  SET_STRING_ELT(nms, 566, mkChar("dim_popinitT_123456"));
  SET_STRING_ELT(nms, 567, mkChar("dim_popinitT_2"));
  SET_STRING_ELT(nms, 568, mkChar("dim_popinitT_3"));
  SET_STRING_ELT(nms, 569, mkChar("dim_popinitT_4"));
  SET_STRING_ELT(nms, 570, mkChar("dim_popinitT_5"));
  SET_STRING_ELT(nms, 571, mkChar("dim_popinitT_6"));
  SET_STRING_ELT(nms, 572, mkChar("dim_popinitT_7"));
  SET_STRING_ELT(nms, 573, mkChar("dim_popinitU"));
  SET_STRING_ELT(nms, 574, mkChar("dim_popinitU_1"));
  SET_STRING_ELT(nms, 575, mkChar("dim_popinitU_12"));
  SET_STRING_ELT(nms, 576, mkChar("dim_popinitU_123"));
  SET_STRING_ELT(nms, 577, mkChar("dim_popinitU_1234"));
  SET_STRING_ELT(nms, 578, mkChar("dim_popinitU_12345"));
  SET_STRING_ELT(nms, 579, mkChar("dim_popinitU_123456"));
  SET_STRING_ELT(nms, 580, mkChar("dim_popinitU_2"));
  SET_STRING_ELT(nms, 581, mkChar("dim_popinitU_3"));
  SET_STRING_ELT(nms, 582, mkChar("dim_popinitU_4"));
  SET_STRING_ELT(nms, 583, mkChar("dim_popinitU_5"));
  SET_STRING_ELT(nms, 584, mkChar("dim_popinitU_6"));
  SET_STRING_ELT(nms, 585, mkChar("dim_popinitU_7"));
  SET_STRING_ELT(nms, 586, mkChar("dim_PostTBprognA"));
  SET_STRING_ELT(nms, 587, mkChar("dim_PostTBprognA_1"));
  SET_STRING_ELT(nms, 588, mkChar("dim_PostTBprognA_12"));
  SET_STRING_ELT(nms, 589, mkChar("dim_PostTBprognA_123"));
  SET_STRING_ELT(nms, 590, mkChar("dim_PostTBprognA_1234"));
  SET_STRING_ELT(nms, 591, mkChar("dim_PostTBprognA_12345"));
  SET_STRING_ELT(nms, 592, mkChar("dim_PostTBprognA_123456"));
  SET_STRING_ELT(nms, 593, mkChar("dim_PostTBprognA_2"));
  SET_STRING_ELT(nms, 594, mkChar("dim_PostTBprognA_3"));
  SET_STRING_ELT(nms, 595, mkChar("dim_PostTBprognA_4"));
  SET_STRING_ELT(nms, 596, mkChar("dim_PostTBprognA_5"));
  SET_STRING_ELT(nms, 597, mkChar("dim_PostTBprognA_6"));
  SET_STRING_ELT(nms, 598, mkChar("dim_PostTBprognA_7"));
  SET_STRING_ELT(nms, 599, mkChar("dim_PostTBprognE"));
  SET_STRING_ELT(nms, 600, mkChar("dim_PostTBprognE_1"));
  SET_STRING_ELT(nms, 601, mkChar("dim_PostTBprognE_12"));
  SET_STRING_ELT(nms, 602, mkChar("dim_PostTBprognE_123"));
  SET_STRING_ELT(nms, 603, mkChar("dim_PostTBprognE_1234"));
  SET_STRING_ELT(nms, 604, mkChar("dim_PostTBprognE_12345"));
  SET_STRING_ELT(nms, 605, mkChar("dim_PostTBprognE_123456"));
  SET_STRING_ELT(nms, 606, mkChar("dim_PostTBprognE_2"));
  SET_STRING_ELT(nms, 607, mkChar("dim_PostTBprognE_3"));
  SET_STRING_ELT(nms, 608, mkChar("dim_PostTBprognE_4"));
  SET_STRING_ELT(nms, 609, mkChar("dim_PostTBprognE_5"));
  SET_STRING_ELT(nms, 610, mkChar("dim_PostTBprognE_6"));
  SET_STRING_ELT(nms, 611, mkChar("dim_PostTBprognE_7"));
  SET_STRING_ELT(nms, 612, mkChar("dim_PostTBprognL"));
  SET_STRING_ELT(nms, 613, mkChar("dim_PostTBprognL_1"));
  SET_STRING_ELT(nms, 614, mkChar("dim_PostTBprognL_12"));
  SET_STRING_ELT(nms, 615, mkChar("dim_PostTBprognL_123"));
  SET_STRING_ELT(nms, 616, mkChar("dim_PostTBprognL_1234"));
  SET_STRING_ELT(nms, 617, mkChar("dim_PostTBprognL_12345"));
  SET_STRING_ELT(nms, 618, mkChar("dim_PostTBprognL_123456"));
  SET_STRING_ELT(nms, 619, mkChar("dim_PostTBprognL_2"));
  SET_STRING_ELT(nms, 620, mkChar("dim_PostTBprognL_3"));
  SET_STRING_ELT(nms, 621, mkChar("dim_PostTBprognL_4"));
  SET_STRING_ELT(nms, 622, mkChar("dim_PostTBprognL_5"));
  SET_STRING_ELT(nms, 623, mkChar("dim_PostTBprognL_6"));
  SET_STRING_ELT(nms, 624, mkChar("dim_PostTBprognL_7"));
  SET_STRING_ELT(nms, 625, mkChar("dim_PostTBprognS"));
  SET_STRING_ELT(nms, 626, mkChar("dim_PostTBprognS_1"));
  SET_STRING_ELT(nms, 627, mkChar("dim_PostTBprognS_12"));
  SET_STRING_ELT(nms, 628, mkChar("dim_PostTBprognS_123"));
  SET_STRING_ELT(nms, 629, mkChar("dim_PostTBprognS_1234"));
  SET_STRING_ELT(nms, 630, mkChar("dim_PostTBprognS_12345"));
  SET_STRING_ELT(nms, 631, mkChar("dim_PostTBprognS_123456"));
  SET_STRING_ELT(nms, 632, mkChar("dim_PostTBprognS_2"));
  SET_STRING_ELT(nms, 633, mkChar("dim_PostTBprognS_3"));
  SET_STRING_ELT(nms, 634, mkChar("dim_PostTBprognS_4"));
  SET_STRING_ELT(nms, 635, mkChar("dim_PostTBprognS_5"));
  SET_STRING_ELT(nms, 636, mkChar("dim_PostTBprognS_6"));
  SET_STRING_ELT(nms, 637, mkChar("dim_PostTBprognS_7"));
  SET_STRING_ELT(nms, 638, mkChar("dim_PostTBprognT"));
  SET_STRING_ELT(nms, 639, mkChar("dim_PostTBprognT_1"));
  SET_STRING_ELT(nms, 640, mkChar("dim_PostTBprognT_12"));
  SET_STRING_ELT(nms, 641, mkChar("dim_PostTBprognT_123"));
  SET_STRING_ELT(nms, 642, mkChar("dim_PostTBprognT_1234"));
  SET_STRING_ELT(nms, 643, mkChar("dim_PostTBprognT_12345"));
  SET_STRING_ELT(nms, 644, mkChar("dim_PostTBprognT_123456"));
  SET_STRING_ELT(nms, 645, mkChar("dim_PostTBprognT_2"));
  SET_STRING_ELT(nms, 646, mkChar("dim_PostTBprognT_3"));
  SET_STRING_ELT(nms, 647, mkChar("dim_PostTBprognT_4"));
  SET_STRING_ELT(nms, 648, mkChar("dim_PostTBprognT_5"));
  SET_STRING_ELT(nms, 649, mkChar("dim_PostTBprognT_6"));
  SET_STRING_ELT(nms, 650, mkChar("dim_PostTBprognT_7"));
  SET_STRING_ELT(nms, 651, mkChar("dim_PostTBprognU"));
  SET_STRING_ELT(nms, 652, mkChar("dim_PostTBprognU_1"));
  SET_STRING_ELT(nms, 653, mkChar("dim_PostTBprognU_12"));
  SET_STRING_ELT(nms, 654, mkChar("dim_PostTBprognU_123"));
  SET_STRING_ELT(nms, 655, mkChar("dim_PostTBprognU_1234"));
  SET_STRING_ELT(nms, 656, mkChar("dim_PostTBprognU_12345"));
  SET_STRING_ELT(nms, 657, mkChar("dim_PostTBprognU_123456"));
  SET_STRING_ELT(nms, 658, mkChar("dim_PostTBprognU_2"));
  SET_STRING_ELT(nms, 659, mkChar("dim_PostTBprognU_3"));
  SET_STRING_ELT(nms, 660, mkChar("dim_PostTBprognU_4"));
  SET_STRING_ELT(nms, 661, mkChar("dim_PostTBprognU_5"));
  SET_STRING_ELT(nms, 662, mkChar("dim_PostTBprognU_6"));
  ...
  SET_STRING_ELT(nms, 666, mkChar("dim_rate_tbmortality"));
  SET_STRING_ELT(nms, 667, mkChar("dim_rate_tbmortality_1"));
  SET_STRING_ELT(nms, 668, mkChar("dim_rate_tbmortality_12"));
  SET_STRING_ELT(nms, 669, mkChar("dim_rate_tbmortality_123"));
  SET_STRING_ELT(nms, 670, mkChar("dim_rate_tbmortality_1234"));
  SET_STRING_ELT(nms, 671, mkChar("dim_rate_tbmortality_12345"));
  SET_STRING_ELT(nms, 672, mkChar("dim_rate_tbmortality_123456"));
  SET_STRING_ELT(nms, 673, mkChar("dim_rate_tbmortality_2"));
  SET_STRING_ELT(nms, 674, mkChar("dim_rate_tbmortality_3"));
  SET_STRING_ELT(nms, 675, mkChar("dim_rate_tbmortality_4"));
  SET_STRING_ELT(nms, 676, mkChar("dim_rate_tbmortality_5"));
  SET_STRING_ELT(nms, 677, mkChar("dim_rate_tbmortality_6"));
  SET_STRING_ELT(nms, 678, mkChar("dim_rate_tbmortality_7"));
  SET_STRING_ELT(nms, 679, mkChar("dim_relapsefrompost"));
  SET_STRING_ELT(nms, 680, mkChar("dim_relapsefrompost_1"));
  SET_STRING_ELT(nms, 681, mkChar("dim_relapsefrompost_12"));
  SET_STRING_ELT(nms, 682, mkChar("dim_relapsefrompost_123"));
  SET_STRING_ELT(nms, 683, mkChar("dim_relapsefrompost_1234"));
  SET_STRING_ELT(nms, 684, mkChar("dim_relapsefrompost_12345"));
  SET_STRING_ELT(nms, 685, mkChar("dim_relapsefrompost_123456"));
  SET_STRING_ELT(nms, 686, mkChar("dim_relapsefrompost_2"));
  SET_STRING_ELT(nms, 687, mkChar("dim_relapsefrompost_3"));
  SET_STRING_ELT(nms, 688, mkChar("dim_relapsefrompost_4"));
  SET_STRING_ELT(nms, 689, mkChar("dim_relapsefrompost_5"));
  SET_STRING_ELT(nms, 690, mkChar("dim_relapsefrompost_6"));
  SET_STRING_ELT(nms, 691, mkChar("dim_relapsefrompost_7"));
  SET_STRING_ELT(nms, 692, mkChar("dim_RiskChangeA"));
  SET_STRING_ELT(nms, 693, mkChar("dim_RiskChangeA_1"));
  SET_STRING_ELT(nms, 694, mkChar("dim_RiskChangeA_12"));
  SET_STRING_ELT(nms, 695, mkChar("dim_RiskChangeA_123"));
  SET_STRING_ELT(nms, 696, mkChar("dim_RiskChangeA_1234"));
  SET_STRING_ELT(nms, 697, mkChar("dim_RiskChangeA_12345"));
  SET_STRING_ELT(nms, 698, mkChar("dim_RiskChangeA_123456"));
  SET_STRING_ELT(nms, 699, mkChar("dim_RiskChangeA_2"));
  SET_STRING_ELT(nms, 700, mkChar("dim_RiskChangeA_3"));
  SET_STRING_ELT(nms, 701, mkChar("dim_RiskChangeA_4"));
  SET_STRING_ELT(nms, 702, mkChar("dim_RiskChangeA_5"));
  SET_STRING_ELT(nms, 703, mkChar("dim_RiskChangeA_6"));
  SET_STRING_ELT(nms, 704, mkChar("dim_RiskChangeA_7"));
  SET_STRING_ELT(nms, 705, mkChar("dim_RiskChangeE"));
  SET_STRING_ELT(nms, 706, mkChar("dim_RiskChangeE_1"));
  SET_STRING_ELT(nms, 707, mkChar("dim_RiskChangeE_12"));
  SET_STRING_ELT(nms, 708, mkChar("dim_RiskChangeE_123"));
  SET_STRING_ELT(nms, 709, mkChar("dim_RiskChangeE_1234"));
  SET_STRING_ELT(nms, 710, mkChar("dim_RiskChangeE_12345"));
  SET_STRING_ELT(nms, 711, mkChar("dim_RiskChangeE_123456"));
  SET_STRING_ELT(nms, 712, mkChar("dim_RiskChangeE_2"));
  SET_STRING_ELT(nms, 713, mkChar("dim_RiskChangeE_3"));
  SET_STRING_ELT(nms, 714, mkChar("dim_RiskChangeE_4"));
  SET_STRING_ELT(nms, 715, mkChar("dim_RiskChangeE_5"));
  SET_STRING_ELT(nms, 716, mkChar("dim_RiskChangeE_6"));
  SET_STRING_ELT(nms, 717, mkChar("dim_RiskChangeE_7"));
  SET_STRING_ELT(nms, 718, mkChar("dim_RiskChangeL"));
  SET_STRING_ELT(nms, 719, mkChar("dim_RiskChangeL_1"));
  SET_STRING_ELT(nms, 720, mkChar("dim_RiskChangeL_12"));
  SET_STRING_ELT(nms, 721, mkChar("dim_RiskChangeL_123"));
  SET_STRING_ELT(nms, 722, mkChar("dim_RiskChangeL_1234"));
  SET_STRING_ELT(nms, 723, mkChar("dim_RiskChangeL_12345"));
  SET_STRING_ELT(nms, 724, mkChar("dim_RiskChangeL_123456"));
  SET_STRING_ELT(nms, 725, mkChar("dim_RiskChangeL_2"));
  SET_STRING_ELT(nms, 726, mkChar("dim_RiskChangeL_3"));
  SET_STRING_ELT(nms, 727, mkChar("dim_RiskChangeL_4"));
  SET_STRING_ELT(nms, 728, mkChar("dim_RiskChangeL_5"));
  SET_STRING_ELT(nms, 729, mkChar("dim_RiskChangeL_6"));
  SET_STRING_ELT(nms, 730, mkChar("dim_RiskChangeL_7"));
  SET_STRING_ELT(nms, 731, mkChar("dim_RiskChangeS"));
  SET_STRING_ELT(nms, 732, mkChar("dim_RiskChangeS_1"));
  SET_STRING_ELT(nms, 733, mkChar("dim_RiskChangeS_12"));
  SET_STRING_ELT(nms, 734, mkChar("dim_RiskChangeS_123"));
  SET_STRING_ELT(nms, 735, mkChar("dim_RiskChangeS_1234"));
  SET_STRING_ELT(nms, 736, mkChar("dim_RiskChangeS_12345"));
  SET_STRING_ELT(nms, 737, mkChar("dim_RiskChangeS_123456"));
  SET_STRING_ELT(nms, 738, mkChar("dim_RiskChangeS_2"));
  SET_STRING_ELT(nms, 739, mkChar("dim_RiskChangeS_3"));
  SET_STRING_ELT(nms, 740, mkChar("dim_RiskChangeS_4"));
  SET_STRING_ELT(nms, 741, mkChar("dim_RiskChangeS_5"));
  SET_STRING_ELT(nms, 742, mkChar("dim_RiskChangeS_6"));
  SET_STRING_ELT(nms, 743, mkChar("dim_RiskChangeS_7"));
  SET_STRING_ELT(nms, 744, mkChar("dim_RiskChangeT"));
  SET_STRING_ELT(nms, 745, mkChar("dim_RiskChangeT_1"));
  SET_STRING_ELT(nms, 746, mkChar("dim_RiskChangeT_12"));
  SET_STRING_ELT(nms, 747, mkChar("dim_RiskChangeT_123"));
  SET_STRING_ELT(nms, 748, mkChar("dim_RiskChangeT_1234"));
  SET_STRING_ELT(nms, 749, mkChar("dim_RiskChangeT_12345"));
  SET_STRING_ELT(nms, 750, mkChar("dim_RiskChangeT_123456"));
  SET_STRING_ELT(nms, 751, mkChar("dim_RiskChangeT_2"));
  SET_STRING_ELT(nms, 752, mkChar("dim_RiskChangeT_3"));
  SET_STRING_ELT(nms, 753, mkChar("dim_RiskChangeT_4"));
  SET_STRING_ELT(nms, 754, mkChar("dim_RiskChangeT_5"));
  SET_STRING_ELT(nms, 755, mkChar("dim_RiskChangeT_6"));
  SET_STRING_ELT(nms, 756, mkChar("dim_RiskChangeT_7"));
  SET_STRING_ELT(nms, 757, mkChar("dim_RiskChangeU"));
  SET_STRING_ELT(nms, 758, mkChar("dim_RiskChangeU_1"));
  SET_STRING_ELT(nms, 759, mkChar("dim_RiskChangeU_12"));
  SET_STRING_ELT(nms, 760, mkChar("dim_RiskChangeU_123"));
  SET_STRING_ELT(nms, 761, mkChar("dim_RiskChangeU_1234"));
  SET_STRING_ELT(nms, 762, mkChar("dim_RiskChangeU_12345"));
  SET_STRING_ELT(nms, 763, mkChar("dim_RiskChangeU_123456"));
  SET_STRING_ELT(nms, 764, mkChar("dim_RiskChangeU_2"));
  SET_STRING_ELT(nms, 765, mkChar("dim_RiskChangeU_3"));
  SET_STRING_ELT(nms, 766, mkChar("dim_RiskChangeU_4"));
  SET_STRING_ELT(nms, 767, mkChar("dim_RiskChangeU_5"));
  SET_STRING_ELT(nms, 768, mkChar("dim_RiskChangeU_6"));
  SET_STRING_ELT(nms, 769, mkChar("dim_RiskChangeU_7"));
  SET_STRING_ELT(nms, 770, mkChar("dim_RiskHazard"));
  SET_STRING_ELT(nms, 771, mkChar("dim_RiskHazard_1"));
  SET_STRING_ELT(nms, 772, mkChar("dim_RiskHazard_12"));
  SET_STRING_ELT(nms, 773, mkChar("dim_RiskHazard_2"));
  SET_STRING_ELT(nms, 774, mkChar("dim_RiskHazard_3"));
  SET_STRING_ELT(nms, 775, mkChar("dim_RiskHazardData"));
  SET_STRING_ELT(nms, 776, mkChar("dim_RiskHazardData_1"));
  SET_STRING_ELT(nms, 777, mkChar("dim_RiskHazardData_12"));
  SET_STRING_ELT(nms, 778, mkChar("dim_RiskHazardData_123"));
  SET_STRING_ELT(nms, 779, mkChar("dim_RiskHazardData_2"));
  SET_STRING_ELT(nms, 780, mkChar("dim_RiskHazardData_3"));
  SET_STRING_ELT(nms, 781, mkChar("dim_RiskHazardData_4"));
  SET_STRING_ELT(nms, 782, mkChar("dim_Symp"));
  SET_STRING_ELT(nms, 783, mkChar("dim_Symp_1"));
  SET_STRING_ELT(nms, 784, mkChar("dim_Symp_12"));
  SET_STRING_ELT(nms, 785, mkChar("dim_Symp_123"));
  SET_STRING_ELT(nms, 786, mkChar("dim_Symp_1234"));
  SET_STRING_ELT(nms, 787, mkChar("dim_Symp_12345"));
  SET_STRING_ELT(nms, 788, mkChar("dim_Symp_123456"));
  SET_STRING_ELT(nms, 789, mkChar("dim_Symp_2"));
  SET_STRING_ELT(nms, 790, mkChar("dim_Symp_3"));
  SET_STRING_ELT(nms, 791, mkChar("dim_Symp_4"));
  SET_STRING_ELT(nms, 792, mkChar("dim_Symp_5"));
  SET_STRING_ELT(nms, 793, mkChar("dim_Symp_6"));
  SET_STRING_ELT(nms, 794, mkChar("dim_Symp_7"));
  SET_STRING_ELT(nms, 795, mkChar("dim_tbbottom"));
  SET_STRING_ELT(nms, 796, mkChar("dim_tbbottom_1"));
  SET_STRING_ELT(nms, 797, mkChar("dim_tbbottom_12"));
  SET_STRING_ELT(nms, 798, mkChar("dim_tbbottom_2"));
  SET_STRING_ELT(nms, 799, mkChar("dim_tbbottom_3"));
  SET_STRING_ELT(nms, 800, mkChar("dim_totalpops"));
  SET_STRING_ELT(nms, 801, mkChar("dim_totalpops_1"));
  SET_STRING_ELT(nms, 802, mkChar("dim_totalpops_12"));
  SET_STRING_ELT(nms, 803, mkChar("dim_totalpops_123"));
  SET_STRING_ELT(nms, 804, mkChar("dim_totalpops_1234"));
  SET_STRING_ELT(nms, 805, mkChar("dim_totalpops_12345"));
  SET_STRING_ELT(nms, 806, mkChar("dim_totalpops_123456"));
  SET_STRING_ELT(nms, 807, mkChar("dim_totalpops_2"));
  SET_STRING_ELT(nms, 808, mkChar("dim_totalpops_3"));
  SET_STRING_ELT(nms, 809, mkChar("dim_totalpops_4"));
  SET_STRING_ELT(nms, 810, mkChar("dim_totalpops_5"));
  SET_STRING_ELT(nms, 811, mkChar("dim_totalpops_6"));
  SET_STRING_ELT(nms, 812, mkChar("dim_totalpops_7"));
  SET_STRING_ELT(nms, 813, mkChar("dim_Treat"));
  SET_STRING_ELT(nms, 814, mkChar("dim_Treat_1"));
  SET_STRING_ELT(nms, 815, mkChar("dim_Treat_12"));
  SET_STRING_ELT(nms, 816, mkChar("dim_Treat_123"));
  SET_STRING_ELT(nms, 817, mkChar("dim_Treat_1234"));
  SET_STRING_ELT(nms, 818, mkChar("dim_Treat_12345"));
  SET_STRING_ELT(nms, 819, mkChar("dim_Treat_123456"));
  SET_STRING_ELT(nms, 820, mkChar("dim_Treat_2"));
  SET_STRING_ELT(nms, 821, mkChar("dim_Treat_3"));
  SET_STRING_ELT(nms, 822, mkChar("dim_Treat_4"));
  SET_STRING_ELT(nms, 823, mkChar("dim_Treat_5"));
  SET_STRING_ELT(nms, 824, mkChar("dim_Treat_6"));
  SET_STRING_ELT(nms, 825, mkChar("dim_Treat_7"));
  SET_STRING_ELT(nms, 826, mkChar("dim_treatmentends"));
  SET_STRING_ELT(nms, 827, mkChar("dim_treatmentends_1"));
  SET_STRING_ELT(nms, 828, mkChar("dim_treatmentends_12"));
  SET_STRING_ELT(nms, 829, mkChar("dim_treatmentends_123"));
  SET_STRING_ELT(nms, 830, mkChar("dim_treatmentends_1234"));
  SET_STRING_ELT(nms, 831, mkChar("dim_treatmentends_12345"));
  SET_STRING_ELT(nms, 832, mkChar("dim_treatmentends_123456"));
  SET_STRING_ELT(nms, 833, mkChar("dim_treatmentends_2"));
  SET_STRING_ELT(nms, 834, mkChar("dim_treatmentends_3"));
  SET_STRING_ELT(nms, 835, mkChar("dim_treatmentends_4"));
  SET_STRING_ELT(nms, 836, mkChar("dim_treatmentends_5"));
  SET_STRING_ELT(nms, 837, mkChar("dim_treatmentends_6"));
  SET_STRING_ELT(nms, 838, mkChar("dim_treatmentends_7"));
  SET_STRING_ELT(nms, 839, mkChar("dim_treatmentstarts"));
  SET_STRING_ELT(nms, 840, mkChar("dim_treatmentstarts_1"));
  SET_STRING_ELT(nms, 841, mkChar("dim_treatmentstarts_12"));
  SET_STRING_ELT(nms, 842, mkChar("dim_treatmentstarts_123"));
  SET_STRING_ELT(nms, 843, mkChar("dim_treatmentstarts_1234"));
  SET_STRING_ELT(nms, 844, mkChar("dim_treatmentstarts_12345"));
  SET_STRING_ELT(nms, 845, mkChar("dim_treatmentstarts_123456"));
  SET_STRING_ELT(nms, 846, mkChar("dim_treatmentstarts_2"));
  SET_STRING_ELT(nms, 847, mkChar("dim_treatmentstarts_3"));
  SET_STRING_ELT(nms, 848, mkChar("dim_treatmentstarts_4"));
  SET_STRING_ELT(nms, 849, mkChar("dim_treatmentstarts_5"));
  SET_STRING_ELT(nms, 850, mkChar("dim_treatmentstarts_6"));
  SET_STRING_ELT(nms, 851, mkChar("dim_treatmentstarts_7"));
  SET_STRING_ELT(nms, 852, mkChar("dim_ttp"));
  SET_STRING_ELT(nms, 853, mkChar("dim_Uninfected"));
  SET_STRING_ELT(nms, 854, mkChar("dim_Uninfected_1"));
  SET_STRING_ELT(nms, 855, mkChar("dim_Uninfected_12"));
  SET_STRING_ELT(nms, 856, mkChar("dim_Uninfected_123"));
  SET_STRING_ELT(nms, 857, mkChar("dim_Uninfected_1234"));
  SET_STRING_ELT(nms, 858, mkChar("dim_Uninfected_12345"));
  SET_STRING_ELT(nms, 859, mkChar("dim_Uninfected_123456"));
  SET_STRING_ELT(nms, 860, mkChar("dim_Uninfected_2"));
  SET_STRING_ELT(nms, 861, mkChar("dim_Uninfected_3"));
  SET_STRING_ELT(nms, 862, mkChar("dim_Uninfected_4"));
  SET_STRING_ELT(nms, 863, mkChar("dim_Uninfected_5"));
  SET_STRING_ELT(nms, 864, mkChar("dim_Uninfected_6"));
  SET_STRING_ELT(nms, 865, mkChar("dim_Uninfected_7"));
  SET_STRING_ELT(nms, 866, mkChar("foi"));
  SET_STRING_ELT(nms, 867, mkChar("fromtreatmentA"));
  SET_STRING_ELT(nms, 868, mkChar("fromtreatmentL"));
  SET_STRING_ELT(nms, 869, mkChar("immigration"));
  SET_STRING_ELT(nms, 870, mkChar("In"));
  SET_STRING_ELT(nms, 871, mkChar("initial_Asymp"));
  SET_STRING_ELT(nms, 872, mkChar("initial_Learly"));
  SET_STRING_ELT(nms, 873, mkChar("initial_Llate"));
  SET_STRING_ELT(nms, 874, mkChar("initial_Symp"));
  SET_STRING_ELT(nms, 875, mkChar("initial_Treat"));
  SET_STRING_ELT(nms, 876, mkChar("initial_Uninfected"));
  SET_STRING_ELT(nms, 877, mkChar("interpolate_bz"));
  SET_STRING_ELT(nms, 878, mkChar("interpolate_In"));
  SET_STRING_ELT(nms, 879, mkChar("interpolate_omega"));
  SET_STRING_ELT(nms, 880, mkChar("interpolate_RiskHazard"));
  SET_STRING_ELT(nms, 881, mkChar("lttp"));
  SET_STRING_ELT(nms, 882, mkChar("migrA"));
  SET_STRING_ELT(nms, 883, mkChar("migrage"));
  SET_STRING_ELT(nms, 884, mkChar("migrageinA"));
  SET_STRING_ELT(nms, 885, mkChar("migrageinE"));
  SET_STRING_ELT(nms, 886, mkChar("migrageinL"));
  SET_STRING_ELT(nms, 887, mkChar("migrageinS"));
  SET_STRING_ELT(nms, 888, mkChar("migrageinT"));
  SET_STRING_ELT(nms, 889, mkChar("migrageinU"));
  SET_STRING_ELT(nms, 890, mkChar("migrageoutA"));
  SET_STRING_ELT(nms, 891, mkChar("migrageoutE"));
  SET_STRING_ELT(nms, 892, mkChar("migrageoutL"));
  SET_STRING_ELT(nms, 893, mkChar("migrageoutS"));
  SET_STRING_ELT(nms, 894, mkChar("migrageoutT"));
  SET_STRING_ELT(nms, 895, mkChar("migrageoutU"));
  SET_STRING_ELT(nms, 896, mkChar("migrE"));
  SET_STRING_ELT(nms, 897, mkChar("migrL"));
  SET_STRING_ELT(nms, 898, mkChar("migrS"));
  SET_STRING_ELT(nms, 899, mkChar("migrT"));
  SET_STRING_ELT(nms, 900, mkChar("migrU"));
  SET_STRING_ELT(nms, 901, mkChar("mortality_treated"));
  SET_STRING_ELT(nms, 902, mkChar("mortality_untreated"));
  SET_STRING_ELT(nms, 903, mkChar("nage"));
  SET_STRING_ELT(nms, 904, mkChar("native"));
  SET_STRING_ELT(nms, 905, mkChar("nnat"));
  SET_STRING_ELT(nms, 906, mkChar("npost"));
  SET_STRING_ELT(nms, 907, mkChar("nprot"));
  SET_STRING_ELT(nms, 908, mkChar("nrisk"));
  SET_STRING_ELT(nms, 909, mkChar("nstrain"));
  SET_STRING_ELT(nms, 910, mkChar("offset_variable_Asymp"));
  SET_STRING_ELT(nms, 911, mkChar("offset_variable_Llate"));
  SET_STRING_ELT(nms, 912, mkChar("offset_variable_Symp"));
  SET_STRING_ELT(nms, 913, mkChar("offset_variable_Treat"));
  SET_STRING_ELT(nms, 914, mkChar("omega"));
  SET_STRING_ELT(nms, 915, mkChar("Pmigr_nat"));
  SET_STRING_ELT(nms, 916, mkChar("Pmigr_post"));
  SET_STRING_ELT(nms, 917, mkChar("Pmigr_prot"));
  SET_STRING_ELT(nms, 918, mkChar("Pmigr_risk"));
  SET_STRING_ELT(nms, 919, mkChar("Pmigr_strain"));
  SET_STRING_ELT(nms, 920, mkChar("popdat"));
  SET_STRING_ELT(nms, 921, mkChar("popinitA"));
  SET_STRING_ELT(nms, 922, mkChar("popinitE"));
  SET_STRING_ELT(nms, 923, mkChar("popinitL"));
  SET_STRING_ELT(nms, 924, mkChar("popinitS"));
  SET_STRING_ELT(nms, 925, mkChar("popinitT"));
  SET_STRING_ELT(nms, 926, mkChar("popinitU"));
  SET_STRING_ELT(nms, 927, mkChar("PostTBprognA"));
  SET_STRING_ELT(nms, 928, mkChar("PostTBprognE"));
  SET_STRING_ELT(nms, 929, mkChar("PostTBprognL"));
  SET_STRING_ELT(nms, 930, mkChar("PostTBprognS"));
  SET_STRING_ELT(nms, 931, mkChar("PostTBprognT"));
  SET_STRING_ELT(nms, 932, mkChar("PostTBprognU"));
  SET_STRING_ELT(nms, 933, mkChar("progn_fast"));
  SET_STRING_ELT(nms, 934, mkChar("progn_posttb"));
  SET_STRING_ELT(nms, 935, mkChar("progn_slow"));
  SET_STRING_ELT(nms, 936, mkChar("progn_symp"));
  SET_STRING_ELT(nms, 937, mkChar("r"));
  SET_STRING_ELT(nms, 938, mkChar("rate_tbmortality"));
  SET_STRING_ELT(nms, 939, mkChar("relapse"));
  SET_STRING_ELT(nms, 940, mkChar("relapsefrompost"));
  SET_STRING_ELT(nms, 941, mkChar("RiskChangeA"));
  SET_STRING_ELT(nms, 942, mkChar("RiskChangeE"));
  SET_STRING_ELT(nms, 943, mkChar("RiskChangeL"));
  SET_STRING_ELT(nms, 944, mkChar("RiskChangeS"));
  SET_STRING_ELT(nms, 945, mkChar("RiskChangeT"));
  SET_STRING_ELT(nms, 946, mkChar("RiskChangeU"));
  SET_STRING_ELT(nms, 947, mkChar("RiskHazard"));
  SET_STRING_ELT(nms, 948, mkChar("RiskHazardData"));
  SET_STRING_ELT(nms, 949, mkChar("stabilization"));
  SET_STRING_ELT(nms, 950, mkChar("tbbottom"));
  SET_STRING_ELT(nms, 951, mkChar("tol"));
  SET_STRING_ELT(nms, 952, mkChar("totalpops"));
  SET_STRING_ELT(nms, 953, mkChar("treatment_inversedurn"));
  SET_STRING_ELT(nms, 954, mkChar("treatmentends"));
  SET_STRING_ELT(nms, 955, mkChar("treatmentstarts"));
  SET_STRING_ELT(nms, 956, mkChar("ttp"));
...
SEXP ocaode_metadata(SEXP internal_p) {
  ...
  SET_STRING_ELT(output_names, 0, mkChar("rate_notificationrate"));
...
void ocaode_rhs(ocaode_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  if (output) {
    ...
    double rate_notificationrate = 100000 * odin_sum1(internal->treatmentstarts, 0, internal->dim_treatmentstarts) / (double) (odin_sum1(internal->totalpops, 0, internal->dim_totalpops) + internal->tol);
    output[0] = rate_notificationrate;
  }
}
void ocaode_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
