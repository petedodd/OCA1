...
SEXP ocaode_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 1038));
  ...
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_Exit));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_Exit_1));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_Exit_2));
  ...
  SET_VECTOR_ELT(contents, 847, ScalarInteger(internal->dim_totalexits));
  SET_VECTOR_ELT(contents, 848, ScalarInteger(internal->dim_totalexits_1));
  SET_VECTOR_ELT(contents, 849, ScalarInteger(internal->dim_totalexits_12));
  SET_VECTOR_ELT(contents, 850, ScalarInteger(internal->dim_totalexits_123));
  SET_VECTOR_ELT(contents, 851, ScalarInteger(internal->dim_totalexits_1234));
  SET_VECTOR_ELT(contents, 852, ScalarInteger(internal->dim_totalexits_12345));
  SET_VECTOR_ELT(contents, 853, ScalarInteger(internal->dim_totalexits_123456));
  SET_VECTOR_ELT(contents, 854, ScalarInteger(internal->dim_totalexits_2));
  SET_VECTOR_ELT(contents, 855, ScalarInteger(internal->dim_totalexits_3));
  SET_VECTOR_ELT(contents, 856, ScalarInteger(internal->dim_totalexits_4));
  SET_VECTOR_ELT(contents, 857, ScalarInteger(internal->dim_totalexits_5));
  SET_VECTOR_ELT(contents, 858, ScalarInteger(internal->dim_totalexits_6));
  SET_VECTOR_ELT(contents, 859, ScalarInteger(internal->dim_totalexits_7));
  SET_VECTOR_ELT(contents, 860, ScalarInteger(internal->dim_totalpop));
  SET_VECTOR_ELT(contents, 861, ScalarInteger(internal->dim_totalpop_1));
  SET_VECTOR_ELT(contents, 862, ScalarInteger(internal->dim_totalpop_12));
  SET_VECTOR_ELT(contents, 863, ScalarInteger(internal->dim_totalpop_123));
  SET_VECTOR_ELT(contents, 864, ScalarInteger(internal->dim_totalpop_1234));
  SET_VECTOR_ELT(contents, 865, ScalarInteger(internal->dim_totalpop_12345));
  SET_VECTOR_ELT(contents, 866, ScalarInteger(internal->dim_totalpop_123456));
  SET_VECTOR_ELT(contents, 867, ScalarInteger(internal->dim_totalpop_2));
  SET_VECTOR_ELT(contents, 868, ScalarInteger(internal->dim_totalpop_3));
  SET_VECTOR_ELT(contents, 869, ScalarInteger(internal->dim_totalpop_4));
  SET_VECTOR_ELT(contents, 870, ScalarInteger(internal->dim_totalpop_5));
  SET_VECTOR_ELT(contents, 871, ScalarInteger(internal->dim_totalpop_6));
  SET_VECTOR_ELT(contents, 872, ScalarInteger(internal->dim_totalpop_7));
  SET_VECTOR_ELT(contents, 873, ScalarInteger(internal->dim_totalpops));
  SET_VECTOR_ELT(contents, 874, ScalarInteger(internal->dim_totalpops_1));
  SET_VECTOR_ELT(contents, 875, ScalarInteger(internal->dim_totalpops_12));
  SET_VECTOR_ELT(contents, 876, ScalarInteger(internal->dim_totalpops_123));
  SET_VECTOR_ELT(contents, 877, ScalarInteger(internal->dim_totalpops_1234));
  SET_VECTOR_ELT(contents, 878, ScalarInteger(internal->dim_totalpops_12345));
  SET_VECTOR_ELT(contents, 879, ScalarInteger(internal->dim_totalpops_123456));
  SET_VECTOR_ELT(contents, 880, ScalarInteger(internal->dim_totalpops_2));
  SET_VECTOR_ELT(contents, 881, ScalarInteger(internal->dim_totalpops_3));
  SET_VECTOR_ELT(contents, 882, ScalarInteger(internal->dim_totalpops_4));
  SET_VECTOR_ELT(contents, 883, ScalarInteger(internal->dim_totalpops_5));
  SET_VECTOR_ELT(contents, 884, ScalarInteger(internal->dim_totalpops_6));
  SET_VECTOR_ELT(contents, 885, ScalarInteger(internal->dim_totalpops_7));
  SET_VECTOR_ELT(contents, 886, ScalarInteger(internal->dim_Treat));
  SET_VECTOR_ELT(contents, 887, ScalarInteger(internal->dim_Treat_1));
  SET_VECTOR_ELT(contents, 888, ScalarInteger(internal->dim_Treat_12));
  SET_VECTOR_ELT(contents, 889, ScalarInteger(internal->dim_Treat_123));
  SET_VECTOR_ELT(contents, 890, ScalarInteger(internal->dim_Treat_1234));
  SET_VECTOR_ELT(contents, 891, ScalarInteger(internal->dim_Treat_12345));
  SET_VECTOR_ELT(contents, 892, ScalarInteger(internal->dim_Treat_123456));
  SET_VECTOR_ELT(contents, 893, ScalarInteger(internal->dim_Treat_2));
  SET_VECTOR_ELT(contents, 894, ScalarInteger(internal->dim_Treat_3));
  SET_VECTOR_ELT(contents, 895, ScalarInteger(internal->dim_Treat_4));
  SET_VECTOR_ELT(contents, 896, ScalarInteger(internal->dim_Treat_5));
  SET_VECTOR_ELT(contents, 897, ScalarInteger(internal->dim_Treat_6));
  SET_VECTOR_ELT(contents, 898, ScalarInteger(internal->dim_Treat_7));
  SET_VECTOR_ELT(contents, 899, ScalarInteger(internal->dim_treatmentends));
  SET_VECTOR_ELT(contents, 900, ScalarInteger(internal->dim_treatmentends_1));
  SET_VECTOR_ELT(contents, 901, ScalarInteger(internal->dim_treatmentends_12));
  SET_VECTOR_ELT(contents, 902, ScalarInteger(internal->dim_treatmentends_123));
  SET_VECTOR_ELT(contents, 903, ScalarInteger(internal->dim_treatmentends_1234));
  SET_VECTOR_ELT(contents, 904, ScalarInteger(internal->dim_treatmentends_12345));
  SET_VECTOR_ELT(contents, 905, ScalarInteger(internal->dim_treatmentends_123456));
  SET_VECTOR_ELT(contents, 906, ScalarInteger(internal->dim_treatmentends_2));
  SET_VECTOR_ELT(contents, 907, ScalarInteger(internal->dim_treatmentends_3));
  SET_VECTOR_ELT(contents, 908, ScalarInteger(internal->dim_treatmentends_4));
  SET_VECTOR_ELT(contents, 909, ScalarInteger(internal->dim_treatmentends_5));
  SET_VECTOR_ELT(contents, 910, ScalarInteger(internal->dim_treatmentends_6));
  SET_VECTOR_ELT(contents, 911, ScalarInteger(internal->dim_treatmentends_7));
  SET_VECTOR_ELT(contents, 912, ScalarInteger(internal->dim_treatmentstarts));
  SET_VECTOR_ELT(contents, 913, ScalarInteger(internal->dim_treatmentstarts_1));
  SET_VECTOR_ELT(contents, 914, ScalarInteger(internal->dim_treatmentstarts_12));
  SET_VECTOR_ELT(contents, 915, ScalarInteger(internal->dim_treatmentstarts_123));
  SET_VECTOR_ELT(contents, 916, ScalarInteger(internal->dim_treatmentstarts_1234));
  SET_VECTOR_ELT(contents, 917, ScalarInteger(internal->dim_treatmentstarts_12345));
  SET_VECTOR_ELT(contents, 918, ScalarInteger(internal->dim_treatmentstarts_123456));
  SET_VECTOR_ELT(contents, 919, ScalarInteger(internal->dim_treatmentstarts_2));
  SET_VECTOR_ELT(contents, 920, ScalarInteger(internal->dim_treatmentstarts_3));
  SET_VECTOR_ELT(contents, 921, ScalarInteger(internal->dim_treatmentstarts_4));
  SET_VECTOR_ELT(contents, 922, ScalarInteger(internal->dim_treatmentstarts_5));
  SET_VECTOR_ELT(contents, 923, ScalarInteger(internal->dim_treatmentstarts_6));
  SET_VECTOR_ELT(contents, 924, ScalarInteger(internal->dim_treatmentstarts_7));
  SET_VECTOR_ELT(contents, 925, ScalarInteger(internal->dim_ttp));
  SET_VECTOR_ELT(contents, 926, ScalarInteger(internal->dim_Uninfected));
  SET_VECTOR_ELT(contents, 927, ScalarInteger(internal->dim_Uninfected_1));
  SET_VECTOR_ELT(contents, 928, ScalarInteger(internal->dim_Uninfected_12));
  SET_VECTOR_ELT(contents, 929, ScalarInteger(internal->dim_Uninfected_123));
  SET_VECTOR_ELT(contents, 930, ScalarInteger(internal->dim_Uninfected_1234));
  SET_VECTOR_ELT(contents, 931, ScalarInteger(internal->dim_Uninfected_12345));
  SET_VECTOR_ELT(contents, 932, ScalarInteger(internal->dim_Uninfected_123456));
  SET_VECTOR_ELT(contents, 933, ScalarInteger(internal->dim_Uninfected_2));
  SET_VECTOR_ELT(contents, 934, ScalarInteger(internal->dim_Uninfected_3));
  SET_VECTOR_ELT(contents, 935, ScalarInteger(internal->dim_Uninfected_4));
  SET_VECTOR_ELT(contents, 936, ScalarInteger(internal->dim_Uninfected_5));
  SET_VECTOR_ELT(contents, 937, ScalarInteger(internal->dim_Uninfected_6));
  SET_VECTOR_ELT(contents, 938, ScalarInteger(internal->dim_Uninfected_7));
  SEXP Exit = PROTECT(allocVector(REALSXP, internal->dim_Exit));
  memcpy(REAL(Exit), internal->Exit, internal->dim_Exit * sizeof(double));
  odin_set_dim(Exit, 2, internal->dim_Exit_1, internal->dim_Exit_2);
  SET_VECTOR_ELT(contents, 939, Exit);
  ...
  SET_VECTOR_ELT(contents, 940, exmigrate);
  SET_VECTOR_ELT(contents, 941, ScalarReal(internal->foi));
  ...
  SET_VECTOR_ELT(contents, 942, fromtreatmentA);
  ...
  SET_VECTOR_ELT(contents, 943, fromtreatmentL);
  ...
  SET_VECTOR_ELT(contents, 944, immigration);
  ...
  SET_VECTOR_ELT(contents, 945, In);
  ...
  SET_VECTOR_ELT(contents, 946, initial_Asymp);
  ...
  SET_VECTOR_ELT(contents, 947, initial_Learly);
  ...
  SET_VECTOR_ELT(contents, 948, initial_Llate);
  ...
  SET_VECTOR_ELT(contents, 949, initial_Symp);
  ...
  SET_VECTOR_ELT(contents, 950, initial_Treat);
  ...
  SET_VECTOR_ELT(contents, 951, initial_Uninfected);
  SET_VECTOR_ELT(contents, 957, ScalarInteger(internal->lttp));
  ...
  SET_VECTOR_ELT(contents, 958, migrA);
  ...
  SET_VECTOR_ELT(contents, 959, migrage);
  ...
  SET_VECTOR_ELT(contents, 960, migrageinA);
  ...
  SET_VECTOR_ELT(contents, 961, migrageinE);
  ...
  SET_VECTOR_ELT(contents, 962, migrageinL);
  ...
  SET_VECTOR_ELT(contents, 963, migrageinS);
  ...
  SET_VECTOR_ELT(contents, 964, migrageinT);
  ...
  SET_VECTOR_ELT(contents, 965, migrageinU);
  ...
  SET_VECTOR_ELT(contents, 966, migrageoutA);
  ...
  SET_VECTOR_ELT(contents, 967, migrageoutE);
  ...
  SET_VECTOR_ELT(contents, 968, migrageoutL);
  ...
  SET_VECTOR_ELT(contents, 969, migrageoutS);
  ...
  SET_VECTOR_ELT(contents, 970, migrageoutT);
  ...
  SET_VECTOR_ELT(contents, 971, migrageoutU);
  ...
  SET_VECTOR_ELT(contents, 972, migrE);
  ...
  SET_VECTOR_ELT(contents, 973, migrL);
  ...
  SET_VECTOR_ELT(contents, 974, migrS);
  ...
  SET_VECTOR_ELT(contents, 975, migrT);
  ...
  SET_VECTOR_ELT(contents, 976, migrU);
  SET_VECTOR_ELT(contents, 977, ScalarReal(internal->mortality_treated));
  SET_VECTOR_ELT(contents, 978, ScalarReal(internal->mortality_untreated));
  SET_VECTOR_ELT(contents, 979, ScalarInteger(internal->nage));
  ...
  SET_VECTOR_ELT(contents, 980, NAS);
  ...
  SET_VECTOR_ELT(contents, 981, native);
  SET_VECTOR_ELT(contents, 982, ScalarInteger(internal->nnat));
  SET_VECTOR_ELT(contents, 983, ScalarInteger(internal->npost));
  SET_VECTOR_ELT(contents, 984, ScalarInteger(internal->nprot));
  SET_VECTOR_ELT(contents, 985, ScalarInteger(internal->nrisk));
  SET_VECTOR_ELT(contents, 986, ScalarInteger(internal->nstrain));
  SET_VECTOR_ELT(contents, 987, ScalarInteger(internal->offset_output_rate_Incidence));
  SET_VECTOR_ELT(contents, 988, ScalarInteger(internal->offset_variable_Asymp));
  SET_VECTOR_ELT(contents, 989, ScalarInteger(internal->offset_variable_Llate));
  SET_VECTOR_ELT(contents, 990, ScalarInteger(internal->offset_variable_Symp));
  SET_VECTOR_ELT(contents, 991, ScalarInteger(internal->offset_variable_Treat));
  ...
  SET_VECTOR_ELT(contents, 992, omega);
  ...
  SET_VECTOR_ELT(contents, 993, omegac);
  ...
  SET_VECTOR_ELT(contents, 994, OutR);
  ...
  SET_VECTOR_ELT(contents, 995, Pmigr_nat);
  ...
  SET_VECTOR_ELT(contents, 996, Pmigr_post);
  ...
  SET_VECTOR_ELT(contents, 997, Pmigr_prot);
  ...
  SET_VECTOR_ELT(contents, 998, Pmigr_risk);
  ...
  SET_VECTOR_ELT(contents, 999, Pmigr_strain);
  ...
  SET_VECTOR_ELT(contents, 1000, popdat);
  ...
  SET_VECTOR_ELT(contents, 1001, popinitA);
  ...
  SET_VECTOR_ELT(contents, 1002, popinitE);
  ...
  SET_VECTOR_ELT(contents, 1003, popinitL);
  ...
  SET_VECTOR_ELT(contents, 1004, popinitS);
  ...
  SET_VECTOR_ELT(contents, 1005, popinitT);
  ...
  SET_VECTOR_ELT(contents, 1006, popinitU);
  ...
  SET_VECTOR_ELT(contents, 1007, PostTBprognA);
  ...
  SET_VECTOR_ELT(contents, 1008, PostTBprognE);
  ...
  SET_VECTOR_ELT(contents, 1009, PostTBprognL);
  ...
  SET_VECTOR_ELT(contents, 1010, PostTBprognS);
  ...
  SET_VECTOR_ELT(contents, 1011, PostTBprognT);
  ...
  SET_VECTOR_ELT(contents, 1012, PostTBprognU);
  SET_VECTOR_ELT(contents, 1013, ScalarReal(internal->progn_fast));
  ...
  SET_VECTOR_ELT(contents, 1014, progn_posttb);
  SET_VECTOR_ELT(contents, 1015, ScalarReal(internal->progn_slow));
  SET_VECTOR_ELT(contents, 1016, ScalarReal(internal->progn_symp));
  SEXP r = PROTECT(allocVector(REALSXP, internal->dim_r));
  memcpy(REAL(r), internal->r, internal->dim_r * sizeof(double));
  SET_VECTOR_ELT(contents, 1017, r);
  SET_VECTOR_ELT(contents, 1018, ScalarReal(internal->relapse));
  ...
  SET_VECTOR_ELT(contents, 1019, relapsefrompost);
  ...
  SET_VECTOR_ELT(contents, 1020, RiskChangeA);
  ...
  SET_VECTOR_ELT(contents, 1021, RiskChangeE);
  ...
  SET_VECTOR_ELT(contents, 1022, RiskChangeL);
  ...
  SET_VECTOR_ELT(contents, 1023, RiskChangeS);
  ...
  SET_VECTOR_ELT(contents, 1024, RiskChangeT);
  ...
  SET_VECTOR_ELT(contents, 1025, RiskChangeU);
  ...
  SET_VECTOR_ELT(contents, 1026, RiskHazard);
  ...
  SET_VECTOR_ELT(contents, 1027, RiskHazardData);
  SET_VECTOR_ELT(contents, 1028, ScalarReal(internal->stabilization));
  ...
  SET_VECTOR_ELT(contents, 1029, tbbottom);
  SET_VECTOR_ELT(contents, 1030, ScalarReal(internal->tol));
  ...
  SET_VECTOR_ELT(contents, 1031, totalexits);
  ...
  SET_VECTOR_ELT(contents, 1032, totalpop);
  ...
  SET_VECTOR_ELT(contents, 1033, totalpops);
  SET_VECTOR_ELT(contents, 1034, ScalarReal(internal->treatment_inversedurn));
  ...
  SET_VECTOR_ELT(contents, 1035, treatmentends);
  ...
  SET_VECTOR_ELT(contents, 1036, treatmentstarts);
  SEXP ttp = PROTECT(allocVector(REALSXP, internal->dim_ttp));
  memcpy(REAL(ttp), internal->ttp, internal->dim_ttp * sizeof(double));
  SET_VECTOR_ELT(contents, 1037, ttp);
  SEXP nms = PROTECT(allocVector(STRSXP, 1038));
  ...
  SET_STRING_ELT(nms, 191, mkChar("dim_Exit"));
  SET_STRING_ELT(nms, 192, mkChar("dim_Exit_1"));
  SET_STRING_ELT(nms, 193, mkChar("dim_Exit_2"));
  ...
  SET_STRING_ELT(nms, 847, mkChar("dim_totalexits"));
  SET_STRING_ELT(nms, 848, mkChar("dim_totalexits_1"));
  SET_STRING_ELT(nms, 849, mkChar("dim_totalexits_12"));
  SET_STRING_ELT(nms, 850, mkChar("dim_totalexits_123"));
  SET_STRING_ELT(nms, 851, mkChar("dim_totalexits_1234"));
  SET_STRING_ELT(nms, 852, mkChar("dim_totalexits_12345"));
  SET_STRING_ELT(nms, 853, mkChar("dim_totalexits_123456"));
  SET_STRING_ELT(nms, 854, mkChar("dim_totalexits_2"));
  SET_STRING_ELT(nms, 855, mkChar("dim_totalexits_3"));
  SET_STRING_ELT(nms, 856, mkChar("dim_totalexits_4"));
  SET_STRING_ELT(nms, 857, mkChar("dim_totalexits_5"));
  SET_STRING_ELT(nms, 858, mkChar("dim_totalexits_6"));
  SET_STRING_ELT(nms, 859, mkChar("dim_totalexits_7"));
  SET_STRING_ELT(nms, 860, mkChar("dim_totalpop"));
  SET_STRING_ELT(nms, 861, mkChar("dim_totalpop_1"));
  SET_STRING_ELT(nms, 862, mkChar("dim_totalpop_12"));
  SET_STRING_ELT(nms, 863, mkChar("dim_totalpop_123"));
  SET_STRING_ELT(nms, 864, mkChar("dim_totalpop_1234"));
  SET_STRING_ELT(nms, 865, mkChar("dim_totalpop_12345"));
  SET_STRING_ELT(nms, 866, mkChar("dim_totalpop_123456"));
  SET_STRING_ELT(nms, 867, mkChar("dim_totalpop_2"));
  SET_STRING_ELT(nms, 868, mkChar("dim_totalpop_3"));
  SET_STRING_ELT(nms, 869, mkChar("dim_totalpop_4"));
  SET_STRING_ELT(nms, 870, mkChar("dim_totalpop_5"));
  SET_STRING_ELT(nms, 871, mkChar("dim_totalpop_6"));
  SET_STRING_ELT(nms, 872, mkChar("dim_totalpop_7"));
  SET_STRING_ELT(nms, 873, mkChar("dim_totalpops"));
  SET_STRING_ELT(nms, 874, mkChar("dim_totalpops_1"));
  SET_STRING_ELT(nms, 875, mkChar("dim_totalpops_12"));
  SET_STRING_ELT(nms, 876, mkChar("dim_totalpops_123"));
  SET_STRING_ELT(nms, 877, mkChar("dim_totalpops_1234"));
  SET_STRING_ELT(nms, 878, mkChar("dim_totalpops_12345"));
  SET_STRING_ELT(nms, 879, mkChar("dim_totalpops_123456"));
  SET_STRING_ELT(nms, 880, mkChar("dim_totalpops_2"));
  SET_STRING_ELT(nms, 881, mkChar("dim_totalpops_3"));
  SET_STRING_ELT(nms, 882, mkChar("dim_totalpops_4"));
  SET_STRING_ELT(nms, 883, mkChar("dim_totalpops_5"));
  SET_STRING_ELT(nms, 884, mkChar("dim_totalpops_6"));
  SET_STRING_ELT(nms, 885, mkChar("dim_totalpops_7"));
  SET_STRING_ELT(nms, 886, mkChar("dim_Treat"));
  SET_STRING_ELT(nms, 887, mkChar("dim_Treat_1"));
  SET_STRING_ELT(nms, 888, mkChar("dim_Treat_12"));
  SET_STRING_ELT(nms, 889, mkChar("dim_Treat_123"));
  SET_STRING_ELT(nms, 890, mkChar("dim_Treat_1234"));
  SET_STRING_ELT(nms, 891, mkChar("dim_Treat_12345"));
  SET_STRING_ELT(nms, 892, mkChar("dim_Treat_123456"));
  SET_STRING_ELT(nms, 893, mkChar("dim_Treat_2"));
  SET_STRING_ELT(nms, 894, mkChar("dim_Treat_3"));
  SET_STRING_ELT(nms, 895, mkChar("dim_Treat_4"));
  SET_STRING_ELT(nms, 896, mkChar("dim_Treat_5"));
  SET_STRING_ELT(nms, 897, mkChar("dim_Treat_6"));
  SET_STRING_ELT(nms, 898, mkChar("dim_Treat_7"));
  SET_STRING_ELT(nms, 899, mkChar("dim_treatmentends"));
  SET_STRING_ELT(nms, 900, mkChar("dim_treatmentends_1"));
  SET_STRING_ELT(nms, 901, mkChar("dim_treatmentends_12"));
  SET_STRING_ELT(nms, 902, mkChar("dim_treatmentends_123"));
  SET_STRING_ELT(nms, 903, mkChar("dim_treatmentends_1234"));
  SET_STRING_ELT(nms, 904, mkChar("dim_treatmentends_12345"));
  SET_STRING_ELT(nms, 905, mkChar("dim_treatmentends_123456"));
  SET_STRING_ELT(nms, 906, mkChar("dim_treatmentends_2"));
  SET_STRING_ELT(nms, 907, mkChar("dim_treatmentends_3"));
  SET_STRING_ELT(nms, 908, mkChar("dim_treatmentends_4"));
  SET_STRING_ELT(nms, 909, mkChar("dim_treatmentends_5"));
  SET_STRING_ELT(nms, 910, mkChar("dim_treatmentends_6"));
  SET_STRING_ELT(nms, 911, mkChar("dim_treatmentends_7"));
  SET_STRING_ELT(nms, 912, mkChar("dim_treatmentstarts"));
  SET_STRING_ELT(nms, 913, mkChar("dim_treatmentstarts_1"));
  SET_STRING_ELT(nms, 914, mkChar("dim_treatmentstarts_12"));
  SET_STRING_ELT(nms, 915, mkChar("dim_treatmentstarts_123"));
  SET_STRING_ELT(nms, 916, mkChar("dim_treatmentstarts_1234"));
  SET_STRING_ELT(nms, 917, mkChar("dim_treatmentstarts_12345"));
  SET_STRING_ELT(nms, 918, mkChar("dim_treatmentstarts_123456"));
  SET_STRING_ELT(nms, 919, mkChar("dim_treatmentstarts_2"));
  SET_STRING_ELT(nms, 920, mkChar("dim_treatmentstarts_3"));
  SET_STRING_ELT(nms, 921, mkChar("dim_treatmentstarts_4"));
  SET_STRING_ELT(nms, 922, mkChar("dim_treatmentstarts_5"));
  SET_STRING_ELT(nms, 923, mkChar("dim_treatmentstarts_6"));
  SET_STRING_ELT(nms, 924, mkChar("dim_treatmentstarts_7"));
  SET_STRING_ELT(nms, 925, mkChar("dim_ttp"));
  SET_STRING_ELT(nms, 926, mkChar("dim_Uninfected"));
  SET_STRING_ELT(nms, 927, mkChar("dim_Uninfected_1"));
  SET_STRING_ELT(nms, 928, mkChar("dim_Uninfected_12"));
  SET_STRING_ELT(nms, 929, mkChar("dim_Uninfected_123"));
  SET_STRING_ELT(nms, 930, mkChar("dim_Uninfected_1234"));
  SET_STRING_ELT(nms, 931, mkChar("dim_Uninfected_12345"));
  SET_STRING_ELT(nms, 932, mkChar("dim_Uninfected_123456"));
  SET_STRING_ELT(nms, 933, mkChar("dim_Uninfected_2"));
  SET_STRING_ELT(nms, 934, mkChar("dim_Uninfected_3"));
  SET_STRING_ELT(nms, 935, mkChar("dim_Uninfected_4"));
  SET_STRING_ELT(nms, 936, mkChar("dim_Uninfected_5"));
  SET_STRING_ELT(nms, 937, mkChar("dim_Uninfected_6"));
  SET_STRING_ELT(nms, 938, mkChar("dim_Uninfected_7"));
  SET_STRING_ELT(nms, 939, mkChar("Exit"));
  SET_STRING_ELT(nms, 940, mkChar("exmigrate"));
  SET_STRING_ELT(nms, 941, mkChar("foi"));
  SET_STRING_ELT(nms, 942, mkChar("fromtreatmentA"));
  SET_STRING_ELT(nms, 943, mkChar("fromtreatmentL"));
  SET_STRING_ELT(nms, 944, mkChar("immigration"));
  SET_STRING_ELT(nms, 945, mkChar("In"));
  SET_STRING_ELT(nms, 946, mkChar("initial_Asymp"));
  SET_STRING_ELT(nms, 947, mkChar("initial_Learly"));
  SET_STRING_ELT(nms, 948, mkChar("initial_Llate"));
  SET_STRING_ELT(nms, 949, mkChar("initial_Symp"));
  SET_STRING_ELT(nms, 950, mkChar("initial_Treat"));
  SET_STRING_ELT(nms, 951, mkChar("initial_Uninfected"));
  SET_STRING_ELT(nms, 952, mkChar("interpolate_bz"));
  SET_STRING_ELT(nms, 953, mkChar("interpolate_In"));
  SET_STRING_ELT(nms, 954, mkChar("interpolate_omega"));
  SET_STRING_ELT(nms, 955, mkChar("interpolate_OutR"));
  SET_STRING_ELT(nms, 956, mkChar("interpolate_RiskHazard"));
  SET_STRING_ELT(nms, 957, mkChar("lttp"));
  SET_STRING_ELT(nms, 958, mkChar("migrA"));
  SET_STRING_ELT(nms, 959, mkChar("migrage"));
  SET_STRING_ELT(nms, 960, mkChar("migrageinA"));
  SET_STRING_ELT(nms, 961, mkChar("migrageinE"));
  SET_STRING_ELT(nms, 962, mkChar("migrageinL"));
  SET_STRING_ELT(nms, 963, mkChar("migrageinS"));
  SET_STRING_ELT(nms, 964, mkChar("migrageinT"));
  SET_STRING_ELT(nms, 965, mkChar("migrageinU"));
  SET_STRING_ELT(nms, 966, mkChar("migrageoutA"));
  SET_STRING_ELT(nms, 967, mkChar("migrageoutE"));
  SET_STRING_ELT(nms, 968, mkChar("migrageoutL"));
  SET_STRING_ELT(nms, 969, mkChar("migrageoutS"));
  SET_STRING_ELT(nms, 970, mkChar("migrageoutT"));
  SET_STRING_ELT(nms, 971, mkChar("migrageoutU"));
  SET_STRING_ELT(nms, 972, mkChar("migrE"));
  SET_STRING_ELT(nms, 973, mkChar("migrL"));
  SET_STRING_ELT(nms, 974, mkChar("migrS"));
  SET_STRING_ELT(nms, 975, mkChar("migrT"));
  SET_STRING_ELT(nms, 976, mkChar("migrU"));
  SET_STRING_ELT(nms, 977, mkChar("mortality_treated"));
  SET_STRING_ELT(nms, 978, mkChar("mortality_untreated"));
  SET_STRING_ELT(nms, 979, mkChar("nage"));
  SET_STRING_ELT(nms, 980, mkChar("NAS"));
  SET_STRING_ELT(nms, 981, mkChar("native"));
  SET_STRING_ELT(nms, 982, mkChar("nnat"));
  SET_STRING_ELT(nms, 983, mkChar("npost"));
  SET_STRING_ELT(nms, 984, mkChar("nprot"));
  SET_STRING_ELT(nms, 985, mkChar("nrisk"));
  SET_STRING_ELT(nms, 986, mkChar("nstrain"));
  SET_STRING_ELT(nms, 987, mkChar("offset_output_rate_Incidence"));
  SET_STRING_ELT(nms, 988, mkChar("offset_variable_Asymp"));
  SET_STRING_ELT(nms, 989, mkChar("offset_variable_Llate"));
  SET_STRING_ELT(nms, 990, mkChar("offset_variable_Symp"));
  SET_STRING_ELT(nms, 991, mkChar("offset_variable_Treat"));
  SET_STRING_ELT(nms, 992, mkChar("omega"));
  SET_STRING_ELT(nms, 993, mkChar("omegac"));
  SET_STRING_ELT(nms, 994, mkChar("OutR"));
  SET_STRING_ELT(nms, 995, mkChar("Pmigr_nat"));
  SET_STRING_ELT(nms, 996, mkChar("Pmigr_post"));
  SET_STRING_ELT(nms, 997, mkChar("Pmigr_prot"));
  SET_STRING_ELT(nms, 998, mkChar("Pmigr_risk"));
  SET_STRING_ELT(nms, 999, mkChar("Pmigr_strain"));
  SET_STRING_ELT(nms, 1000, mkChar("popdat"));
  SET_STRING_ELT(nms, 1001, mkChar("popinitA"));
  SET_STRING_ELT(nms, 1002, mkChar("popinitE"));
  SET_STRING_ELT(nms, 1003, mkChar("popinitL"));
  SET_STRING_ELT(nms, 1004, mkChar("popinitS"));
  SET_STRING_ELT(nms, 1005, mkChar("popinitT"));
  SET_STRING_ELT(nms, 1006, mkChar("popinitU"));
  SET_STRING_ELT(nms, 1007, mkChar("PostTBprognA"));
  SET_STRING_ELT(nms, 1008, mkChar("PostTBprognE"));
  SET_STRING_ELT(nms, 1009, mkChar("PostTBprognL"));
  SET_STRING_ELT(nms, 1010, mkChar("PostTBprognS"));
  SET_STRING_ELT(nms, 1011, mkChar("PostTBprognT"));
  SET_STRING_ELT(nms, 1012, mkChar("PostTBprognU"));
  SET_STRING_ELT(nms, 1013, mkChar("progn_fast"));
  SET_STRING_ELT(nms, 1014, mkChar("progn_posttb"));
  SET_STRING_ELT(nms, 1015, mkChar("progn_slow"));
  SET_STRING_ELT(nms, 1016, mkChar("progn_symp"));
  SET_STRING_ELT(nms, 1017, mkChar("r"));
  SET_STRING_ELT(nms, 1018, mkChar("relapse"));
  SET_STRING_ELT(nms, 1019, mkChar("relapsefrompost"));
  SET_STRING_ELT(nms, 1020, mkChar("RiskChangeA"));
  SET_STRING_ELT(nms, 1021, mkChar("RiskChangeE"));
  SET_STRING_ELT(nms, 1022, mkChar("RiskChangeL"));
  SET_STRING_ELT(nms, 1023, mkChar("RiskChangeS"));
  SET_STRING_ELT(nms, 1024, mkChar("RiskChangeT"));
  SET_STRING_ELT(nms, 1025, mkChar("RiskChangeU"));
  SET_STRING_ELT(nms, 1026, mkChar("RiskHazard"));
  SET_STRING_ELT(nms, 1027, mkChar("RiskHazardData"));
  SET_STRING_ELT(nms, 1028, mkChar("stabilization"));
  SET_STRING_ELT(nms, 1029, mkChar("tbbottom"));
  SET_STRING_ELT(nms, 1030, mkChar("tol"));
  SET_STRING_ELT(nms, 1031, mkChar("totalexits"));
  SET_STRING_ELT(nms, 1032, mkChar("totalpop"));
  SET_STRING_ELT(nms, 1033, mkChar("totalpops"));
  SET_STRING_ELT(nms, 1034, mkChar("treatment_inversedurn"));
  SET_STRING_ELT(nms, 1035, mkChar("treatmentends"));
  SET_STRING_ELT(nms, 1036, mkChar("treatmentstarts"));
  SET_STRING_ELT(nms, 1037, mkChar("ttp"));
...
SEXP ocaode_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_Exit_1 = internal->nage;
  internal->dim_Exit_2 = 2;
  ...
  internal->dim_Exit = internal->dim_Exit_1 * internal->dim_Exit_2;
  ...
  R_Free(internal->Exit);
  internal->Exit = (double*) R_Calloc(internal->dim_Exit, double);
  R_Free(internal->fromtreatmentA);
...
void ocaode_rhs(ocaode_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->nage; ++i) {
    for (int j = 1; j <= 2; ++j) {
      internal->Exit[i - 1 + internal->dim_Exit_1 * (j - 1)] = odin_sum7(internal->totalexits, i - 1, i, j - 1, j, 0, internal->dim_totalexits_3, 0, internal->dim_totalexits_4, 0, internal->dim_totalexits_5, 0, internal->dim_totalexits_6, 0, internal->dim_totalexits_7, internal->dim_totalexits_1, internal->dim_totalexits_12, internal->dim_totalexits_123, internal->dim_totalexits_1234, internal->dim_totalexits_12345, internal->dim_totalexits_123456);
    }
  }
  for (int i = 1; i <= internal->nage; ++i) {
    for (int j = 1; j <= 2; ++j) {
      internal->omegac[i - 1 + internal->dim_omegac_1 * (j - 1)] = internal->omega[internal->dim_omega_1 * (j - 1) + i - 1] + internal->In[internal->dim_In_1 * (j - 1) + i - 1] / (double) internal->NAS[internal->dim_NAS_1 * (j - 1) + i - 1] - internal->Exit[internal->dim_Exit_1 * (j - 1) + i - 1] / (double) internal->NAS[internal->dim_NAS_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->nage; ++i) {
    for (int j = 1; j <= 2; ++j) {
