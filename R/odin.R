...
ocaode_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "OCA1",
    user = c("BB", "BETAage", "BETAnat", "BETArisk", "BETAsex", "BETAstrain",
             "birthrisk", "CDR_raw", "exmigrate", "immigration", "IRRprotn",
             "IRRstrain", "migr_TBD", "migr_TBI", "migrage", "nage", "nnat",
             ...
             "popinitU", "r", "RiskHazardData", "ttp", "asymp_relinf",
